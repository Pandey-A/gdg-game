...
(function(Ie) {
    ...
    B.strDate = function(a) {
        switch (a.length) {
            ...
            default:
                throw new u("Invalid date format : " +
                    a);
        }
    };
    B.cca = function(a, b) {
    ...
    Ob.count = function(a, b) {
        var c = 0;
        if (null == b)
            for (var f = Je(a)(); f.hasNext();) f.next(), c++;
        else
    ...
    aa["typeof"] = function(a) {
        switch (typeof a) {
            ...
            case "number":
                return Math.ceil(a) == a % 2147483648 ?
                    F.TInt : F.TFloat;
            case "object":
    ...
    t.createElement = function(a) {
        ...
        if (b.nodeType != t.Element) throw new u("Bad node type, expected Element but found " +
            b.nodeType);
        b.nodeName = a;
        return b
    };
    t.createPCData = function(a) {
        ...
        if (b.nodeType == t.Document || b.nodeType == t.Element) throw new u("Bad node type, unexpected " + b.nodeType);
        b.nodeValue = a;
        return b
    };
    ...
    t.createComment = function(a) {
        ...
        if (b.nodeType == t.Document || b.nodeType == t.Element) throw new u("Bad node type, unexpected " +
            b.nodeType);
        b.nodeValue = a;
        return b
    };
    ...
    t.prototype = {
        get_nodeName: function() {
            if (this.nodeType !=
                t.Element) throw new u("Bad node type, expected Element but found " + this.nodeType);
            return this.nodeName
        },
        get: function(a) {
            if (this.nodeType != t.Element) throw new u("Bad node type, expected Element but found " + this.nodeType);
        ...
        exists: function(a) {
            if (this.nodeType != t.Element) throw new u("Bad node type, expected Element but found " +
                this.nodeType);
            return this.attributeMap.exists(a)
        },
        iterator: function() {
            if (this.nodeType != t.Document && this.nodeType != t.Element) throw new u("Bad node type, expected Element or Document but found " + this.nodeType);
        ...
        elementsNamed: function(a) {
            ...
            for (var b = [], c = 0, f = this.children; c < f.length;) {
                ...
                if (p = k.nodeType == t.Element) {
                    p =
                        void 0;
                    if (k.nodeType != t.Element) throw new u("Bad node type, expected Element but found " + k.nodeType);
                    p = k.nodeName;
                    p = p == a
                }
                p && b.push(k)
        ...
        addChild: function(a) {
            if (this.nodeType != t.Document && this.nodeType != t.Element) throw new u("Bad node type, expected Element or Document but found " +
                this.nodeType);
    ...
    P.fadeIn = function(a, b, c) {
        ...
        var f = new G;
        f.run(new H([new z(b), new x(function() {
            a.$zF[1].alpha.animateTo(1,
                c)
        })]));
        a.add(f)
    };
    P.animate = function(a, b, c, f, k, p, d) {
        ...
        g = new G;
        g.run(new H([new z(b), new x(function() {
    ...
    P.spawn = function(a, b, c, f, k, p) {
        ...
        c = new G;
        c.run(new H([new z(b), new x(function() {
            k && a.$zF[1].alpha.animateTo(1, 0.75 * f);
            p ? (a.$zF[1].scaleX.animateTo(1, f, C.bounceOut), a.$zF[1].scaleY.animateTo(1, f, C.bounceOut)) : (a.$zF[1].scaleX.animateTo(1, f), a.$zF[1].scaleY.animateTo(1, f));
            a.$zF[1].set_pixelSnapping(!0)
        })]));
        a.add(c)
    };
    ...
    U.init = function() {
        m.$vG.getCloudStorage().get(U.gameName + "score1",
            0).then(function(a) {
            d.score1 = a
        });
        m.$vG.getCloudStorage().get(U.gameName + "time1", 0).then(function(a) {
            d.time1 = a
        });
        m.$vG.getCloudStorage().get(U.gameName + "targets1", 0).then(function(a) {
            d.targets1 = a
        });
        m.$vG.getCloudStorage().get(U.gameName + "trophy1", 0).then(function(a) {
            d.trophy1 = a
        });
        m.$vG.getCloudStorage().get(U.gameName + "score2", 0).then(function(a) {
            d.score2 = a
        });
        m.$vG.getCloudStorage().get(U.gameName + "time2", 0).then(function(a) {
            d.time2 = a
        });
        m.$vG.getCloudStorage().get(U.gameName + "targets2", 0).then(function(a) {
            d.targets2 =
                a
        });
        m.$vG.getCloudStorage().get(U.gameName + "trophy2", 0).then(function(a) {
            d.trophy2 = a
        })
    };
    U.save = function() {
    ...
    La.prototype = {
        ...
        serializeRef: function(a) {
            for (var b = typeof a, c = 0, f = this.cache.length; c < f;) {
                var k = c++,
                    p = this.cache[k];
                if (typeof p == b && p == a) return this.buf.b += "r", this.buf.b = null == k ? this.buf.b + "null" : this.buf.b + ("" + k), !0
            }
            this.cache.push(a);
            return !1
        },
        ...
        serialize: function(a) {
            ...
            switch (b[1]) {
                    ...
                    switch (b) {
                        case Array:
                            ...
                            for (var c = a.length, f = 0; f < c;) {
                                var k = f++;
                                null == a[k] ? b++ : (0 < b && (1 == b ? this.buf.b += "n" : (this.buf.b += "u", this.buf.b = null == b ? this.buf.b + "null" : this.buf.b + ("" + b)), b = 0), this.serialize(a[k]))
                            }
                        ...
                        case X:
                            this.buf.b += "b";
                            for (b = a.keys(); b.hasNext();) c = b.next(), this.serializeString(c), this.serialize(null != Sa[c] ? a.getReserved(c) : a.h[c]);
                            this.buf.b += "h";
                            break;
                        case va:
                            this.buf.b += "q";
                        ...
                        case Ma:
                            ...
                            for (b = a.keys(); b.hasNext();) c =
                                b.next(), f = T.field(c, "__id__"), T.deleteField(c, "__id__"), this.serialize(c), c.__id__ = f, this.serialize(a.h[c.__id__]);
                            this.buf.b += "h";
                            break;
                        case cb:
                            f = 0;
                            ...
                            f == k ? (k = a.get(f++), a = a.get(f++), b.add(c.charAt(k >> 2)), b.add(c.charAt((k << 4 | a >> 4) & 63)), b.add(c.charAt(a << 2 & 63))) : f == k + 1 && (a = a.get(f++), b.add(c.charAt(a >> 2)),
                            ...
                            break;
                        default:
                            this.useCache && this.cache.pop(), null != a.hxSerialize ? (this.buf.b += "C", this.serializeString(aa.getClassName(b)), this.useCache && this.cache.push(a), a.hxSerialize(this), this.buf.b += "g") : (this.buf.b += "c", this.serializeString(aa.getClassName(b)), this.useCache && this.cache.push(a), this.serializeFields(a))
                    }
                    break;
                case 4:
                    if (K.__instanceof(a, Ne)) a = aa.getClassName(a), this.buf.b += "A", this.serializeString(a);
                    else if (K.__instanceof(a, Oe)) this.buf.b += "B", this.serializeString(aa.getEnumName(a));
                    else {
                        if (this.useCache && this.serializeRef(a)) break;
                        this.buf.b += "o";
                ...
                case 7:
                    ...
                    this.useEnumIndex ? (this.buf.b += ":", this.buf.b += r.string(a[1])) :
            ...
            switch (this.get(this.pos++)) {
                ...
                case 121:
                    ...
                    if (58 != this.get(this.pos++) || this.length - this.pos <
                        a) throw new u("Invalid string length");
                ...
                case 118:
                    return 48 <=
                        this.buf.charCodeAt(this.pos) && 57 >= this.buf.charCodeAt(this.pos) && 48 <= this.buf.charCodeAt(this.pos + 1) && 57 >= this.buf.charCodeAt(this.pos + 1) && 48 <= this.buf.charCodeAt(this.pos + 2) && 57 >= this.buf.charCodeAt(this.pos + 2) && 48 <= this.buf.charCodeAt(this.pos + 3) && 57 >= this.buf.charCodeAt(this.pos + 3) && 45 == this.buf.charCodeAt(this.pos + 4) ? (a = B.substr(this.buf, this.pos, 19), a = B.strDate(a), this.pos += 19) : (a = this.readFloat(), b = new Date, b.setTime(a), a = b), this.cache.push(a), a;
                case 115:
                    a = this.readDigits();
                    f = this.buf;
                    if (58 !=
                        this.get(this.pos++) || this.length - this.pos < a) throw new u("Invalid bytes length");
                    var k = na.CODES;
                    null == k && (k = na.initCodes(), na.CODES = k);
                    for (var p = this.pos, d = a & 3, g = p + (a - d), b = cb.alloc(3 * (a >> 2) + (2 <= d ? d - 1 : 0)), c = 0; p < g;) {
                    ...
                    2 <= d && (h = k[$.fastCodeAt(f, p++)], g = k[$.fastCodeAt(f, p++)], b.set(c++, h << 2 | g >> 4), 3 == d && (f = k[$.fastCodeAt(f, p++)], b.set(c++, g <<
                        4 | f >> 2)));
                    this.pos += a;
                    this.cache.push(b);
                    return b;
    ...
    Fa.i64ToDouble = function(a, b) {
        var c = (b >> 20 & 2047) - 1023,
            f = 4294967296 * (b & 1048575) + 2147483648 *
            (a >>> 31) + (a & 2147483647);
    ...
    zd.prototype = {
        resolve: function(a) {
            ...
            if (null == b) throw b = this.__x.nodeType == t.Document ? "Document" : this.__x.get_nodeName(), new u(b + " is missing element " + a);
            return new Wa(b)
        },
        __class__: zd
    };
    ...
    Ad.__name__ = ["haxe", "xml", "_Fast",
        "AttribAccess"
    ];
    Ad.prototype = {
        resolve: function(a) {
            if (this.__x.nodeType == t.Document) throw new u("Cannot access document attribute " + a);
    ...
    var Wa = function(a) {
        if (a.nodeType != t.Document && a.nodeType != t.Element) throw new u("Invalid nodeType " + a.nodeType);
        this.x = a;
        this.node = new zd(a);
        this.nodes = new Dd(a);
        this.att = new Ad(a);
    ...
    Wa.prototype = {
        get_name: function() {
            return this.x.nodeType ==
                t.Document ? "Document" : this.x.get_nodeName()
        },
        get_innerData: function() {
            ...
            var b = a.next(),
                c = a.next();
            if (null != c) {
                if (b.nodeType == t.PCData && c.nodeType == t.CData && "" == $.trim(function(a) {
                        if (b.nodeType == t.Document || b.nodeType == t.Element) throw new u("Bad node type, unexpected " + b.nodeType);
                        return b.nodeValue
                    }(this))) {
                    var f = a.next();
                    if (null == f || f.nodeType == t.PCData && "" == $.trim(function(a) {
                            if (f.nodeType == t.Document || f.nodeType ==
                                t.Element) throw new u("Bad node type, unexpected " + f.nodeType);
                            return f.nodeValue
                        }(this)) && null == a.next()) {
                        if (c.nodeType == t.Document || c.nodeType == t.Element) throw new u("Bad node type, unexpected " + c.nodeType);
                        return c.nodeValue
                    }
                }
                throw new u(this.get_name() + " does not only have data");
            }
            if (b.nodeType != t.PCData && b.nodeType != t.CData) throw new u(this.get_name() + " does not have data");
            if (b.nodeType == t.Document || b.nodeType == t.Element) throw new u("Bad node type, unexpected " + b.nodeType);
            return b.nodeValue
        },
        __class__: Wa
    ...
    Ra.doParse = function(a, b, c, f) {
        null == c && (c = 0);
        for (var k = null, p = 1, d = 1, g = null, e = 0, h = 0, l = 0, m = a.charCodeAt(c), n = new Ea, q = 1, v = -1; m == m;) {
            switch (p) {
                case 0:
                    switch (m) {
                        case 10:
                ...
                case 13:
                    60 == m ? (n.addSub(a,
                        e, c - e), d = t.createPCData(n.b), n = new Ea, f.addChild(d), h++, p = 0, d = 2) : 38 == m && (n.addSub(a, e, c - e), p = 18, q = 13, e = c + 1);
                    break;
                case 17:
                    93 == m && 93 == a.charCodeAt(c + 1) && 62 == a.charCodeAt(c + 2) && (m = t.createCData(B.substr(a, e, c - e)), f.addChild(m), h++, c += 2, p = 1);
                    break;
                case 2:
                    switch (m) {
                        case 33:
                            if (91 == a.charCodeAt(c + 1)) {
                                c += 2;
                                if ("CDATA[" != B.substr(a, c, 6).toUpperCase()) throw new u("Expected <![CDATA[");
                                c += 5;
                                p = 17
                            } else if (68 == a.charCodeAt(c + 1) || 100 == a.charCodeAt(c + 1)) {
                                if ("OCTYPE" != B.substr(a, c + 2, 6).toUpperCase()) throw new u("Expected <!DOCTYPE");
                                c += 8;
                                p = 16
                            } else {
                ...
                case 8:
                    switch (m) {
                        case 38:
                            ...
                            break;
                        case 62:
                            if (b) throw new u("Invalid unescaped " + String.fromCharCode(m) + " in attribute value");
                            m == v && (n.addSub(a, e, c - e), d = n.b, n = new Ea, k.set(g, d), p = 0, d = 4);
                            break;
                        case 60:
                            if (b) throw new u("Invalid unescaped " + String.fromCharCode(m) + " in attribute value");
                            m == v && (n.addSub(a, e, c - e), d = n.b, n = new Ea, k.set(g, d), p = 0, d = 4);
                ...
                case 10:
                    if (!(97 <= m && 122 >= m || 65 <= m && 90 >= m || 48 <= m && 57 >= m || 58 == m || 46 == m || 95 == m || 45 == m)) {
                        ...
                        d = B.substr(a, e, c - e);
                        if (f.nodeType != t.Element) throw new u("Bad node type, expected Element but found " + f.nodeType);
                        if (d != f.nodeName) throw new u("Expected </" + function(a) {
                                if (f.nodeType != t.Element) throw "Bad node type, expected Element but found " + f.nodeType;
                                return f.nodeName
                            }(this) +
                            ">");
                        p = 0;
                    ...
                    break;
                case 15:
                    45 == m && 45 == a.charCodeAt(c + 1) && 62 == a.charCodeAt(c + 2) && (m = t.createComment(B.substr(a, e, c - e)), f.addChild(m), h++, c += 2, p = 1);
                    break;
                case 16:
                    91 == m ? l++ : 93 == m ? l-- : 62 == m && 0 == l && (m = t.createDocType(B.substr(a, e, c - e)), f.addChild(m), h++, p = 1);
                    break;
                case 14:
                    63 == m && 62 == a.charCodeAt(c + 1) && (c++, m = B.substr(a, e + 1, c - e - 2), m = t.createProcessingInstruction(m), f.addChild(m), h++, p = 1);
                    break;
                case 18:
                    if (59 == m) {
                        e = B.substr(a, e, c - e);
                        if (35 == e.charCodeAt(0)) e = 120 == e.charCodeAt(1) ? r.parseInt("0" + B.substr(e,
                            1, e.length - 1)) : r.parseInt(B.substr(e, 1, e.length - 1)), n.b += String.fromCharCode(e);
                        ...
                        if (b) throw new u("Invalid character in entity: " + String.fromCharCode(m));
                        n.b += "&";
                        n.addSub(a, e, c - e);
                        c--;
                        e = c + 1;
        ...
        1 == p && (e = c, p = 13);
        if (13 == p) {
            if (c != e || 0 == h) n.addSub(a, e, c - e), a =
                t.createPCData(n.b), f.addChild(a), h++;
            return c
        }
        if (!b && 18 == p && 13 == q) return n.b += "&", n.addSub(a, e, c - e), a = t.createPCData(n.b), f.addChild(a), h++, c;
            ...
            case "object":
                if (a instanceof Array) {
                    if (a.__enum__) {
                        ...
                        c = a[0] + "(";
                        b += "\t";
                        for (var f = 2, k = a.length; f < k;) var p = f++,
                            c = 2 != p ? c + ("," + K.__string_rec(a[p], b)) : c + K.__string_rec(a[p],
                                b);
                        return c + ")"
                    }
                    c = a.length;
                    f = "[";
                    b += "\t";
                    for (k = 0; k < c;) p = k++, f += (0 < p ? "," : "") + K.__string_rec(a[p], b);
                    return f + "]"
                }
                try {
                    f = a.toString
                ...
                for (c in a) k && !a.hasOwnProperty(c) || "prototype" == c || "__class__" == c || "__super__" == c || "__interfaces__" == c || "__properties__" == c || (2 != f.length && (f += ", \n"), f += b + c + " : " + K.__string_rec(a[c],
                    b));
                b = b.substring(1);
                return f + ("\n" + b + "}");
            case "function":
    ...
    K.__instanceof = function(a, b) {
        ...
        switch (b) {
            ...
            default:
                ...
                return b == Ne && null != a.__name__ || b == Oe && null != a.__ename__ ? !0 : a.__enum__ == b
        }
    };
    ...
    var te = function(a,
        ...
        if (0 > this.offset || 0 > this.length || this.offset + this.length > a.byteLength) throw new u(ra.OutsideBounds);
    };
    ...
    te.prototype = {
        ...
        getInt32: function(a, b) {
            var c = this.offset + a,
                ...
                p = this.buf.a[c++],
                c = this.buf.a[c++];
            return b ? f | k << 8 | p << 16 | c << 24 : c | p << 8 | k << 16 | f << 24
        },
        ...
        setUint32: function(a, b, c) {
            a += this.offset;
            c ? (this.buf.a[a++] = b & 255, this.buf.a[a++] = b >> 8 & 255,
                this.buf.a[a++] = b >> 16 & 255, this.buf.a[a++] = b >>> 24) : (this.buf.a[a++] = b >>> 24, this.buf.a[a++] = b >> 16 & 255, this.buf.a[a++] = b >> 8 & 255, this.buf.a[a++] = b & 255)
        },
    ...
    Ta._new = function(a,
        ...
        if ("number" == typeof a) {
            ...
            c.byteOffset = 0;
            c.buffer = new Ga(c)
        } else if (K.__instanceof(a, Ga)) null == b && (b = 0), null == c && (c = a.byteLength - b), c = 0 == b ? a.a : a.a.slice(b, b + c), c.byteLength = c.length, c.byteOffset = b, c.buffer = a;
        else if (a instanceof Array && null == a.__enum__) c = a.slice(), c.byteLength = c.length, c.byteOffset = 0, c.buffer = new Ga(c);
    ...
    Ta._set = function(a, b) {
        if (K.__instanceof(a.buffer,
                Ga)) {
            if (a.byteLength + b > this.byteLength) throw new u("set() outside of range");
    ...
    s.prototype = {
        ...
        onMessage: function(a, b) {
            if (null != this.$aF) {
                var c = this.$aF.$pF;
                if (null != c && (c = null != Sa[a] ? c.getReserved(a) : c.h[a], null != c && null != c.$oG)) return c.emit(b), !0
            }
            return !1
        },
        ...
        dispose: function() {
            null != this.owner ? this.owner.remove(this) : null != this.$aF && this.$aF.$rF()
        },
    ...
    h.prototype = {
        ...
        remove: function(a) {
            for (var b = null, c = this.firstComponent; null != c;) {
                var f = c.next;
                if (c == a) return null == b ?
                    this.firstComponent = f : (b.owner = this, b.next = f), a = c.get_entitySlot(), delete this.$zF[a], 0 != (c.$ZF & 1) && (c.onStop(), c.$ZF &= -2), c.onRemoved(), c.owner = null, c.next = null, !0;
                b = c;
                c = f
            }
            return !1
    ...
    xa.prototype = {
        init: function() {
            ...
            var f = 0,
                k = function(c) {
                    if (!(1E3 > c.timeStamp -
                        ...
                        switch (c.type) {
                            case "mousedown":
                                c.target == b && (c.preventDefault(), a.$FG.$IN(p, k, c.button), b.focus());
                                break;
                            case "mousemove":
                                a.$FG.$MN(p, k);
                                break;
                            ...
                            case "mousewheel":
                            case "DOMMouseScroll":
                                a.$FG.$NN(p, k, "mousewheel" == c.type ? c.wheelDelta / 40 : -c.detail) && c.preventDefault()
                        }
                    }
                };
            ...
            if (p || 1 < k) {
                ...
                k = function(b) {
                    ...
                    switch (b.type) {
                        ...
                        case "pointermove":
                            b.preventDefault();
                            for (b = 0; b < c.length;) e = c[b], ++b, g = a.$CG(e, k), h = a.$DG(e, k), d.$MN((p ? e.identifier : e.pointerId) | 0, g, h);
                            break;
                        case "touchend":
                        case "touchcancel":
                        case "MSPointerUp":
                        case "pointerup":
                            for (b = 0; b < c.length;) e = c[b], ++b, g = a.$CG(e, k), h = a.$DG(e, k), d.$JN((p ? e.identifier : e.pointerId) | 0, g, h)
                    }
                };
                p ? (b.addEventListener("touchstart", k, !1), b.addEventListener("touchmove", k, !1),
                    b.addEventListener("touchend", k, !1), b.addEventListener("touchcancel", k, !1)) : (b.addEventListener("MSPointerDown", k, !1), b.addEventListener("MSPointerMove", k, !1), b.addEventListener("MSPointerUp", k, !1))
            } else this.$JG = new Xb;
            ...
            null != g.value ? (k = function(a) {
                m.hidden.set__(T.field(window.document, g.field))
            }, k(null), window.document.addEventListener(g.prefix + "visibilitychange",
                k, !1)) : (k = function(a) {
                m.hidden.set__("pagehide" == a.type)
            }, window.addEventListener("pageshow", k, !1), window.addEventListener("pagehide", k, !1));
            ...
            la.$dN("fullscreen") &&
                this.$JG.get_supported() && this.$IG.get_fullscreenSupported() && this.$JG.up.connect(function(b) {
                    a.$IG.fullscreen.$bG || a.$IG.requestFullscreen()
                });
            var v = la.$eN();
            null != v && (this.$IG.fullscreen.get_changed().connect(function(b, c) {
        ...
        $BG: function(a) {
            var b = (a - this.$VG) / 1E3;
            this.$VG = a;
            m.hidden.$bG || (this.$WG ? this.$WG = !1 : (this.$XG && (this.$XG = !1, this.$IG.$XS(null)), this.$AG.$BG(b), this.$AG.$xI(this.$HG)))
        },
        getKeyboard: function() {
            ...
            if (null == this.$PG) {
                ...
                if (null != window.history && null != (Le = window.history, D(Le, Le.pushState))) {
                    var c = !1,
                        f = function() {
                    ...
                    window.addEventListener("popstate", function(b) {
                        c && (null != a.$PG.backButton.$oG ? (f(), a.$PG.backButton.emit()) : window.history.back())
                    });
                    if (A.$gS) this.$GG.down.connect(function(a) {
                        f()
                    }).once();
                    else f()
                }
        ...
        $EG: function(a) {
            if (0 <= window.navigator.userAgent.indexOf("Windows Phone")) return new qb(a);
            try {
    ...
    ga.prototype = {
        $gG: function(a, b) {
            var c = this,
                f = new eb(this, a);
            this.$oG == ga.$qG ? this.$iG(function() {
                c.$lG(f, b)
            }) : this.$lG(f, b);
            return f
        },
    ...
    rb.prototype = v(ga.prototype, {
        ...
        $rG: function(a, b) {
            for (var c = this.$jG(), f = c; null != f;) f.$eG(a, b), f.stayInList || f.dispose(), f = f.$dG;
            this.$kG(c)
        },
        __class__: rb
    });
    ...
    Ya.prototype = v(ga.prototype, {
        ...
        $rG: function() {
            for (var a = this.$jG(), b = a; null != b;) b.$eG(), b.stayInList || b.dispose(), b = b.$dG;
            this.$kG(a)
        },
        __class__: Ya
    });
    ...
    R.prototype = v(ga.prototype, {
        ...
        $rG: function(a) {
            for (var b = this.$jG(), c = b; null != c;) c.$eG(a), c.stayInList || c.dispose(), c = c.$dG;
            this.$kG(b)
        },
        __class__: R
    });
    ...
    O.prototype = v(fa.prototype, {
        set__: function(a) {
            this.$sG = null;
            return fa.prototype.set__.call(this,
                a)
        },
        update: function(a) {
            null != this.$sG && (fa.prototype.set__.call(this, this.$sG.update(a)), this.$sG.isComplete() && (this.$sG = null))
        },
    ...
    m.$tG = function() {
        null ==
            m.$wG && (m.$wG = m.$vG.init(), m.$wG = m.$wG.then(function(a) {
                return Za.init()
            }));
        return m.$wG
    };
    ...
    Za.init = function() {
        return m.$vG.getLocalStorage().get("LegacyStorage", {}).then(function(a) {
    ...
    fb.prototype = {
        update: function(a) {
            this.elapsed += a;
            return this.elapsed >= this.$PH ? this.$OH : this.$NH + (this.$OH - this.$NH) * this.$QH(this.elapsed / this.$PH)
        },
        isComplete: function() {
    ...
    var q = l["kit.asset.AssetFormat"] = {
        ...
        __constructs__: "WEBP JXR PNG JPG GIF _2DKD _2DKP _2DKE MP3 M4A OPUS OGG WAV WOFF TTF OTF SWF MP4 WEBM Data".split(" ")
    };
    q.WEBP = ["WEBP", 0];
    q.WEBP.toString = n;
    q.WEBP.__enum__ = q;
    ...
    pa.fromAssets = function(a, b, c) {
        ...
        for (var f = la.$dN("assets"), k = 0, p = T.fields(f); k < p.length;) {
            ...
            if ($.startsWith(d, a)) {
                ...
                if (0 < e.length) {
                    var g = new Qa("^-([\\d\\.]+)%$", "");
                    g.match(e) && (e = r.parseFloat(g.matched(1)), c.push(new bc(d, e / 100)))
        ...
        for (f = 0; f < b.length;) {
            ...
            p = h;
            d = 0;
            for (e = k.split("/"); d < e.length;) g = e[d], ++d, p += "/" + encodeURIComponent(g);
    ...
    ta.prototype = {
        ...
        invert: function() {
            ...
            if (0 == a) return !1;
            this.set(this.m11 / a, -this.m10 / a, -this.m01 / a, this.m00 / a, (this.m01 * this.m12 - this.m11 * this.m02) / a, (this.m10 * this.m02 - this.m00 * this.m12) / a);
            return !0
        },
    ...
    w.hitTest = function(a, b, c) {
        ...
        var f = a.$zF[1];
        if (null != f) {
            if (6 != (f.$ZF & 6) || null != f.$HI && null !=
                f.$HI.$FK || !f.getLocalMatrix().inverseTransform(b, c, w.$OI)) return null;
            b = w.$OI.x;
            c = w.$OI.y;
            var k = f.get_scissor();
    ...
    w.$II = function(a, b, c) {
        if (a.active) {
            ...
            if (null != p) {
                ...
                b.save();
                null != e && null != e.$EK && 0 != (p.$ZF & 128) && (c = e.$EK.owner,
                    null != c && (b.beginMask(), w.$II(c, b, !1), b.endMask()));
                if (null != e) {
                    var g = !1;
                    c = !1;
                    for (var h = 0, l = 0, n = 0, q = 0, r = 0, v = e.$GK; r < v.length;) {
                        var u = v[r];
                        ++r;
                        u.active && (g = !0, c = c || !u.outputOnly, h = Math.max(h, u.paddingTop), l = Math.max(l, u.paddingRight), n = Math.max(n, u.paddingBottom), q = Math.max(q, u.paddingLeft))
                    }
                    if (g && m.$vG.$HG.get_filterSupported()) {
                        ...
                        r = p.getViewMatrix();
                        k = new Ca;
                        k.set(1.79769313486231E308, 1.79769313486231E308, -1.79769313486231E308, -1.79769313486231E308);
                        var t =
                            e.$HK;
                        if (null != t) {
                            var v = t.x,
                                ...
                                s = v + t.width,
                                t = u + t.height;
                            s > v && t > u && (w.$NI(r, v, u, k), w.$NI(r, s, u, k), w.$NI(r, s, t, k), w.$NI(r, v, t, k))
                        } else w.$MI(a, g, k);
                        k.width -= k.x;
                        k.height -= k.y;
                        if (!k.get_empty()) {
                            ...
                            c && (f = f.get_graphics(), f.save(), f.translate(-k.x, -k.y), f.transform(r.m00, r.m10, r.m01, r.m11, r.m02, r.m12), w.$KI(p, f), w.$JI(a, f), f.restore());
                            f = 0;
                            for (c = e.$GK; f < c.length;) h = c[f], ++f, w.$QI.apply(h);
                            f = w.$QI.$nH();
                            null != g && (c = g.clone(w.$PI), c.invert(), b.transform(c.m00, c.m10, c.m01, c.m11, c.m02, c.m12))
                        }
                    }
                }
                1 > d && b.multiplyAlpha(d);
                null == f && (d = p.getLocalMatrix(), c = d.m02, h = d.m12, 0 != (p.$ZF & 32) && (c = Math.round(c), h = Math.round(h)), b.transform(d.m00, d.m10, d.m01, d.m11, c, h));
                null != e && (1 == e.$AK.$bG && 1 == e.$BK.$bG && 1 == e.$CK.$bG || b.tint(e.$AK.$bG, e.$BK.$bG, e.$CK.$bG), null != e.$$J && b.setBlendMode(e.$$J), e = e.$_J, null != e && null == f && b.applyScissor(e.x, e.y, e.width, e.height));
                null == f ? w.$KI(p, b) : b.drawSubTexture(f, k.x, k.y, 0, 0, k.width,
                    k.height)
            }
            null == f && w.$JI(a, b);
            null != p && b.restore()
    ...
    w.$MI = function(a, b, c) {
        if (a.active) {
            var f = a.$zF[1];
            if (null != f) {
                if (0 == (f.$ZF & 2) || null != f.$HI &&
                    null != f.$HI.$FK) return null;
                b = null != b ? ta.multiply(b, f.getLocalMatrix()) : f.getLocalMatrix();
                var k = f.getNaturalWidth(),
                    f = f.getNaturalHeight();
                0 < k && 0 < f && (w.$NI(b, 0, 0, c), w.$NI(b, k, 0, c), w.$NI(b, k, f, c), w.$NI(b, 0, f, c))
            }
            k = a.$zF[7];
            if (null != k)
                for (var k = k.occludedScenes, f = 0, p = k.length; f < p;) w.$MI(k[f], b, c), ++f;
    ...
    w.prototype = v(s.prototype, {
        ...
        getLocalMatrix: function() {
            0 != (this.$ZF & 8) && (this.$ZF &= -9, this.$zH.compose(this.x.$bG, this.y.$bG, this.scaleX.$bG, this.scaleY.$bG, 3.141592653589793 * this.rotation.$bG / 180), this.$zH.translate(-this.anchorX.$bG, -this.anchorY.$bG));
            return this.$zH
        },
        getViewMatrix: function() {
            if (this.$sH()) {
                var a =
                    this.$tH();
                this.$$H = null != a ? ta.multiply(a.getViewMatrix(), this.getLocalMatrix(), this.$$H) : this.getLocalMatrix().clone(this.$$H);
                this.$ZF &= -17;
                null != a && (this.$AI = a.$_H);
                ++this.$_H
            }
        ...
        setTint: function(a) {
            if (null != this.$HI ||
                16777215 != a) this.get_tintR().set__((a & 16711680) / 16711680), this.get_tintG().set__((a & 65280) / 65280), this.get_tintB().set__((a & 255) / 255);
            return this
        },
        setScale: function(a) {
            this.scaleX.set__(a);
        ...
        $uH: function() {
            var a = this;
            null == this.$GI && m.$vG.$AG.$RQ(function() {
        ...
        set_mask: function(a) {
            ...
            null != a && (b = a.$HI, null == b && (b = a.$HI = new Oa), null != b.$FK && b.$FK.set_mask(null), b.$FK = this);
            return this.$HI.$EK = a
        },
        ...
        $xH: function(a) {
            0 == (this.$ZF & 64) && (this.$ZF |= 64, null != this.$EI || null != this.$FI) && (null != this.$EI && this.$EI.emit(a), this.$uH())
        },
        $yH: function(a) {
            switch (a.source[1]) {
                case 1:
                    null != this.$FI && 0 != (this.$ZF & 64) && this.$FI.emit(a), this.$ZF &= -65, null != this.$GI && (this.$GI.dispose(), this.$GI =
                        null)
            }
    ...
    sc.prototype =
        v(y.prototype, {
            $xI: function(a) {
                a.drawSubTexture(this.$NJ, this.$OJ, this.$PJ, this.$QJ, this.$RJ, this.$SJ, this.$TJ)
            },
            __class__: sc
        });
    ...
    Bc.prototype = v(y.prototype, {
        $xI: function(a) {
            a.strokeCircle(this.$UJ, this.$YJ, this.$ZJ, this.$aJ, this.$cJ, this.$bJ)
        },
        __class__: Bc
    });
    ...
    Ec.prototype = v(y.prototype, {
        $xI: function(a) {
            a.strokeEllipse(this.$UJ, this.$YJ, this.$ZJ, this.$dJ, this.$eJ, this.$cJ, this.$bJ)
        },
        __class__: Ec
    });
    ...
    Fc.prototype = v(y.prototype, {
        $xI: function(a) {
            a.fillArc(this.$UJ, this.$YJ, this.$ZJ, this.$aJ, this.$fJ, this.$gJ,
                this.$bJ)
        },
        __class__: Fc
    });
    ...
    Gc.prototype = v(y.prototype, {
        $xI: function(a) {
            a.strokeArc(this.$UJ, this.$YJ, this.$ZJ, this.$aJ, this.$fJ, this.$gJ, this.$cJ, this.$bJ)
        },
        __class__: Gc
    });
    ...
    ba.prototype = {
        ...
        $fH: function() {
            ...
            for (var a = new hb(this.$iH.toString()), b = new va, c = this.name.lastIndexOf("/"), c = 0 <= c ? B.substr(this.name, 0, c + 1) : "", f = a.$qJ(); f.hasNext();) switch (f.next()) {
                case "info":
                    for (var k =
                            a.$rJ(); k.hasNext();) {
                        var p = k.next();
                    ...
                    break;
                case "common":
                    for (k = a.$rJ(); k.hasNext();) switch (p = k.next(), p.$xJ) {
                        case "lineHeight":
                ...
                case "char":
                    k = null;
                    for (p = a.$rJ(); p.hasNext();) switch (d = p.next(),
                        d.$xJ) {
                        case "id":
                            k = new Jc(d.$yJ());
                            break;
    ...
    var bb = function(a, b, c, f, k, p) {
        ...
        for (g = 0; g < this.$kJ.length;) {
            ...
            n || h == a ? (n && (0 <= b ? (this.$kJ[b] = a, m = this.$nJ[b], g = b) : this.$kJ.splice(g, 0, a)), b = -1, l = this.$oJ, p()) : (32 == h.charCode && (b = g), m += h.xAdvance + k, l = ha.max(l, h.height + h.yOffset),
                g + 1 < this.$kJ.length && (m += h.getKerning(this.$kJ[g + 1].charCode)));
            ++g
        }
        p();
        k = 0;
    ...
    Nd.prototype = {
        ...
        $zJ: function() {
            return 34 != this.$bG.charCodeAt(0) ? null : B.substr(this.$bG, 1, this.$bG.length -
                2)
        },
        __class__: Nd
    };
    ...
    I.prototype = v(w.prototype, {
        ...
        getNaturalWidth: function() {
            this.$KK();
            return 0 < this.wrapWidth.$bG ? this.wrapWidth.$bG : this.$NK.bounds.width
        },
        getNaturalHeight: function() {
            this.$KK();
        ...
        set_align: function(a) {
            a != this.$MK && (this.$MK = a, this.$ZF |=
                256);
            return a
        },
        $KK: function() {
            0 != (this.$ZF & 256) && (this.$ZF &= -257, this.$NK = this.$mJ.layoutText(this.$LK, this.$MK, this.wrapWidth.$bG, this.letterSpacing.$bG, this.lineSpacing.$bG))
        },
        onUpdate: function(a) {
            w.prototype.onUpdate.call(this, a);
    ...
    var we = function() {
        ...
        this.paddingTop = this.paddingRight =
            this.paddingBottom = this.paddingLeft = 0;
        this.outputOnly = !1;
        this.active = !0
    };
    ...
    we.prototype = {
        ...
        $ZK: function() {
            null == this.$dK && (this.$dK = null != this.$cK ? this.$cK + "@" + this.$bK : this.$bK);
            return this.$dK
        },
        __class__: we
    };
    ...
    var ub = function(a, b) {
        ...
        c = a.origin;
        null != c ? (this.anchorX = c[0], this.anchorY = c[1]) : this.anchorY = this.anchorX =
            0;
        c = a.scale;
    ...
    var Ud = function(a, b) {
        ...
        if (null != f.videos)
            for (k = 0, d = f.videos; k < d.length;) e = d[k], ++k,
                g = a.getVideo(b + "/" + oa.removeFileExtension(e.file), !1), e = e.id, g = new Mc(e, g), this.$oK.set(e, g);
        k = [];
        d = 0;
        for (g = f.movies; d < g.length;) e = g[d], ++d, e = new vb(this, e), k.push(e), this.$oK.set(e.$kK, e);
        if (null != f.scenes)
            for (d = 0, g = f.scenes; d < g.length;) e = g[d], ++d, e = new vb(this, e), k.push(e), this.scenes.push(e);
        ...
        for (d = 0; d < f.length;) {
            ...
            if (null != e.mask) {
                var h = a.getTexture(b + "/" + oa.removeFileExtension(e.mask)),
                    l = m.$vG.$HG.createTexture(g.get_width(),
                        g.get_height()),
                    n = l.get_graphics();
                n.save();
            ...
            h = 0;
            for (e = e.textures; h < e.length;) l = e[h], ++h, l = new ub(l, g), this.$oK.set(l.$kK, l)
        }
        for (var q = null, f = q = function(a) {
                for (var b = a.keyframes, f = b.length, k = 0; k < f;) {
                    ...
                    p.tweened && 1 == p.duration && d + 1 < f && (d = b[d + 1], d.visible && null != d.$hL || (p.visible = !1))
                }
                b = 0;
                for (a = a.childLayers; b <
                    a.length;) f = a[b], ++b, q(f)
            }, d = 0; d < k.length;)
            for (e = k[d], ++d, g = 0, e = e.layers; g < e.length;) h = e[g], ++g, f(h)
    };
    ...
    Nc.prototype =
        v(s.prototype, {
            ...
            play: function(a, b) {
                null == b && (b = !0);
                if (b || null == this.$tK || this.$tK.symbol.$kK != a) this.$tK = this.$pK(a);
                return this
            },
            loop: function(a, b) {
                null == b && (b = !0);
                if (b || null == this.$uK || this.$uK.symbol.$kK != a) this.$tK = null, this.$uK = this.$pK(a);
                return this
            },
            onAdded: function() {
            ...
            onUpdate: function(a) {
                null !=
                    this.$tK && this.$tK.$AL + a > this.$tK.symbol.duration && (this.$tK = null, this.$rK(this.$uK))
            },
            $pK: function(a) {
                var b;
                null != this.$wK ? (b = this.$wK.get(a), null != b ? b.set_position(0) : (b = this.$qK(a), this.$wK.set(a, b))) : b = this.$qK(a);
                return this.$rK(b)
            },
            $qK: function(a) {
    ...
    var Ia = function(a) {
        ...
        if (a.button) {
            var d = 0 / a.frameRate,
                ...
                h = !1,
                l = !1,
                c = new Ca(1.79769313486231E308, 1.79769313486231E308, -1.79769313486231E308, -1.79769313486231E308),
                f = 0;
            ...
            this.get_pointerIn().connect(function(a) {
                ...
                n = m.$vG.$GG.move.connect(function(a) {
                    null == b.owner && (n.dispose(), m.$vG.$FG.get_cursor() == ea.Button && m.$vG.$FG.set_cursor(ea.Default))
                })
            });
    ...
    Ia.prototype = v(w.prototype, {
        containsLocal: function(a, b) {
            return null != this.$FL && a >= this.$FL.x && a < this.$FL.width && b >= this.$FL.y && b < this.$FL.height
        },
        onAdded: function() {
        ...
        onUpdate: function(a) {
            ...
            switch (this.$ZF & 6912) {
                case 0:
                    0 <= this.speed.$bG && (this.$AL += this.speed.$bG * a, this.$AL > this.symbol.duration && (0 != (this.$ZF & 1024) ? (this.$AL = this.symbol.duration, this.$ZF |= 2048) : (this.$AL %= this.symbol.duration, null != this.$DL && this.$DL.emit())));
                    break;
                case 512:
                    this.$ZF &= -513
            }
    ...
    var ib = function(a) {
        ...
        if (0 < a.childLayers.length)
            for (k =
                new w, e = (new h).add(k), e.addChild(this.$ML), this.$ML = b = new h, f = new h, a.mask && (this.$SL = new w, this.$SL.set_mask(k), f.add(this.$SL)), b.addChild(f), b.addChild(e), k = 0, a = a.childLayers; k < a.length;) e = a[k], ++k, e = new ib(e), this.$eL.push(e), f.addChild(e.$ML)
    };
    l.$CAB = ib;
    ib.__name__ = ["$CAB"];
    ib.$fL = function(a, b) {
    ...
    ib.prototype = {
        $VL: function(a, b) {
            null != a.sound && null != a.sound.sound && (this.$ML.emitMessageToParents("MovieSprite.FRAME_SOUND", new Oc(this.$ML, a)).handled || a.sound.sound.play());
            if (null != b) {
                var c = a.label;
                null != c && b.emit(c)
            }
            null != a.actions && this.$ML.emitMessageToParents("MovieSprite.FRAME_ACTION", new Oc(this.$ML, a))
        },
        $WL: function(a) {
            ...
            if (0 <= this.$PL) {
                for (var b = this.$QL.keyframes, c = this.$OL, f = this.$PL + 1, k = b.length; f < k;) {
                    var d = f++;
                    this.$VL(b[d],
                        a);
        ...
        $XL: function(a, b, c) {
            ...
            k = f.length - 1;
            d = this.$PL;
            for (this.$PL = -1; this.$PL < k && f[this.$PL + 1].index <= a;) ++this.$PL;
            this.$PL != d && (this.$NL = !0);
        ...
        $YL: function(a, b, c) {
            ...
            var f = this.$QL.keyframes,
                e = f.length - 1,
                k = this.$PL;
            if (a > this.$QL.frames) this.$PL =
                e, this.$NL = !0;
            else
                for (; this.$PL < e && f[this.$PL + 1].index <= a;) ++this.$PL, this.$NL = !0;
            if (null != this.$dL) {
                var d = f[this.$PL],
                    g;
                if (this.$NL) {
                    if (this.$NL = !1, g = this.$dL[this.$PL], g != this.$cL.$zF[1]) {
                        var h;
                ...
                if (this.$RL && (h = d.visible && null != d.symbol && a <= this.$QL.frames, g.set_visible(h), null != this.$SL && this.$SL.set_maskEnabled(h), h)) {
                    h = d.x;
                    var l = d.y,
                        m = d.scaleX,
                        n = d.scaleY,
                    ...
                    if (d.tweened && this.$PL <
                        ...
                        if (16777215 != s || 16777215 != t) {
                            ...
                            var x = (t & 65280) >> 8,
                                ...
                                x = x + ((((s & 65280) >> 8) - x) * e | 0),
                                t = t + (((s & 255) - t) * e | 0),
                                t = w + ((((s & 16711680) >> 16) - w) * e | 0) << 16 | x << 8 | t
                        }
                    }
                    ...
                    g.alpha.set__(u);
                    g.setTint(t);
                    null == d.blendMode && null == g.get_blendMode() || g.set_blendMode(d.blendMode)
                }
            }
            if (0 != c)
                for (1 == c ? k = -1 : 2 == c && 0 <= this.$PL && f[this.$PL].index == a && (k = this.$PL - 1), a = this.$OL, c = k, k = this.$PL; c < k;)
        ...
        $ZL: function(a) {
            ...
            if (null != this.$dL)
                for (b = 0, c = this.$dL; b < c.length;) f =
                    c[b], ++b, f.set_pixelSnapping(a)
        },
        $zK: function() {
    ...
    var Pc = function(a, b) {
        ...
        if (null != b.childLayers)
            for (c = 0, f = b.childLayers; c < f.length;) k = f[c], ++c, k = new Pc(a, k), k.frames > this.frames && (this.frames = k.frames), this.childLayers.push(k)
    };
    ...
    var Vd = function(a, b, c) {
        ...
        this.alpha = 1;
        this.skewX =
            this.skewY = this.pivotX = this.pivotY = 0;
    ...
    Ua.prototype = v(w.prototype, {
        ...
        getNaturalWidth: function() {
            return null != this.$kL ? this.$kL.get_video().get_width() :
                0
        },
        getNaturalHeight: function() {
    ...
    var wb = function(a, b) {
        ...
        if (0 == f.length) this.$vM();
            ...
            this.$yM =
                Ob.count(k);
            for (f = new Qb(k, k.arrayKeys()); f.hasNext();) k = [f.next()], this.$qM(k[0], function(a) {
                return function(f) {
                    if (null != f) {
                        ...
                        try {
                            ...
                            d instanceof u && (d = d.val), c.$wM(f, "Unexpected error: " + r.string(d))
                        }
                    } else switch (f = a[0][0], k = new Sc(0, 0), c.$zM.set(f.name, k), f.format[1]) {
                        case 8:
                        case 9:
                        case 10:
                        case 11:
    ...
    wb.prototype = {
        ...
        $uM: function(a, b, c) {
            ...
            a = 0 < c ? b / c : 0;
            a != this.$$M && (this.$$M = a, this.$oF.emitProgress(a), this.$oF.set_total(c), this.$oF.set_progress(b))
        },
        $vM: function() {
            this.$oF.$bW(this.$eI)
        },
    ...
    Ba.prototype = {
        $IN: function(a) {
            if (16777238 == a) return null != this.backButton.$oG ? (this.backButton.emit(), !0) : !1;
            this.$KN.h.hasOwnProperty(a) || (this.$KN.h[a] = !0, Ba.$LN.$hK(Ba.$LN.id + 1, Xd.$MQ(a)), this.down.emit(Ba.$LN));
            return !0
        },
        $JN: function(a) {
            this.$KN.h.hasOwnProperty(a) && (this.$KN.remove(a), Ba.$LN.$hK(Ba.$LN.id + 1, Xd.$MQ(a)), this.up.emit(Ba.$LN))
        },
        __class__: Ba
    };
    var Yd = function() {};
    l["kit.subsystem.MouseSystem"] =
        Yd;
    ...
    qa.prototype = {
        ...
        $IN: function(a, b, c) {
            this.$PN.h.hasOwnProperty(c) || (this.$PN.h[c] = !0, this.$IK(a, b, Zd.$fQ(c)), this.$GG.$IN(a,
                b, this.$jK), this.down.emit(qa.$LN))
        },
        $MN: function(a, b) {
            this.$IK(a, b, null);
        ...
        $JN: function(a, b, c) {
            this.$PN.h.hasOwnProperty(c) && (this.$PN.remove(c), this.$IK(a, b, Zd.$fQ(c)), this.$GG.$JN(a, b, this.$jK), this.up.emit(qa.$LN))
        },
        $NN: function(a, b, c) {
            this.$yI = a;
            this.$zI = b;
    ...
    Wb.prototype = {
        ...
        $MN: function(a,
            b, c) {
            a = this.$XN.h[a];
            null != a && (a.$hK(b, c), this.$VN == a && this.$GG.$MN(b, c, a.$jK), this.move.emit(a))
        },
        $JN: function(a, b, c) {
            var f = this.$XN.h[a];
            null != f && (f.$hK(b, c), this.$XN.remove(a), B.remove(this.$VJ, f), this.$VN == f && (this.$VN = null, this.$GG.$JN(b, c, f.$jK)), this.up.emit(f))
        },
        __class__: Wb
    };
    var xe = function() {};
    ...
    xe.$YN = function() {
        m.$tG().then(function(a) {
            try {
                m.$vG.getExternal().call("console.info", ["Built with 2DKit, http://2dkit.com"])
            } catch (b) {
    ...
    Vc.prototype = {
        ...
        $rN: function(a) {
            ...
            this.$tN = 0;
            if (null != this.$vN && a)
                for (a = b.iterator(); a.hasNext();) b = a.next(), this.$vN(b.$xJ, b.$fK)
        },
        dispose: function() {
            this.$rN()
        },
        $sN: function(a) {
            for (; this.$tN > this.$uN;) {
                var b = this.$pN(a);
                if (null != b) null != this.$vN && this.$vN(b.$xJ, b.$fK), this.$yN.remove(b.$xJ), this.$tN -=
                    b.$hN;
                else break
            }
        },
    ...
    var Ld = function(a, b) {
        ...
        this.$PO = m.$vG.$HG.createTexture(c,
            f);
        this.$LJ = a;
        this.$MJ = b
    };
    ...
    Ld.prototype = {
        ...
        $RO: function(a) {
            null != a.$bK && (a.outputOnly || a.setUniformSampler2D("uTexture", this.$OO),
                a.setUniformVec2("uFilterPosition", this.$MO, this.$NO), this.$PO.renderFilter(a, this.$LJ, this.$MJ), a = this.$OO, this.$OO = this.$PO, this.$PO = a)
        },
        __class__: Ld
    };
    var Ab = function() {};
    ...
    Xa.prototype = {
        $hK: function() {
            if (1 == la.$dN("scaleMode")) {
                ...
                var b = la.$dN("width"),
                    ...
                    k = la.$dN("maxHeight"),
                    d = function() {
                        var d = Math.min(m.$vG.$IG.get_width() / b, m.$vG.$IG.get_height() / c);
                        a.setXY(m.$vG.$IG.get_width() / 2 - d * b / 2, m.$vG.$IG.get_height() / 2 - d * c / 2);
                        a.setScale(d);
                        f * d < m.$vG.$IG.get_width() || k * d < m.$vG.$IG.get_height() ?
                            (null == a.get_scissor() && a.set_scissor(new Ca), a.get_scissor().set(b / 2 - f / 2, c / 2 - k / 2, f, k)) : a.set_scissor(null)
                    };
                d();
        ...
        $BG: function(a) {
            if (!(0 >= a)) {
                0.5 < a ? 3 >= this.$UQ && (++this.$UQ, a = 0.016666666666666666) : this.$UQ = 0;
                if (null != this.$SQ) {
                    var b = this.$SQ;
                    this.$SQ = null;
                ...
                for (b = 0; b < this.$TQ.length;) c = this.$TQ[b], null == c || c.update(a) ? this.$TQ.splice(b, 1) : ++b;
                m.volume.update(a);
                Xa.$VQ(m.root, a);
                Xa.$VQ(this.$OQ, a)
            }
        ...
        $xI: function(a) {
            var b = a.graphics;
            null != b && (a.willRender(), w.$II(m.root, b, !0), w.$II(this.$OQ, b, !0), a.didRender())
        },
        $PQ: function(a) {
            this.$TQ.push(a)
        },
        ...
        function(a, b, c, f) {
            ...
            for (e = 2; e < k - 2;) {
                ...
                if (0.15 > u) {
                    var u = c[e - 4],
                        w = c[e - 3];
                    0 > (n - u) * (v - w) - (q - w) * (r - u) ? (a.push(n - s.x), a.push(q - s.y), a.push(n + m * f), a.push(q + l * f), a.push(n -
                        s.x), a.push(q - s.y), a.push(n + t.x * f), a.push(q + t.y * f)) : (a.push(n - m * f), a.push(q - l * f), a.push(n + s.x), a.push(q + s.y), a.push(n - t.x * f), a.push(q - t.y * f), a.push(n + s.x), a.push(q + s.y));
                    ++d
            ...
            a.push(h + f * l);
            a = 0;
            for (c = d - 1; a < c;) k = 2 * a++, b.push(k), b.push(k + 1), b.push(k + 2), b.push(k + 2), b.push(k + 3), b.push(k + 1);
            return !0
        };
    W.$cQ = function(a) {
    ...
    Yb.prototype = v(s.prototype, {
        ...
        onStart: function() {
            var a = this,
                b = la.$eN();
            null != b && m.$vG.$IG.orientation.watch(function(c, f) {
    ...
    Q.prototype = {
        ...
        $qQ: function(a, b, c, f, d) {
            var e = this.$CR,
                e = (255 * e.$HM & 255) << 16 | (255 * e.$JM & 255) << 8 | 255 * e.$LM & 255;
        ...
        drawSubTexture: function(a, b, c, f, d, e, g) {
            if (this.$BR) this.$BR = !1, this.$AR.globalCompositeOperation = "copy", this.drawSubTexture(a, b, c, f, d, e, g), this.$AR.globalCompositeOperation = "source-over";
            else {
                var h = a.$RN;
                f = a.$SN + f | 0;
                a = a.$TN + d | 0;
                ...
                c |= 0;
                d = h.$XH;
                this.$CR.$ER ? (h = this.$qQ(h.$RR, f, a, e, g), this.$AR.drawImage(h,
                    b * d, c * d, e * d, g * d)) : this.$AR.drawImage(h.$RR, f * d, a * d, e * d, g * d, b, c, e, g)
            }
        },
        drawPattern: function(a, b, c, f, d) {
            if (this.$BR) this.$BR = !1, this.$AR.globalCompositeOperation = "copy", this.drawPattern(a, b, c, f, d), this.$AR.globalCompositeOperation = "source-over";
            else {
                var e = this.$CR,
                    g = a.$RN.$XH;
                ...
                f |= 0;
                d |= 0;
                e.$FR ? this.$AR.rect(b, c, f, d) : (this.$AR.fillStyle = this.$yQ(a), this.$AR.fillRect(b, c, f * g, d * g));
                1 != g && this.$AR.restore()
            }
        },
        fillRect: function(a, b, c, f, d) {
            this.$BR ?
                (this.$BR = !1, this.$AR.globalCompositeOperation = "copy", this.fillRect(a, b, c, f, d), this.$AR.globalCompositeOperation = "source-over") : (b |= 0, c |= 0, f |= 0, d |= 0, this.$CR.$FR ? this.$AR.rect(b, c, f, d) : (this.$AR.fillStyle = this.$xQ(a), this.$AR.fillRect(b, c, f, d)))
        },
        fillTriangles: function(a, b, c) {
            this.$BR = !1;
            this.$rQ(b, c);
        ...
        fillArc: function(a, b, c, f, d, e, g) {
            ...
            this.$AR.beginPath();
            this.$AR.moveTo(b, c);
            this.$AR.arc(0, 0, f, 3.141592653589793 * d / 180, 3.141592653589793 * e / 180);
            this.$zQ(a)
        },
        strokeArc: function(a, b, c, f, d, e, g, h) {
            ...
            c = d + e;
            this.$AR.beginPath();
            this.$AR.arc(b, b, f, 3.141592653589793 * d / 180, 3.141592653589793 * c / 180);
            this.$_Q(a, g)
        },
        strokeLines: function(a, b, c) {
            this.$BR = !1;
        ...
        $xQ: function(a) {
            var b = this.$CR;
            b.$ER && (a = (b.$HM * (a & 16711680) / 16711680 * 255 & 255) << 16 | (b.$JM * (a & 65280) / 65280 * 255 & 255) << 8 | b.$LM * (a & 255) / 255 * 255 & 255);
            return A.$zS(a)
        },
        $yQ: function(a) {
            return this.$CR.$ER ? (a = this.$qQ(a.$RN.$RR, a.$SN, a.$TN, a.$LJ, a.$MJ), this.$AR.createPattern(a, "repeat")) : a.$KR()
        },
        $zQ: function(a) {
        ...
        $_Q: function(a, b) {
            this.$CR.$FR || (this.$AR.strokeStyle = this.$xQ(a), this.$AR.lineWidth = b, this.$AR.stroke())
        },
        __class__: Q
    };
    var $c = function() {
    ...
    ad.prototype = v(Ka.prototype, {
        $KR: function() {
            if (this.$MR != this.$RN.$SR || null == this.$LR) this.$MR = this.$RN.$SR, this.$LR = this.$RN.$UR(this.$SN, this.$TN, this.$LJ, this.$MJ);
            return this.$LR
        },
        __class__: ad
    });
    ...
    Db.prototype = v(V.prototype, {
        ...
        $UR: function(a, b, c, f) {
            var d = this.$VR(),
                e = this.$RR;
            if (0 != a || 0 != b || c != this.$PR || f != this.$QR) e = A.$tS(c, f), c = e.getContext("2d", null), c.globalCompositeOperation = "copy", c.drawImage(this.$RR, -a, -b);
            return d.createPattern(e,
                "repeat")
        },
        $VR: function() {
            K.__instanceof(this.$RR, HTMLCanvasElement) || (this.$RR = A.$uS(this.$RR));
    ...
    J.$eR = function() {
        ...
        for (var c = [{
                    ...
                    format: q.WEBM,
                    mimeType: "video/webm"
                }], b = 0 <= window.navigator.userAgent.indexOf("2DKSim") ?
                c : b.concat(c), c = [], f = 0; f < b.length;) {
            var d = b[f];
            ++f;
            var e = "";
            try {
    ...
    J.$fR = function() {
        if (J.$qR) {
            J.$qR = !1;
            if ((new Qa("\\bSilk\\b", "")).match(window.navigator.userAgent) || null == window.Blob) return !1;
    ...
    J.prototype = v(wb.prototype, {
        $rM: function(a, b) {
            ...
            switch (b.format[1]) {
                ...
                case 4:
                    ...
                    !d && J.$fR() ? this.$bR(a, b, "blob", function(a) {
                ...
                case 11:
                case 12:
                    if (E.get_supported()) this.$bR(a, b, "arraybuffer", function(a) {
                        E.$ST.decodeAudioData(a, function(a) {
                            c.$tM(b, new E(a))
                        }, function() {
                            c.$tM(b, ya.$DO())
                        })
                        ...
                        d.$IO(e, "error",
                            function(a) {
                                J.$hR(g);
                                a = e.error.code;
                                3 == a || 4 == a ? c.$tM(b, ya.$DO()) : c.$wM(b, "Failed to load audio: " + e.error.code)
                            });
                        d.$HO(e, "progress", function(a) {
                            0 < e.buffered.length && 0 < e.duration && (a = e.buffered.end(0) / e.duration, c.$uM(b, a * b.bytes | 0, b.bytes))
                        });
                        e.src = a;
                        e.load()
                    }
                ...
                case 15:
                    (function(a, f) {
                        ...
                        ++J.$pR;
                        if ("undefined" != typeof FontFace)(new FontFace(d, "url(" + a + ")", {})).load().then(function(a) {
                            ...
                            e.innerHTML = "@font-face{font-family:" + d + ";src:url(" + a + ");}";
                            ...
                            m.nextFrame(function(a) {
                                ...
                                return f = function() {
                                    ...
                                    5 <= a || g != h ? c.$tM(b, new mb(d, null, e)) : m.$vG.$AG.$RQ(f)
                                }
                            }(this))
                        }
                    })(a, !1);
        ...
        $sM: function(a) {
            var b = this;
            null == J.$mR && (J.$mR = new sa, J.$dR(function(a) {
                var f;
                f = window.navigator.isCocoonJS ? [q.TTF, q.WOFF] : [q.WOFF, q.OTF, q.TTF];
                a = b.$vG.getRenderer().getTextureAssetFormats().concat(a).concat(J.$eR()).concat(f).concat([q.Data]);
                J.$mR.$bW(a)
            }));
            J.$mR.then(a)
        },
            ...
            var d = this,
                ...
                g = function() {
                    ...
                    e.onprogress = function(a) {
                        l || (l = !0, h = window.setInterval(function() {
                            4 != e.readyState && 5E3 < Date.now() - g && !q() && (m(), d.$wM(b, "Download stalled"))
                        }, 1E3));
                        g = Date.now();
                        d.$uM(b, a.loaded,
                            a.total)
    ...
    Gb.prototype = {
        ...
        update: function(a) {
            ...
            return this.$FO.$bG || this.$WS ? (this.$ES = !1, this.$TS.dispose(), this.$US.dispose(), !0) : !1
        },
        dispose: function() {
            this.set_paused(!0);
            this.$FO.set__(!0)
        ...
        $QS: function() {
            var a = this;
            this.$SS.play();
            this.$ES || (xa.$ZG.$AG.$PQ(this), this.$ES = !0, this.$TS = m.volume.get_changed().connect(function(b, c) {
                a.$RS()
            }), this.$US = m.hidden.get_changed().connect(function(b,
                c) {
    ...
    var db = function(a) {
        ...
        this.resize = new Ya;
        this.$bS = db.$cS();
        A.$$S() || (A.$oS(this.$TG, "transform-origin", "top left"), A.$oS(this.$TG, "transform", "scale(" + 1 / this.$bS + ")"));
        window.addEventListener("resize", D(this, this.$XS), !1);
        this.$XS(null);
        this.fullscreen = new fa(!1);
        A.$pS(window.document, "fullscreenchange", function(a) {
            b.$aS()
        }, !1);
        this.$aS()
    };
    ...
    db.prototype = {
        ...
        get_fullscreenSupported: function() {
            return !0 == A.$mS(["fullscreenEnabled", "fullScreenEnabled"], window.document).value
        },
        ...
        requestFullscreen: function(a) {
            ...
            if (a) {
                ...
                null != b && b.apply(a, [])
            } else a = A.$mS(["exitFullscreen", "cancelFullscreen", "cancelFullScreen"], window.document).value, null != a && T.callMethod(window.document, a, [])
        },
        $XS: function(a) {
            var b = this.$TG.parentElement.getBoundingClientRect();
            !A.$gS || 90 != window.orientation && -90 != window.orientation ? this.$YS(b.width, b.height) : (a = Math.min(window.innerWidth, b.width), b = Math.min(window.innerHeight, b.height), this.$YS(a, b) && window.scrollTo(window.scrollX, window.scrollY));
            this.$ZS()
        },
        $YS: function(a, b) {
            var c = this.$bS * a,
            ...
            1 != this.$bS && A.$$S() && (this.$TG.style.width = a + "px", this.$TG.style.height = b + "px");
            this.$TG.width = c | 0;
            this.$TG.height = f | 0;
            this.resize.emit();
            return !0
        ...
        $ZS: function() {
            null == window.orientation ? this.orientation.set__(null) : this.orientation.set__(window.innerWidth > window.innerHeight ? Ha.Landscape : Ha.Portrait)
        },
        $aS: function() {
            var a = A.$mS(["fullscreen", "fullScreen", "isFullScreen"], window.document).value;
    ...
    A.$lS = function(a, b) {
        ...
        for (var c = a.charAt(0).toUpperCase() + B.substr(a, 1, null), f = 0, d = A.$fS; f < d.length;) {
            var e = d[f];
            ++f;
            var g = e + c,
                h = T.field(b, g);
    ...
    mb.prototype = v(V.prototype, {
        $lM: function() {
            null != this.$ET && (window.document.fonts["delete"](this.$ET), this.$ET = null);
            null != this.$FT && (null != this.$FT.parentNode && this.$FT.parentNode.removeChild(this.$FT), this.$FT = null)
        },
        __class__: mb
    });
    var Fb = function(a) {
    ...
    cd.prototype = {
        get_texture: function() {
            null == this.$NJ && (this.$NJ = m.$vG.$HG.createTextureFromImage(this.$SS, Z.RGB));
            return this.$NJ
        },
        get_video: function() {
            return this.$GO
    ...
    E.get_supported = function() {
        if (E.$YT) {
            ...
            if (null != a && (E.$ST = new a, E.$TT = E.$UT(), E.$TT.connect(E.$ST.destination), m.volume.watch(function(a, b) {
                        E.$TT.gain.value = a
                    }), m.$vG.$JG.down.connect(function(a) {
                        (new E(E.$XT())).play()
                    }).once(), a = function(a) {
                        "suspended" == E.$ST.state && E.$ST.resume()
                    }, m.$vG.$JG.down.connect(a), m.$vG.$JG.up.connect(a), m.$vG.$FG.down.connect(a),
                    m.$vG.$FG.up.connect(a), A.$gS)) var b = null,
    ...
    E.$UT = function() {
        return null != E.$ST.createGain ? E.$ST.createGain() : E.$ST.createGainNode()
    };
    E.$VT = function(a, b) {
    ...
    Hb.prototype = {
        set_paused: function(a) {
            a != 0 <= this.$eT && (a ? (this.$aT(), this.$eT = this.get_position()) : (this.$FO.$bG || this.$QS(this.$eT), this.$eT = -1));
            return a
        },
        get_position: function() {
            return this.$FO.$bG ? this.$PH : 0 <= this.$eT ? this.$eT : (E.$ST.currentTime - this.$fT + this.$jT) % this.$PH
        },
        update: function(a) {
            this.volume.update(a);
            null != this.$gT && 3 == this.$gT.playbackState && this.$FO.set__(!0);
            return this.$FO.$bG || 0 <= this.$eT ? (this.$ES = !1, this.$US.dispose(), this.$aT(), !0) : !1
        },
        $aT: function() {
            if (null !=
                this.$gT) {
        ...
        $QS: function(a) {
            ...
            this.$ES || (xa.$ZG.$AG.$PQ(this), this.$ES = !0, this.$US = m.hidden.get_changed().connect(function(a, f) {
    ...
    he.prototype = {
        ...
        $uT: function(a) {
            ...
            a.$JV != this.$qU && (c = r.instance(a.$GV, HTMLVideoElement), null != c && 2 <= c.readyState && (this.$vT(b.$FV), this.$IU.texImage2D(3553,
                0, 6407, 6407, 5121, c)));
            a.$JV = this.$qU;
            return b
        },
        ...
        $yT: function(a) {
            if (this.$UU != a)
                if (this.$UU = a, null != a) {
                    var b = null;
                    null == a.$IV && (a.$IV = this.$IU.createFramebuffer(), this.$rT(a), b = a.$LV.$FV);
                    this.$IU.bindFramebuffer(36160, a.$IV);
                    this.$IU.viewport(0,
                        0, a.$NR, a.$OR);
                    null != b && this.$IU.framebufferTexture2D(36160, 36064, 3553, b, 0)
                } else this.$IU.bindFramebuffer(36160, null), this.$IU.viewport(0, 0, this.$oU, this.$pU)
        },
        $zT: function(a) {
        ...
        $_T: function(a, b) {
            return b ? this.$fU : null != a.$HV && a.$HV.separateAlpha ? this.$gU : this.$eU
        },
        $AU: function(a, b, c,
            f, d, e) {
            e.$RN != this.$JK && (this.$$G(), this.$JK = e.$RN);
            if (e.$SN != this.$MU.x || e.$TN != this.$MU.y || e.$LJ != this.$MU.width || e.$MJ != this.$MU.height) this.$$G(), this.$MU.set(e.$SN, e.$TN, e.$LJ, e.$MJ);
            return this.$GU(a, b, c, f, d, this.$BU(e.$RN, d))
        },
        $BU: function(a, b) {
            return b ? this.$iU : null != a.$HV && a.$HV.separateAlpha ? this.$jU : this.$hU
        },
        ...
        $IK: function(a, b, c, f, d, e, g) {
            ...
            if (null != c || null != this.$PU) null != c && null != this.$PU &&
                this.$PU.equals(c) || (this.$$G(), this.$PU = null != c ? c.clone(this.$PU) : null, this.$YU = !0)
        },
        ...
        $RO: function(a, b, c, f) {
            var d = b.$ZK(),
                e = this.$sU.get(d);
            null == e && (e = new ed(this.$IU, this, b.$cK, b.$bK), this.$sU.set(d, e));
        ...
        $$G: function() {
            ...
            this.$OU != this.$VU && (this.$OU ?
                (this.$IU.stencilMask(1 << this.$LU - 1), this.$IU.clear(1024), this.$IU.colorMask(!1, !1, !1, !1), this.$IU.stencilFunc(514, (1 << this.$LU - 1) - 1, 255), this.$IU.stencilOp(7680, 7680, 7682)) : (this.$IU.colorMask(!0, !0, !0, !0), a = (1 << this.$LU) - 1, this.$IU.stencilFunc(514, a, a), this.$IU.stencilOp(7680, 7680, 7680)), this.$VU = this.$OU);
            this.$YU && (null != this.$PU ? (this.$IU.enable(3089), this.$IU.scissor(this.$PU.x | 0, this.$PU.y | 0, this.$PU.width | 0, this.$PU.height | 0)) : this.$IU.disable(3089), this.$YU = !1);
            null != this.$JK && (a = this.$uT(this.$JK),
                null != a.$FM ? (this.$IU.activeTexture(33985), this.$vT(a.$FV), this.$IU.activeTexture(33984), this.$vT(a.$FM)) : this.$vT(a.$FV));
            this.$wT(this.$QU);
            this.$QU != this.$hU && this.$QU != this.$iU && this.$QU != this.$jU || this.$QU.$fV(this.$MU.x / this.$JK.$PR, this.$MU.y / this.$JK.$QR, this.$MU.width / this.$JK.$PR, this.$MU.height / this.$JK.$QR);
            this.$KU != this.$SU && (this.$IU.bindBuffer(34963, this.$KU), this.$SU = this.$KU);
            if (this.$SU == this.$bU) {
                if (this.$aU) {
                    this.$aU = !1;
                    for (var a = new Uint16Array(6 * this.$mU), b = 0, c = this.$mU; b < c;) {
                        var f =
                            b++,
                            d = 6 * f,
                            f = 4 * f;
                ...
                this.$nU = this.$lU = 0
            } else a = new Uint16Array(this.$dU), this.$IU.bufferData(34963, a, 35048), this.$dU.length = 0, this.$IU.bufferData(34962, new Float32Array(this.$lT), 35048), this.$lT.length = 0, this.$IU.drawElements(4, a.length, 5123, 0)
        },
        $HU: function(a) {
            1024 < a ? this.$$G() : (this.$mU = a, a = new Float32Array(32 *
                a), null != this.$kT && a.set(this.$kT, 0), this.$kT = a, this.$aU = !0)
        },
        __class__: he
    };
    var Aa = function(a, b) {
    ...
    Aa.prototype = {
        ...
        drawTriangles: function(a, b, c, f) {
            ...
            for (var u = d = 0, w = b.length; u < w;) {
                ...
                c[a++] = x * h + y * l + m;
                c[a++] = x * n + y * q + g;
                null != f ? (c[a++] = f[d++], c[a++] = f[d++]) : (c[a++] = x / e.$PR, c[a++] = y / e.$QR);
                c[a++] = r;
                c[a++] = s;
                c[a++] = t;
                c[a++] = v
        ...
        fillEllipse: function(a, b, c, f, d, e) {
            ...
            var g = [],
                h = [];
            W.$XQ(g, h,
                b, c, f, d, e) && this.fillTriangles(a, g, h)
        },
        strokeEllipse: function(a, b, c, f, d, e, g) {
            null == g && (g = 50);
            var h = [],
        ...
        fillArc: function(a, b, c, f, d, e, g) {
            ...
            var h = [],
                l = [];
            W.$YQ(h, l, b, c, f, 3.141592653589793 * d / 180, 3.141592653589793 * e / 180, g) && this.fillTriangles(a, h, l)
        },
        strokeArc: function(a, b, c, f, d, e, g, h) {
            null == h && (h = 50);
            var l = [],
                m = [];
            W.$ZQ(l, m, b, c, f, 3.141592653589793 * d / 180, 3.141592653589793 * e / 180, g, h) && this.fillTriangles(a, l, m)
        },
        strokeLines: function(a,
            b, c) {
            var f = [],
                d = [];
    ...
    fd.prototype = {
        $AV: function(a, b, c, f) {
            ...
            this.$_J.set(Math.round(a), Math.round(b), Math.round(c),
                Math.round(f))
        },
        __class__: fd
    };
    ...
    pb.prototype = v(V.prototype, {
        ...
        getGraphics: function() {
            null == this.$WR && (this.$WR = new Aa(this.$HG.$CV, this), this.$WR.onResize(this.$NR,
                this.$OR));
            return this.$WR
        },
        clear: function() {
    ...
    ja.prototype = {
        ...
        $IK: function() {
            null == this.$YV && (this.$YV = this.$IU.createProgram(), this.$TV(), this.$dV && (this.$IU.detachShader(this.$YV, this.$ZV), this.$IU.deleteShader(this.$ZV), this.$ZV = null, this.$IU.detachShader(this.$YV, this.$aV), this.$IU.deleteShader(this.$aV), this.$aV = null))
        },
        $UV: function(a) {
            ...
            if (null != a) {
                b = a.$bV.length;
                for (c = this.$bV.length; b < c;) f = b++, this.$IU.enableVertexAttribArray(f);
                b = this.$bV.length;
                for (c = a.$bV.length; b < c;) f = b++, this.$IU.disableVertexAttribArray(f)
            } else
                for (b = 0, c = this.$bV.length; b < c;) f = b++, this.$IU.enableVertexAttribArray(f);
            b = 0;
            for (c = this.$bV.length; b < c;) {
                ...
                null !=
                    e && e.$hN == d.$hN && e.$gK == d.$gK && a.$cV == this.$cV && e.$vV == d.$vV || this.$IU.vertexAttribPointer(f, d.$hN, d.$gK, !1, this.$cV, d.$vV)
            }
        },
        $VV: function(a, b) {
        ...
        $XV: function(a) {
            return this.$IU.getUniformLocation(this.$YV,
                a)
        },
        __class__: ja
    };
        ...
        $TV: function() {
            ...
            switch (this.$nV) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    a = "vec4(texture2D(u_textureRGB, pos).rgb, texture2D(u_texture, pos).r);"
            }
            a = ["varying mediump vec2 v_uv;\nvarying lowp vec4 v_color;\nuniform lowp sampler2D u_texture;\nuniform mediump vec4 u_region;", 2 == this.$nV ? "uniform lowp sampler2D u_textureRGB;" :
                "", "void main (void) {\nmediump vec2 pos = u_region.xy + mod(v_uv, u_region.zw);", "lowp vec4 color = " + a, 1 == this.$nV ? "if (color.a == 0.0) discard;" : "", "gl_FragColor = color * v_color;\n}"
            ].join("\n");
            this.$VV("attribute highp vec2 a_pos;\nattribute mediump vec2 a_uv;\nattribute lowp vec4 a_color;\nvarying mediump vec2 v_uv;\nvarying lowp vec4 v_color;\nvoid main (void) {\nv_uv = a_uv;\nv_color = vec4(a_color.rgb * a_color.a, a_color.a);\ngl_Position = vec4(a_pos, 0, 1);\n}", a);
            this.$WV("a_pos", 2,
                5126);
            this.$WV("a_uv", 2, 5126);
            ...
            2 == this.$nV && (this.$lV = this.$XV("u_textureRGB"), this.$IU.uniform1i(this.$lV, 1))
        },
        $fV: function(a, b, c, f) {
            if (a != this.$gV || b != this.$hV || c != this.$iV || f != this.$jV) this.$gV = a, this.$hV = b, this.$iV = c, this.$jV = f, this.$IU.uniform4f(this.$mV, a, b, c, f)
        },
        __class__: ob
    });
    var nb = function(a, b) {
    ...
    nb.prototype =
        v(ja.prototype, {
            $TV: function() {
                ...
                a = ["varying mediump vec2 v_uv;\nvarying lowp vec4 v_color;\nuniform lowp sampler2D u_texture;", 2 == this.$nV ? "uniform lowp sampler2D u_textureRGB;" : "", "void main (void) {", "lowp vec4 color = " + a, 1 == this.$nV ? "if (color.a == 0.0) discard;" : "", "gl_FragColor = color * v_color;\n}"].join("\n");
                this.$VV("attribute highp vec2 a_pos;\nattribute mediump vec2 a_uv;\nattribute lowp vec4 a_color;\nvarying mediump vec2 v_uv;\nvarying lowp vec4 v_color;\nvoid main (void) {\nv_uv = a_uv;\nv_color = vec4(a_color.rgb * a_color.a, a_color.a);\ngl_Position = vec4(a_pos, 0, 1);\n}",
                    a);
    ...
    ed.prototype = v(ja.prototype, {
        ...
        $pV: function(a, b, c, f) {
            ...
            for (a = a.$aK.iterator(); a.hasNext();)
                if (c = a.next(), f = this.$sV.get(c.$eK), null == f && (f = new ke(this.$IU.getUniformLocation(this.$YV,
                        c.$eK)), this.$sV.set(c.$eK, f)), f = f.$tV, null != f) switch (c.$gK) {
                    case 0:
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        this.$IU.uniformMatrix4fv(f,
                            !1, c.$fK);
                        break;
                    case 11:
                        this.$IU.uniform1i(f, b), 0 != b && this.$IU.activeTexture(33984 + b), b++, c = this.$wU.$uT(c.$fK.$RN), this.$wU.$vT(c.$FV)
                }
    ...
    ca.prototype = {
        update: function(a, b) {
            null == this.$GW && (this.$GW = new fb(this.$bG.$bG, this.$OH, this.$IW, this.$QH), this.$bG.set_behavior(this.$GW), this.$bG.update(a));
    ...
    Ib.prototype = {
        update: function(a, b) {
            for (var c = !0, f = 0, d = 0, e = this.$KW.length; d < e;) {
                ...
                if (null != h) {
                    var l = h.update(a, b);
                    0 <= l ? (this.$KW[g] = null, this.$LW.push(h), l > f && (f = l)) : c = !1
                }
            }
    ...
    ua.prototype = {
        update: function(a, b) {
            ...
            return 0 < this.$NW && 0 <= c && 0 == --this.$OW ? (this.$OW = this.$NW, c) : -1
        },
        __class__: ua
    };
    var G = function() {
    ...
    sa.prototype = {
        ...
        emitProgress: function(a) {
            0 == this.$hW && (null != this.$jW && this.$jW.emit(a), this.progressChanged.emit())
        },
        $iG: function(a, b) {
            0 == this.$hW ? null == this.$iW ? this.$iW = [b] : this.$iW.push(b) : m.$vG.$AG.$RQ(b)
        },
        $cW: function(a) {
            var b = this;
            K.__instanceof(a, sa) ? a.then(function(a) {
                b.$bW(a)
            }).catchError(function(a) {
                b.failure(a)
            }) : this.$bW(a)
        ...
        $dW: function(a, b) {
            if (0 == this.$hW && (this.$gW =
                    b, this.$hW = a, null != this.$iW)) {
    ...
    ee.prototype = {
        nextInt: function() {
            return this.$hW = (1103515245 * this.$hW +
                12345) % 2147483647
        },
        __class__: ee
    };
    ...
    de.prototype = {
        triangulate: function(a) {
            var b = a.length;
            if (6 > b) return [];
            for (var c = this.$FX(-1, 0, 0, null), f = c, d = 0, e = 0, g = b - 2; e < b;) d += (a[g] - a[e]) * (a[e + 1] + a[g + 1]), g = e, e += 2;
            if (0 < d)
                for (d = e = 0; e < b;) var g = a[e],
                    h = a[e + 1],
                    c = this.$FX(d++, g, h, c),
                    e = e + 2;
            else
                for (e = b - 2, d = e / 2 | 0; 0 <= e;) g = a[e], h = a[e + 1], c = this.$FX(d--, g, h, c), e -= 2;
            c.next = f.next;
            c.next.$GR = c;
        ...
        $AX: function(a, b, c) {
            return (b.$vL - a.$vL) * (c.$tL - b.$tL) - (b.$tL - a.$tL) * (c.$vL - b.$vL)
        },
        $BX: function(a, b, c, f) {
            return 0 <
                (b.$vL - a.$vL) * (c.$tL - b.$tL) - (b.$tL - a.$tL) * (c.$vL - b.$vL) != 0 < (b.$vL - a.$vL) * (f.$tL - b.$tL) - (b.$tL - a.$tL) * (f.$vL - b.$vL) && 0 < (f.$vL - c.$vL) * (a.$tL - f.$tL) - (f.$tL - c.$tL) * (a.$vL - f.$vL) != 0 < (f.$vL - c.$vL) * (b.$tL - f.$tL) - (f.$tL - c.$tL) * (b.$vL - f.$vL)
        },
        $DX: function(a, b) {
            if (null == a) return a;
            null == b && (b = a);
            var c = a,
                f;
            do
                if (f = !1, c.$tW || !this.$_W(c, c.next) && 0 != this.$AX(c.$GR, c, c.next)) c = c.next;
                else {
                    c.next.$GR = c.$GR;
                    c.$GR.next = c.next;
        ...
        $FX: function(a, b, c, f) {
            var d = this.$vW;
            null == d ? (d = new ne, d.$qW = this.$wW, this.$wW = d) : this.$vW = d.next;
            d.$rW = a;
            d.$sW = -1;
            d.$tL = b;
            d.$vL = c;
        ...
        $GX: function(a, b) {
            ...
            if (null != a) {
                ...
                for (var c = a, f, d; a.$GR != a.next;)
                    if (f = a.$GR, d = a.next, this.$zW ? this.$IX(a) :
                        this.$HX(a)) this.$uW.push(f.$rW), this.$uW.push(a.$rW), this.$uW.push(d.$rW), a.next.$GR = a.$GR, a.$GR.next = a.next, null != a.$pW && (a.$pW.$oW = a.$oW), null != a.$oW && (a.$oW.$pW = a.$pW), c = a = d.next;
                    else if (a = d, a == c) {
                    switch (b) {
                        case 0:
                            this.$GX(this.$DX(a), 1);
        ...
        $HX: function(a) {
            var b = a.$GR,
                c = a.next;
            if (0 <= (a.$vL - b.$vL) * (c.$tL - a.$tL) - (a.$tL - b.$tL) * (c.$vL - a.$vL)) return !1;
            for (var f = a.next.next; f != a.$GR;) {
                if (this.$MX(b.$tL, b.$vL, a.$tL, a.$vL, c.$tL, c.$vL,
                        f.$tL, f.$vL) && 0 <= this.$AX(f.$GR, f, f.next)) return !1;
                f = f.next
            }
            return !0
        },
        $IX: function(a) {
            ...
            if (0 <= (a.$vL - b.$vL) * (c.$tL - a.$tL) - (a.$tL - b.$tL) * (c.$vL - a.$vL)) return !1;
            var f;
            f = b.$tL < a.$tL ? b.$tL < c.$tL ? b.$tL : c.$tL : a.$tL < c.$tL ? a.$tL : c.$tL;
            var d;
            d = b.$vL < a.$vL ? b.$vL < c.$vL ? b.$vL : c.$vL : a.$vL < c.$vL ? a.$vL : c.$vL;
            var e;
            e = b.$tL > a.$tL ? b.$tL > c.$tL ? b.$tL : c.$tL : a.$tL > c.$tL ? a.$tL : c.$tL;
            var g;
            g = b.$vL > a.$vL ? b.$vL > c.$vL ? b.$vL : c.$vL : a.$vL > c.$vL ? a.$vL : c.$vL;
            f = this.$QX(f, d);
            e = this.$QX(e, g);
            for (g = a.$oW; null != g &&
                g.$sW <= e;) {
                if (g != a.$GR && g != a.next && this.$MX(b.$tL, b.$vL, a.$tL, a.$vL, c.$tL, c.$vL, g.$tL, g.$vL) && 0 <= this.$AX(g.$GR, g, g.next)) return !1;
                g = g.$oW
            }
        ...
        $JX: function(a) {
            ...
            do {
                var c = b.$GR,
                    f = b.next.next;
                this.$BX(c, b, b.next, f) && (0 > this.$AX(c.$GR, c, c.next) ? 0 <= this.$AX(c, f, c.next) && 0 <= this.$AX(c, c.$GR, f) : 0 > this.$AX(c, f, c.$GR) || 0 > this.$AX(c, c.next,
                    f)) && (0 > this.$AX(f.$GR, f, f.next) ? 0 <= this.$AX(f, c, f.next) && 0 <= this.$AX(f, f.$GR, c) : 0 > this.$AX(f, c, f.$GR) || 0 > this.$AX(f, f.next, c)) && (this.$uW.push(c.$rW), this.$uW.push(b.$rW), this.$uW.push(f.$rW), b.next.$GR = b.$GR, b.$GR.next = b.next, null != b.$pW && (b.$pW.$oW = b.$oW), null != b.$oW && (b.$oW.$pW = b.$pW), this.$EX(b.next), b = a = f);
                b = b.next
            } while (b != a);
            return b
        },
        ...
        $MX: function(a, b, c, f, d, e, g, h) {
            return 0 <= (d - g) * (b - h) - (a - g) * (e - h) && 0 <= (a - g) * (f - h) - (c - g) * (b - h) && 0 <= (c - g) * (e - h) - (d - g) * (f - h)
        },
        $NX: function(a, b) {
            return a.$tL == b.$tL && a.$vL == b.$vL || a.next.$rW != b.$rW && a.$GR.$rW != b.$rW && !this.$PX(a, b) && (0 > this.$AX(a.$GR, a, a.next) ? 0 <= this.$AX(a,
                b, a.next) && 0 <= this.$AX(a, a.$GR, b) : 0 > this.$AX(a, b, a.$GR) || 0 > this.$AX(a, a.next, b)) && (0 > this.$AX(b.$GR, b, b.next) ? 0 <= this.$AX(b, a, b.next) && 0 <= this.$AX(b, b.$GR, a) : 0 > this.$AX(b, a, b.$GR) || 0 > this.$AX(b, b.next, a)) && this.$OX(a, b)
        },
        $OX: function(a, b) {
            var c = a,
                f = !1,
                d = (a.$tL + b.$tL) / 2,
                e = (a.$vL + b.$vL) / 2;
            do c.$vL > e != c.next.$vL > e && d < (c.next.$tL - c.$tL) * (e - c.$vL) / (c.next.$vL - c.$vL) + c.$tL && (f = !f), c = c.next; while (c != a);
            return f
        },
        $PX: function(a, b) {
            var c = a;
            do {
                if (c.$rW != a.$rW && c.next.$rW != a.$rW && c.$rW != b.$rW && c.next.$rW != b.$rW &&
                    this.$BX(c, c.next, a, b)) return !0;
                c = c.next
            } while (c != a);
            return !1
        },
        $QX: function(a, b) {
            var c = 32767 * (a - this.$xW) / this.$hN | 0,
                ...
                f = (f | f << 4) & 252645135,
                f = (f | f << 2) & 858993459;
            return (c | c << 1) & 1431655765 | ((f | f << 1) & 1431655765) << 1
        },
        $RX: function(a) {
            var b = a;
            do 0 > b.$sW && (b.$sW = this.$QX(b.$tL, b.$vL)), b.$pW = b.$GR, b = b.$oW = b.next; while (b != a);
            b.$pW.$oW = null;
            b.$pW = null;
            this.$SX(b)
        },
        $SX: function(a) {
            ...
            do {
                ...
                for (e = 0; null != b;) {
                    ...
                    for (h = l; 0 < g || 0 < h && null != c;) 0 == g ? (f = c, c = c.$oW, h--) : 0 == h || null == c ? (f = b, b = b.$oW, g--) : b.$sW <= c.$sW ? (f = b, b = b.$oW, g--) : (f = c, c = c.$oW, h--), null != d ? d.$oW = f : a = f, f.$pW = d, d = f;
                    b = c
                }
                d.$oW = null;
                l *= 2
    ...
    Pa.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            this.car = new h;
            g.createImageSprite(this.owner, this.car, "game/train_carriage_green-grey", !1, 0, 0);
            var b = new h;
            g.createImageSprite(this.owner, b, "game/train_carriage_green-grey", !1, 1030, 0);
            b.$zF[1].set_pixelSnapping(!1);
            var c = new G;
            c.run(new ua(new H([new z(g.randomNumberFloat(0.1, 0.5)), new x(function() {
                a.owner.$zF[1].y.animateBy(2, g.randomNumberFloat(0.15,
                    0.3))
            }), new z(g.randomNumberFloat(0.3, 0.5)), new x(function() {
                a.owner.$zF[1].y.animateTo(a.y - 1, g.randomNumberFloat(0.15, 0.3))
            }), new z(g.randomNumberFloat(0.2, 0.4))])));
            this.car.add(c);
            c = new G;
            c.run(new ua(new H([new x(function() {
                b.$zF[1].y.animateTo(0.5, g.randomNumberFloat(0.15, 0.3))
            }), new z(g.randomNumberFloat(0.2, 0.5)), new x(function() {
                b.$zF[1].y.animateTo(-0.5, g.randomNumberFloat(0.15, 0.3))
            }), new z(g.randomNumberFloat(0.2, 0.4))])));
            b.add(c)
        },
    ...
    id.prototype = v(s.prototype, {
        ...
        onUpdate: function(a) {
            this.owner.$zF[1].setXY(this.linked.$zF[1].x.$bG, this.linked.$zF[1].y.$bG)
        },
        __class__: id
    });
    var jd = function(a,
    ...
    jd.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            this.owner.$zF[1].setXY(this.x, this.y - 1);
            this.car = new h;
            g.createImageSprite(this.owner, this.car, "game/train_carriage", !1, 0, 0);
            var a = new h;
            g.createImageSprite(this.owner, a, "game/train_carriage", !1, 1030, 0);
            a.$zF[1].set_pixelSnapping(!1);
            var b = new G;
            b.run(new ua(new H([new x(function() {
    ...
    d.initFonts = function() {
        d.translations = new Wa(t.parse(d.configPack.getFile("translation.xml").toString()).firstElement());
        ...
        d.vo || (d.bodyFont = new ba(d.pack, "fonts/int/italicFont"), d.titleFont = new ba(d.pack, "fonts/int/italicFont"), d.italicFont = new ba(d.pack, "fonts/int/italicFont"),
    ...
    kd.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            d.isMobile && (m.$vG.$JG.up.connect(D(this, this.handleTouchUp)), m.$vG.$JG.down.connect(D(this, this.handleTouchDown)), m.$vG.$JG.move.connect(D(this, this.handleTouchMove)));
            m.$vG.getKeyboard().down.connect(D(this,
                this.keyDownHandler));
            m.$vG.getKeyboard().up.connect(D(this, this.keyUpHandler));
            this.myXML = new Wa(t.parse(d.configPack.getFile("config.xml").toString()).firstElement());
            "YES" == this.myXML.node.resolve("showFPS").get_innerData() ? d.showFPS = !0 : d.showFPS = !1;
            "YES" == this.myXML.node.resolve("testMode").get_innerData() ? d.testMode = !0 : d.testMode = !1;
            "YES" == this.myXML.node.resolve("showDebugInfo").get_innerData() ? d.showDebugInfo = !0 : d.showDebugInfo = !1;
            "YES" == this.myXML.node.resolve("english").get_innerData() ? d.vo = !0 : d.vo = !1;
            "YES" == this.myXML.node.resolve("alvin").get_innerData() ? d.alvin = !0 : d.alvin = !1;
            "YES" == this.myXML.node.resolve("powerRangers").get_innerData() ? d.powerRangers = !0 : d.powerRangers = !1;
            d.minScaleSize = r.parseInt(this.myXML.node.resolve("scaleBelow").get_innerData());
        ...
        onPointerDown: function(a) {
            ...
            switch (this.gameState) {
                case "HOME":
                    a.hit == this.muteBtn.$zF[1] ? (d.muted ? (this.muteBtn.dispose(), this.muteBtn = new h, g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioON", !0, this.screenWidth - 65, 55), g.mute(!1)) : (this.muteBtn.dispose(), this.muteBtn = new h, g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioOFF", !0, this.screenWidth - 65, 55), g.mute(!0)), g.alignRight(this.muteBtn)) : this.fadeOut(D(this, this.charScreen));
                    null == this.menuLoop && (this.menuLoop = d.pack.getSound("audio/Spiderman_ITSV_TitleMenu_v1").loop(),
                        this.menuLoop.volume.set__(0), this.menuLoop.volume.animateTo(this.musicVolume, 0.5));
                    this.playSound("click");
                    break;
                case "CHAR":
                    a.hit == this.muteBtn.$zF[1] ? (d.muted ? (this.muteBtn.dispose(), this.muteBtn = new h, g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioON", !0, this.screenWidth - 65, 55), g.mute(!1)) : (this.muteBtn.dispose(), this.muteBtn = new h, g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioOFF", !0, this.screenWidth - 65, 55), g.mute(!0)), g.alignRight(this.muteBtn)) : a.hit == this.miles.$zF[1] ?
                        (d["char"] = "miles", this.gameState = "WAIT", this.milesBurst.$zF[1].x.animateBy(200, 0.5), this.miles.$zF[1].x.animateBy(200, 0.5), this.milesName.$zF[1].x.animateBy(200, 0.5), this.milesBurst.$zF[1].alpha.animateTo(1, 0.3), this.gwenName.$zF[1].alpha.animateTo(0, 0.3), this.gwenBurst.$zF[1].alpha.animateTo(0, 0.3), this.gwen.$zF[1].alpha.animateTo(0, 0.3), a = new G, a.run(new H([new z(1), new x(function() {
                            b.fadeOut(D(b, b.selectScreen))
                        })])), this.screen.add(a)) : a.hit == this.gwen.$zF[1] && (d["char"] = "gwen", this.gameState =
                            "WAIT", this.gwenBurst.$zF[1].x.animateBy(-170, 0.5), this.gwen.$zF[1].x.animateBy(-170, 0.5), this.gwenName.$zF[1].x.animateBy(-170, 0.5), this.gwenBurst.$zF[1].alpha.animateTo(1, 0.3), this.milesName.$zF[1].alpha.animateTo(0, 0.3), this.milesBurst.$zF[1].alpha.animateTo(0, 0.3), this.miles.$zF[1].alpha.animateTo(0, 0.3), a = new G, a.run(new H([new z(1), new x(function() {
                                b.fadeOut(D(b, b.selectScreen))
                            })])), this.screen.add(a));
                    this.playSound("click");
                    break;
                case "WAIT":
                    a.hit == this.muteBtn.$zF[1] && (d.muted ? (this.muteBtn.dispose(),
                        this.muteBtn = new h, g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioON", !0, this.screenWidth - 65, 55), g.mute(!1)) : (this.muteBtn.dispose(), this.muteBtn = new h, g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioOFF", !0, this.screenWidth - 65, 55), g.mute(!0)), g.alignRight(this.muteBtn), this.playSound("click"));
                    break;
                case "SELECT":
                    a.hit == this.muteBtn.$zF[1] ? (d.muted ? (this.muteBtn.dispose(), this.muteBtn = new h, g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioON", !0, this.screenWidth -
                        65, 55), g.mute(!1)) : (this.muteBtn.dispose(), this.muteBtn = new h, g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioOFF", !0, this.screenWidth - 65, 55), g.mute(!0)), g.alignRight(this.muteBtn)) : a.hit == this.startBtn.$zF[1] ? (this.fadeOut(D(this, this.startGame)), this.menuLoop.volume.animateTo(0, 0.5)) : a.hit == this.startBtn2.$zF[1] && (this.fadeOut(D(this, this.startGame2)), this.menuLoop.volume.animateTo(0, 0.5));
                    this.playSound("click");
                    break;
                case "GAME":
                    a.hit == this.pauseBtn.$zF[1] && (this.pauseGame(!0, a),
                        this.playSound("click"))
            }
        },
        ...
        onPointerMove: function(a) {
            switch (this.gameState) {
                case "HOME":
                    d.muted ? g.rolloverImage(this.muteBtn, "buttons/BTN_audioOFF", "buttons/BTN_audioOFF_rollover", a) : g.rolloverImage(this.muteBtn, "buttons/BTN_audioON", "buttons/BTN_audioON_rollover", a);
                    break;
                case "WAIT":
                    d.muted ? g.rolloverImage(this.muteBtn, "buttons/BTN_audioOFF", "buttons/BTN_audioOFF_rollover", a) : g.rolloverImage(this.muteBtn, "buttons/BTN_audioON", "buttons/BTN_audioON_rollover", a);
                    break;
                case "CHAR":
                    d.muted ?
                        g.rolloverImage(this.muteBtn, "buttons/BTN_audioOFF", "buttons/BTN_audioOFF_rollover", a) : g.rolloverImage(this.muteBtn, "buttons/BTN_audioON", "buttons/BTN_audioON_rollover", a);
                    break;
                case "SELECT":
                    d.muted ? g.rolloverImage(this.muteBtn, "buttons/BTN_audioOFF", "buttons/BTN_audioOFF_rollover", a) : g.rolloverImage(this.muteBtn, "buttons/BTN_audioON", "buttons/BTN_audioON_rollover", a);
                    g.rolloverImage(this.startBtn, "buttons/BTN_play", "buttons/BTN_play_rollover", a);
                    g.rolloverImage(this.startBtn2, "buttons/BTN_play",
                        "buttons/BTN_play_rollover", a);
                    break;
                case "GAME":
                    g.rolloverImage(this.pauseBtn, "buttons/BTN_pause", "buttons/BTN_pause_rollover", a)
            }
        },
        homeScreen: function() {
            this.inPlay = !1;
            ...
            this.getScreenSize();
            var a = new h;
            g.createImageSprite(this.screen, a, "screens/background", !1, -((1336 - this.screenWidth) / 2), this.screenHeight - 768);
            a = new h;
            g.createImageSprite(this.screen, a, "screens/title", !0, this.screenWidth / 2, this.screenHeight / 2 - 105);
            a = new h;
            g.createImageSprite(this.screen, a, "screens/miles", !0, this.screenWidth / 2, this.screenHeight - 90);
            a = new h;
            g.createImageSprite(this.screen, a, "screens/gwen", !0, 130, this.screenHeight / 2 - 50);
            g.alignLeft(a);
            a = new h;
            g.createImageSprite(this.screen, a, "screens/spiderman", !0, this.screenWidth - 200, 150);
            g.alignRight(a);
            a = new h;
            g.createImageSprite(this.screen, a, "hud/HUD_top_left", !1, -20, -10);
            g.alignLeft(a);
            a = new h;
            g.createImageSprite(this.screen, a, "hud/HUD_top_right", !1, this.screenWidth - 200, -10);
            g.alignRight(a);
            a =
                new h;
            ...
            a.$zF[1].set_pixelSnapping(!1);
            var b = new h;
            d.isMobile ? g.createXMLSprite(a, b, d.titleFont, "Center", 0,
                -70, d.translations.node.resolve("tapPlay")) : g.createXMLSprite(a, b, d.titleFont, "Center", 0, -70, d.translations.node.resolve("clickPlay"));
            g.pulseBtn(a, 1.05, 0.7);
            this.muteBtn = new h;
            d.muted ? g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioOFF", !0, this.screenWidth - 65, 55) : g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioON", !0, this.screenWidth - 65, 55);
        ...
        charScreen: function() {
            ...
            this.getScreenSize();
            var a = new h;
            g.createImageSprite(this.screen, a, "screens/background2", !1, -((1336 - this.screenWidth) / 2), this.screenHeight - 768);
            a = new h;
            g.createImageSprite(this.screen, a, "hud/HUD_top_left", !1, -20, -10);
            g.alignLeft(a);
            a = new h;
            g.createImageSprite(this.screen, a, "hud/HUD_top_right", !1, this.screenWidth -
                200, -10);
            g.alignRight(a);
            a = new h;
            g.createImageSprite(this.screen, a, "hud/logo", !1, 15, 10);
            ...
            g.alignLeft(a);
            a = new h;
            d.vo ? g.createImageSprite(this.screen, a, "screens/charheader", !0, this.screenWidth / 2 + 80, 100) : g.createXMLSprite(this.screen, a, d.titleFont, "Center", this.screenWidth / 2 + 80, 100, d.translations.node.resolve("selectChar"));
            this.milesBurst = new h;
            g.createImageSprite(this.screen, this.milesBurst,
                "screens/highlight_burst", !0, this.screenWidth / 2 - 195, this.screenHeight - 290);
            this.milesBurst.$zF[1].set_pixelSnapping(!1);
            this.gwenBurst = new h;
            g.createImageSprite(this.screen, this.gwenBurst, "screens/highlight_burst", !0, this.screenWidth / 2 + 165, this.screenHeight - 185);
            this.gwenBurst.$zF[1].set_pixelSnapping(!1);
            this.gwenBurst.$zF[1].alpha.set__(0.3);
            this.milesBurst.$zF[1].alpha.set__(0.3);
            this.miles = new h;
            g.createImageSprite(this.screen, this.miles, "screens/miles", !0, this.screenWidth / 2 - 235, this.screenHeight -
                180);
            this.gwen = new h;
            g.createImageSprite(this.screen, this.gwen, "screens/chargwen", !0, this.screenWidth / 2 + 210, this.screenHeight - 140);
            this.milesName = new h;
            g.createXMLSprite(this.screen, this.milesName, d.smallFont, "Center", this.screenWidth / 2 - 215 + 100, this.screenHeight - 290 - 60, d.translations.node.resolve("miles"));
            this.gwenName = new h;
            g.createXMLSprite(this.screen, this.gwenName, d.smallFont, "Center", this.screenWidth / 2 + 255, this.screenHeight - 185 - 70, d.translations.node.resolve("gwen"));
            this.muteBtn = new h;
            d.muted ?
                g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioOFF", !0, this.screenWidth - 65, 55) : g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioON", !0, this.screenWidth - 65, 55);
            g.alignRight(this.muteBtn);
            this.gameState = "CHAR";
            this.fadeIn()
        },
        selectScreen: function() {
            ...
            this.getScreenSize();
            var a = new h;
            g.createImageSprite(this.screen, a, "screens/background", !1, -((1336 - this.screenWidth) / 2), this.screenHeight -
                768);
            a = new h;
            g.createImageSprite(this.screen, a, "hud/HUD_top_left", !1, -20, -10);
            g.alignLeft(a);
            ...
            g.alignLeft(a);
            a = new h;
            d.vo ? g.createImageSprite(this.screen, a, "screens/header", !0, this.screenWidth / 2 + 80, 100) : g.createXMLSprite(this.screen,
                a, d.titleFont, "Center", this.screenWidth / 2 + 80, 100, d.translations.node.resolve("selectMission"));
            this.frame1 = new h;
            g.createImageSprite(this.screen, this.frame1, "screens/mission1_frame", !0, this.screenWidth / 2 - 230, this.screenHeight / 2 + 80);
            this.frame2 = new h;
            g.createImageSprite(this.screen, this.frame2, "screens/mission2_frame", !0, this.screenWidth / 2 + 230, this.screenHeight / 2 + 80);
            this.startBtn = new h;
            g.createImageSprite(this.screen, this.startBtn, "buttons/BTN_play", !0, this.screenWidth / 2 - 230 + 190, this.screenHeight /
                2 + 225);
            this.startBtn2 = new h;
            g.createImageSprite(this.screen, this.startBtn2, "buttons/BTN_play", !0, this.screenWidth / 2 + 418, this.screenHeight / 2 + 225);
            a = new h;
            g.createImageSprite(this.screen, a, "screens/star_icon", !0, this.screenWidth / 2 - 210 + 50, this.screenHeight / 2 + 10);
            a = new h;
            g.createImageSprite(this.screen, a, "screens/time_icon", !0, this.screenWidth / 2 - 210 + 50, this.screenHeight / 2 + 60);
            a = new h;
            g.createImageSprite(this.screen, a, "screens/star_icon", !0, this.screenWidth / 2 + 310, this.screenHeight / 2 + 10);
            a = new h;
            g.createImageSprite(this.screen,
                a, "screens/time_icon", !0, this.screenWidth / 2 + 310, this.screenHeight / 2 + 60);
            a = new h;
            g.createImageSprite(this.screen, a, "screens/land_icon", !0, this.screenWidth / 2 - 210 + 50, this.screenHeight / 2 + 115);
            a = new h;
            g.createImageSprite(this.screen, a, "screens/land_icon", !0, this.screenWidth / 2 + 310, this.screenHeight / 2 + 115);
            a = new h;
            g.createXMLSprite(this.screen, a, d.blackItalicFont, "Center", this.screenWidth / 2 - 210 - 30, this.screenHeight / 2 - 7, d.translations.node.resolve("best"));
            a = new h;
            g.createXMLSprite(this.screen, a, d.blackItalicFont,
                "Center", this.screenWidth / 2 + 260 - 30, this.screenHeight / 2 - 7, d.translations.node.resolve("best"));
            a = new h;
            g.createTextSprite(this.screen, a, d.blackFont, "Left", this.screenWidth / 2 - 210 + 80, this.screenHeight / 2 - 18, r.string(d.score1));
            a = new h;
            g.createTextSprite(this.screen, a, d.blackFont, "Left", this.screenWidth / 2 + 340, this.screenHeight / 2 - 18, r.string(d.score2));
            a = new h;
            g.createTextSprite(this.screen, a, d.blackFont, "Left", this.screenWidth / 2 - 210 + 80, this.screenHeight / 2 + 33, r.string(d.time1));
            a = new h;
            g.createTextSprite(this.screen,
                a, d.blackFont, "Left", this.screenWidth / 2 + 340, this.screenHeight / 2 + 33, r.string(d.time2));
            a = new h;
            g.createTextSprite(this.screen, a, d.blackFont, "Left", this.screenWidth / 2 - 210 + 80, this.screenHeight / 2 + 84, r.string(d.targets1));
            a = new h;
            g.createTextSprite(this.screen, a, d.blackFont, "Left", this.screenWidth / 2 + 340, this.screenHeight / 2 + 84, r.string(d.targets2));
            a = new h;
            g.createImageSprite(this.screen, a, "gameover/trophy_" + d.trophy1, !0, this.screenWidth / 2 - 230 - 120, this.screenHeight / 2 + 122);
            0 == d.trophy1 ? a.$zF[1].alpha.set__(0.6) :
                (a = (new h).add(new S("screens/glint", "glint", this.screenWidth / 2 - 230 - 122, this.screenHeight / 2 + 175)), this.screen.addChild(a));
            a = new h;
            g.createImageSprite(this.screen, a, "gameover/trophy_" + d.trophy2, !0, this.screenWidth / 2 + 230 - 110, this.screenHeight / 2 + 122);
            0 == d.trophy2 ? a.$zF[1].alpha.set__(0.6) : (a = (new h).add(new S("screens/glint", "glint", this.screenWidth / 2 + 230 - 112, this.screenHeight / 2 + 175)), this.screen.addChild(a));
            this.muteBtn = new h;
            d.muted ? g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioOFF",
                !0, this.screenWidth - 65, 55) : g.createImageSprite(this.screen, this.muteBtn, "buttons/BTN_audioON", !0, this.screenWidth - 65, 55);
            g.alignRight(this.muteBtn);
            this.gameState = "SELECT";
            this.fadeIn()
        },
        gameOver: function() {
            d.replay ? 1 == d.mission ? (this.screen.$zF[18].stopGame(), this.screen.$zF[18].dispose(), this.fadeOut(D(this, this.startGame))) : (this.screen.$zF[19].stopGame(), this.screen.$zF[19].dispose(), this.fadeOut(D(this, this.startGame2))) : (1 == d.mission ? (this.screen.$zF[18].stopGame(), this.screen.$zF[18].dispose()) :
                (this.screen.$zF[19].stopGame(), this.screen.$zF[19].dispose()), this.fadeOut(D(this, this.charScreen)), this.menuLoop.volume.animateTo(this.musicVolume, 0.5))
        },
        startGame: function() {
            d.mission = 1;
            this.screen = (new h).add(new Y(16777215, d.staticWidth, d.staticHeight));
            m.root.addChild(this.screen);
            this.getScreenSize();
            this.screen.add(new ld(this.screenWidth, this.screenHeight, D(this, this.gameOver)));
            this.pauseBtn = new h;
            g.createImageSprite(this.screen, this.pauseBtn, "buttons/BTN_pause", !0, this.screenWidth - 55, 55);
            ...
            this.inPlay = !0;
            this.fadeIn();
            d.showFPS && m.root.addChild((new h).add(new I(this.status_font)).add(new sb));
        ...
        startGame2: function() {
            ...
            m.root.addChild(this.screen);
            this.getScreenSize();
            this.screen.add(new md(this.screenWidth,
                this.screenHeight, D(this, this.gameOver)));
            this.pauseBtn = new h;
            g.createImageSprite(this.screen, this.pauseBtn, "buttons/BTN_pause", !0, this.screenWidth - 55, 55);
            g.alignRight(this.pauseBtn);
            this.screen2 = new h;
        ...
        onUpdate: function(a) {
            m.hidden.$bG ?
                (g.mute(!0), d.active = !1) : d.active || (g.mute(!1), d.active = !0);
        ...
        handleTouchUp: function(a) {
            this.audioEnabled || (d.pack.getSound("audio/blank").play(), this.audioEnabled = !0)
        },
        keyDownHandler: function(a) {
            d.testMode && "HOME" == this.gameState && this.fadeOut(D(this, this.startGame2))
        },
        ...
        pauseGame: function(a, b) {
            if (a) {
                ...
                this.pausedFade = (new h).add(new Y(0, this.screenWidth + 600, this.screenHeight));
                this.screen.addChild(this.pausedFade);
                this.pausedFade.$zF[1].alpha.set__(0.6);
                var c = this.pausedFade.$zF[1].x;
                c.set__(c.$bG - 300);
                this.pauseMenu = (new h).add(new nd(this.screenWidth / 2, this.screenHeight / 2, D(this, this.closePauseMenu)));
        ...
        closePauseMenu: function(a) {
            a ? (this.screen.add(new $a(1)), 1 == d.mission ? (this.screen.$zF[18].stopGame(), this.screen.$zF[18].dispose()) : (this.screen.$zF[19].stopGame(), this.screen.$zF[19].dispose()), this.fadeOut(D(this, this.charScreen)), this.menuLoop.volume.animateTo(this.musicVolume, 0.5), this.screen2.dispose()) : (this.gameState = "GAME", this.screen.add(new $a(1)), this.pausedFade.dispose(), this.pauseMenu.dispose(), this.screen2.$zF[1].set_pointerEnabled(!1), this.pauseBtn.$zF[1].alpha.set__(1),
                this.pauseBtn.$zF[1].scaleX.set__(1), this.pauseBtn.$zF[1].scaleY.set__(1))
        },
        fadeIn: function() {
            ...
            b.set__(b.$bG - 300);
            b = new G;
            b.run(new H([new ca(a.$zF[1].alpha, 0, this.transitionTime), new x(function() {
                a.dispose()
            })]));
            a.add(b);
            this.onResize()
        ...
        fadeOut: function(a) {
            ...
            d.set__(d.$bG - 300);
            d = new G;
            d.run(new H([new ca(c.$zF[1].alpha, 1, this.transitionTime), new x(function() {
                b.screen.dispose();
                a()
            })]));
            c.add(d)
        ...
        onResize: function() {
            if (null != this.screen) {
                d.resizeScreen = !0;
                !d.isMobile && 667 != m.$vG.$IG.get_width() && 900 < m.$vG.$IG.get_width() && (d.resizeScreen = !1);
                939 < m.$vG.$IG.get_width() && 1140 > m.$vG.$IG.get_width() && (d.resizeScreen = !1);
                939 < m.$vG.$IG.get_height() && 1140 > m.$vG.$IG.get_height() && (d.resizeScreen = !1);
                if (1336 < m.$vG.$IG.get_width() || 960 > m.$vG.$IG.get_width()) d.resizeScreen = !0;
                2 < m.$vG.$IG.get_width() / m.$vG.$IG.get_height() && (d.resizeScreen = !1);
                if (d.alwaysResize || 2048 < m.$vG.$IG.get_width() || 768 < m.$vG.$IG.get_height()) d.resizeScreen = !0;
                var a = !1;
                812 == m.$vG.$IG.get_width() && 375 == m.$vG.$IG.get_height() ? (a = d.resizeScreen = !0, this.debugText = "iPhone X") : 375 == m.$vG.$IG.get_width() && 812 == m.$vG.$IG.get_height() ? (a = d.resizeScreen = !0, this.debugText = "iPhone X") : 975 == m.$vG.$IG.get_width() && 2172 == m.$vG.$IG.get_height() ? (a = d.resizeScreen = !0, this.debugText = "iPhone X with address bar") :
                    2172 == m.$vG.$IG.get_width() && 975 == m.$vG.$IG.get_height() && (a = d.resizeScreen = !0, this.debugText = "iPhone X with address bar");
                2048 == m.$vG.$IG.get_width() && 1536 >= m.$vG.$IG.get_height() && (d.staticWidth = r["int"](m.$vG.$IG.get_width() / 2), d.staticHeight = r["int"](m.$vG.$IG.get_height() / 2));
                if (d.resizeScreen) {
                    1920 == r["int"](m.$vG.$IG.get_width()) && 1120 == r["int"](m.$vG.$IG.get_height()) && (d.staticHeight = 560);
                    var b = d.staticWidth,
                        c = d.staticHeight;
                    d.scale = ha.min(m.$vG.$IG.get_width() / b, m.$vG.$IG.get_height() / c);
                    this.screen.$zF[1].setScale(d.scale).setXY((m.$vG.$IG.get_width() - b * d.scale) / 2, (m.$vG.$IG.get_height() - c * d.scale) / 2);
                    if (a) {
                    ...
                    null != this.screen2 && null != this.screen2.$zF[1] && (this.screen2.$zF[1].setScale(d.scale).setXY((m.$vG.$IG.get_width() - b * d.scale) / 2, (m.$vG.$IG.get_height() - c * d.scale) / 2), a && (f = this.screen2.$zF[1].scaleX, f.set__(1.05 * f.$bG), f = this.screen2.$zF[1].x, f.set__(f.$bG - 19.2)));
                    m.$vG.$IG.get_width() >
                        m.$vG.$IG.get_height() ? (d.offsetX = r["int"](m.$vG.$IG.get_width() / d.scale - b), d.offsetY = r["int"](m.$vG.$IG.get_height() / d.scale - c), a && (d.offsetX = r["int"](m.$vG.$IG.get_width() / (1.05 * d.scale) - b))) : (d.offsetX = r["int"](m.$vG.$IG.get_height() / d.scale - c), d.offsetY = r["int"](m.$vG.$IG.get_width() / d.scale - b), a && (d.offsetX = r["int"](m.$vG.$IG.get_height() / (1.05 * d.scale) - c)))
                } else d.scale = 1, d.offsetX = 0, d.offsetY = 0
            }
            null
        },
        getScreenSize: function() {
            if (d.resizeScreen) this.screenWidth = d.staticWidth, this.screenHeight =
                d.staticHeight;
            else if (this.screenWidth = m.$vG.$IG.get_width(), this.screenHeight = m.$vG.$IG.get_height(), this.screenHeight > this.screenWidth) {
        ...
        displayDebugInfo: function() {
            if (d.showDebugInfo) {
                ...
                g.alignLeft(a);
                a = new h;
                g.createTextSprite(this.screen, a, d.bodyFont, "Left", 50, 100, "Screen width  : " +
                    this.screenWidth);
                g.alignLeft(a);
                a = new h;
                g.createTextSprite(this.screen, a, d.bodyFont, "Left", 50, 150, "Screen height : " + this.screenHeight);
                g.alignLeft(a);
                a = new h;
                g.createTextSprite(this.screen, a, d.bodyFont, "Left", 50, 200, "Actual screen width  : " + m.$vG.$IG.get_width());
                g.alignLeft(a);
                a = new h;
                g.createTextSprite(this.screen, a, d.bodyFont, "Left", 50, 250, "Actual screen height : " + m.$vG.$IG.get_height());
                g.alignLeft(a);
                a = new h;
                g.createTextSprite(this.screen, a, d.bodyFont, "Left", 50, 300, "Resizing : " + r.string(d.resizeScreen));
                g.alignLeft(a);
                a = new h;
                g.createTextSprite(this.screen, a, d.bodyFont, "Left", 50, 350, "Always resize : " + r.string(d.alwaysResize));
                g.alignLeft(a);
                a = new h;
                g.createTextSprite(this.screen, a, d.bodyFont, "Left", 50, 400, "Scale : " + d.scale);
                g.alignLeft(a);
                a = new h;
                g.createTextSprite(this.screen, a, d.bodyFont, "Left", 50, 450, "Scale factor : " + m.$vG.$IG.get_scaleFactor());
                g.alignLeft(a);
                a = new h;
                g.createTextSprite(this.screen, a, d.bodyFont, "Left", 50, 500, "Render type  : " + r.string(m.$vG.$HG.get_type()));
                g.alignLeft(a);
                a = new h;
                g.createTextSprite(this.screen, a, d.bodyFont, "Left", 50, 550, this.debugText);
                g.alignLeft(a)
            }
        },
        __class__: kd
    ...
    var Jb = function(a, b, c) {
        ...
        this.y = b | 0;
        this.callback = c;
        d.resizeScreen ? (this.screenWidth = d.staticWidth, this.screenHeight = d.staticHeight) : (this.screenWidth = m.$vG.$IG.get_width(), this.screenHeight = m.$vG.$IG.get_height())
    };
    ...
    Jb.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            var b = new G;
            b.run(new H([new ca(this.fade.$zF[1].alpha, 0.75, 0.5), new x(function() {
                a.addContent()
            })]));
            this.fade.add(b)
        },
        getTrophyType: function() {
            this.trophyNumber = 0;
            1 == d.mission ? (25 <= d.score && 15 <= d.targets ? this.trophyNumber = 3 : 10 <= d.score &&
                10 <= d.targets ? this.trophyNumber = 2 : 5 <= d.score && 5 <= d.targets && (this.trophyNumber = 1), this.trophyNumber > d.trophy1 && (d.trophy1 = this.trophyNumber), d.score > d.score1 && (d.score1 = d.score), d.time > d.time1 && (d.time1 = d.time), d.targets > d.targets1 && (d.targets1 = d.targets)) : (100 <= d.score && 15 <= d.targets ? this.trophyNumber = 3 : 60 <= d.score && 10 <= d.targets ? this.trophyNumber = 2 : 25 <= d.score && 5 <= d.targets && (this.trophyNumber = 1), this.trophyNumber > d.trophy2 && (d.trophy2 = this.trophyNumber), d.score > d.score2 && (d.score2 = d.score), d.time >
                d.time2 && (d.time2 = d.time), d.targets > d.targets2 && (d.targets2 = d.targets));
            U.save()
        },
        addContent: function() {
            this.frame = new h;
            g.createImageSprite(this.owner, this.frame, "gameover/frame_mission" + d.mission, !0, 0, 0);
            P.animate(this.frame, 0, -15, -450, 20, 0.2);
            var a = new h;
            d.vo ? g.createImageSprite(this.owner, a, "gameover/header", !0, 0, -200) : g.createXMLSprite(this.owner, a, d.titleFont, "Center", 0, -200, d.translations.node.resolve("missionOver"));
            P.spawn(a, 0.5, 0.3, 0.3);
            this.items.push(a);
            a = new h;
            g.createXMLSprite(this.owner,
                a, d.blackItalicFont, "Center", 10, -110, d.translations.node.resolve("results"));
            ...
            this.items.push(a);
            a = new h;
            g.createTextSprite(this.owner,
                a, d.blackFont, "Center", 150, -58, r.string(d.score));
            P.spawn(a, 1, 0.3, 0.3);
            this.items.push(a);
            a = new h;
            g.createTextSprite(this.owner, a, d.blackFont, "Center", 150, 2, r.string(d.time));
            P.spawn(a, 1.1, 0.3, 0.3);
            this.items.push(a);
            a = new h;
            g.createTextSprite(this.owner, a, d.blackFont, "Center", 150, 64, r.string(d.targets));
            P.spawn(a, 1.2, 0.3, 0.3);
            this.items.push(a);
            this.closeBtn = new h;
            g.createImageSprite(this.owner, this.closeBtn, "buttons/BTN_home", !0, 285, -95);
            P.spawn(this.closeBtn, 1.5, 0.5, 0.5);
            this.items.push(this.closeBtn);
            this.replayBtn = new h;
            g.createImageSprite(this.owner, this.replayBtn, "buttons/BTN_replay", !0, 285, 0);
            P.spawn(this.replayBtn, 1.7, 0.5, 0.5);
            this.items.push(this.replayBtn);
            0 < this.trophyNumber && (a = new h, g.createImageSprite(this.owner, a, "gameover/trophy_" + this.trophyNumber, !0, -130, 50), P.spawn(a, 1, 0.5, 0.5), a = (new h).add(new S("screens/glint", "glint", -132, 103)), this.owner.addChild(a), P.spawn(a, 1, 0.5, 0.5));
            this.connect1(m.$vG.$GG.down, D(this, this.onPointerDown));
            this.connect1(m.$vG.$GG.move, D(this, this.onPointerMove))
        },
        onPointerDown: function(a) {
            d.replay = !1;
            a.hit == this.replayBtn.$zF[1] ? (d.replay = !0, null) : a.hit == this.closeBtn.$zF[1] && (d.replay = !1, null);
            this.callback()
        },
        onPointerMove: function(a) {
            g.rolloverImage(this.closeBtn, "buttons/BTN_home", "buttons/BTN_home_rollover", a);
            g.rolloverImage(this.replayBtn, "buttons/BTN_replay", "buttons/BTN_replay_rollover", a)
        },
        __class__: Jb
    });
    var Kb = function(a, b, c) {
        ...
        this.y = b | 0;
        this.callback = c;
        d.resizeScreen ? (this.screenWidth = d.staticWidth, this.screenHeight =
            d.staticHeight) : (this.screenWidth = m.$vG.$IG.get_width(), this.screenHeight = m.$vG.$IG.get_height())
    };
    l["project.Help"] = Kb;
    ...
    Kb.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            g.createFillSprite(this.owner, this.fade, 0, !0, 0, 0, 3E3, 3E3, 0);
            var b = new G;
            b.run(new H([new ca(this.fade.$zF[1].alpha,
                0.75, 0.5), new x(function() {
                a.addContent()
            })]));
            this.fade.add(b)
        },
        addContent: function() {
            ...
            P.animate(this.frame, 0, -15, -450, 20, 0.2);
            var a = new h;
            d.vo ? g.createImageSprite(this.owner, a, "help/header", !0, 0, -200) : g.createXMLSprite(this.owner, a, d.titleFont, "Center", 0, -200, d.translations.node.resolve("help"));
            P.spawn(a, 0.5, 0.3, 0.3);
            this.items.push(a);
            this.help = new h;
            1 == d.mission ? d.isMobile ? (g.createImageSprite(this.owner, this.help,
                    "help/m1_mobile1", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 30, 30, d.translations.node.resolve("run")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 265, 30, d.translations.node.resolve("jumpCars"))) : (g.createImageSprite(this.owner, this.help, "help/m1_desktop1", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 20, 20, d.translations.node.resolve("run")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 250, 20, d.translations.node.resolve("jumpCars"))) :
                d.isMobile ? d.vo ? g.createImageSprite(this.owner, this.help, "help/m2_mobile1", !0, 15, 20) : (g.createImageSprite(this.owner, this.help, "help/m2_mobile1_int", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 210, 20, d.translations.node.resolve("jumpWall")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 35, 210, d.translations.node.resolve("jump")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 150, 255, d.translations.node.resolve("hold")), a = new h, g.createXMLSprite(this.help,
                    a, d.helpFont, "Center", 330, 220, d.translations.node.resolve("power"))) : d.vo ? g.createImageSprite(this.owner, this.help, "help/m2_desktop1", !0, 15, 20) : (g.createImageSprite(this.owner, this.help, "help/m2_desktop1_int", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 210, 20, d.translations.node.resolve("jumpWall")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 35, 210, d.translations.node.resolve("jump")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 150, 255, d.translations.node.resolve("hold")),
                    a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 330, 220, d.translations.node.resolve("power")));
            P.fadeIn(this.help, 0.9, 0.3);
            this.backBtn = new h;
            g.createImageSprite(this.owner, this.backBtn, "buttons/BTN_back", !0, -275, 20);
            P.spawn(this.backBtn, 1.5, 0.5, 0.5);
            this.items.push(this.backBtn);
            this.nextBtn = new h;
            g.createImageSprite(this.owner, this.nextBtn, "buttons/BTN_next", !0, 300, 20);
            P.spawn(this.nextBtn, 1.5, 0.5, 0.5);
            this.items.push(this.nextBtn);
            this.closeBtn = new h;
            g.createImageSprite(this.owner, this.closeBtn,
                "buttons/BTN_close", !0, 300, -100);
            P.spawn(this.closeBtn, 1.5, 0.5, 0.5);
            this.items.push(this.closeBtn);
            this.connect1(m.$vG.$GG.down, D(this, this.onPointerDown));
            this.connect1(m.$vG.$GG.move, D(this, this.onPointerMove))
        ...
        onPointerDown: function(a) {
            ...
            else if (a.hit == this.backBtn.$zF[1] || a.hit == this.nextBtn.$zF[1]) this.help.dispose(), this.help = new h, 1 == this.stage ? (this.stage = 2, 1 == d.mission ? (g.createImageSprite(this.owner, this.help, "help/m1_2", !0, 0, 20), a = new h, g.createXMLSprite(this.help,
                a, d.helpFont, "Left", 270, 55, d.translations.node.resolve("collect")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Left", 270, 200, d.translations.node.resolve("avoid"))) : (g.createImageSprite(this.owner, this.help, "help/m2_2", !0, 0, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 95, 35, d.translations.node.resolve("collect2")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Left", 335, 40, d.translations.node.resolve("land")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 260, 170,
                d.translations.node.resolve("avoid")))) : (this.stage = 1, 1 == d.mission ? d.isMobile ? (g.createImageSprite(this.owner, this.help, "help/m1_mobile1", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 30, 30, d.translations.node.resolve("run")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 265, 30, d.translations.node.resolve("jumpCars"))) : (g.createImageSprite(this.owner, this.help, "help/m1_desktop1", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 20, 20, d.translations.node.resolve("run")),
                a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 250, 20, d.translations.node.resolve("jumpCars"))) : d.isMobile ? d.vo ? g.createImageSprite(this.owner, this.help, "help/m2_mobile1", !0, 15, 20) : (g.createImageSprite(this.owner, this.help, "help/m2_mobile1_int", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 215, 25, d.translations.node.resolve("jumpWall")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 55, 225, d.translations.node.resolve("jump")), a = new h, g.createXMLSprite(this.help,
                a, d.helpFont, "Center", 155, 270, d.translations.node.resolve("hold")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 330, 220, d.translations.node.resolve("power"))) : d.vo ? g.createImageSprite(this.owner, this.help, "help/m2_desktop1", !0, 15, 20) : (g.createImageSprite(this.owner, this.help, "help/m2_desktop1_int", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 215, 25, d.translations.node.resolve("jumpWall")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 55, 225, d.translations.node.resolve("jump")),
                a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 155, 270, d.translations.node.resolve("hold")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 330, 220, d.translations.node.resolve("power")))), P.fadeIn(this.help, 0, 0.3)
        },
        onPointerMove: function(a) {
            g.rolloverImage(this.closeBtn, "buttons/BTN_close", "buttons/BTN_close_rollover", a);
            g.rolloverImage(this.backBtn, "buttons/BTN_back", "buttons/BTN_back_rollover", a);
            g.rolloverImage(this.nextBtn, "buttons/BTN_next", "buttons/BTN_next_rollover", a)
        },
        __class__: Kb
    });
    ...
    od.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            g.alignLeft(a);
            a = new h;
            g.createImageSprite(this.owner, a, "hud/HUD_top_right", !1, this.screenWidth - 200, -10);
            g.alignRight(a);
            a = new h;
            g.createImageSprite(this.owner, a,
                "hud/logo", !1, 10, 10);
            g.alignLeft(a);
            a = new h;
            g.createXMLSprite(this.owner, a, d.italicFont, "Center", 120, 87, d.translations.node.resolve("cinemaGame"));
            g.alignLeft(a);
            a = new h;
            g.createImageSprite(this.owner, a, "hud/char_icon_" + d["char"], !0, 290, 50);
            g.alignLeft(a);
            this.healthbar = new h;
            g.createImageSprite(this.owner, this.healthbar, "hud/health4", !0, 450, 65);
            g.alignLeft(this.healthbar);
            a = new h;
            switch (d["char"]) {
                case "miles":
                    g.createXMLSprite(this.healthbar, a, d.italicFont, "Center", 50, -6, d.translations.node.resolve("miles"));
                    break;
                case "gwen":
                    g.createXMLSprite(this.healthbar, a, d.italicFont, "Center", 50, -6, d.translations.node.resolve("gwen"))
            }
            g.alignLeft(a);
            a.$zF[1].set_pixelSnapping(!1);
            var b = a.$zF[1].scaleX;
            ...
            g.createTextSprite(this.owner, this.scoreText, d.hudFont, "Left", 617, 22, "0");
            g.alignLeft(this.scoreText);
            a = new h;
            g.createImageSprite(this.owner, a, "game2/landing_icon",
                !0, 690, 55);
            g.alignLeft(a);
            this.tagsText = new h;
            g.createTextSprite(this.owner, this.tagsText, d.hudFont, "Left", 711, 22, "0");
            g.alignLeft(this.tagsText);
            a = new h;
            g.createImageSprite(this.owner, a, "hud/time_icon", !0, 776, 50);
            g.alignLeft(a);
            this.timeText = new h;
            g.createTextSprite(this.owner, this.timeText, d.hudFont, "Left", 798, 22, "60");
        ...
        setScore: function(a) {
            r.instance(this.scoreText.$zF[1], I).set_text(null ==
                a ? "null" : "" + a)
        },
        setTime: function(a) {
            r.instance(this.timeText.$zF[1], I).set_text(null == a ? "null" : "" + a);
            5 >= a ? this.timeText.$zF[1].setTint(16711680) : this.timeText.$zF[1].setTint(16777215)
        },
        setHealth: function(a) {
            r.instance(this.healthbar.$zF[1], N).texture = d.pack.getTexture("hud/health" + a);
            g.alignLeft(this.healthbar)
        },
        __class__: od
    });
    ...
    pd.prototype =
        v(s.prototype, {
            ...
            onAdded: function() {
                ...
                g.alignLeft(a);
                a = new h;
                g.createImageSprite(this.owner,
                    a, "hud/char_icon_" + d["char"], !0, 290, 50);
                g.alignLeft(a);
                this.healthbar = new h;
                g.createImageSprite(this.owner, this.healthbar, "hud/health4", !0, 450, 65);
                g.alignLeft(this.healthbar);
            ...
            setScore: function(a) {
                r.instance(this.scoreText.$zF[1], I).set_text(null == a ? "null" : "" + a)
            },
            setTargets: function(a) {
                r.instance(this.tagsText.$zF[1], I).set_text(null == a ? "null" : "" + a)
            },
    ...
    var ld = function(a, b, c) {
        ...
        this.midSpeed = 100;
        this.rearSpeed = -200;
        this.inPlatform = this.enterPlatform = this.exitPlatform = this.platformLightsOn = this.inColumn = !1;
        this.timer = 1.5;
        this.seconds = 60;
    ...
    ld.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            d.isMobile && (this.connect1(m.$vG.$JG.down, D(this, this.handleTouchDown)), this.connect1(m.$vG.$JG.move, D(this, this.handleTouchMove)), this.connect1(m.$vG.$JG.up, D(this, this.handleTouchUp)));
            this.connect1(m.$vG.getKeyboard().down,
                D(this, this.keyDownHandler));
            ...
            this.startGame();
            this.musicLoop = d.pack.getSound("audio/Spiderman_ITSV_SubwayGameplay_v1").loop();
        ...
        startGame: function() {
            ...
            g.createImageSprite(this.screen, this.background, "blank", !1, -((1336 - this.screenWidth) / 2), this.screenHeight - 768);
            this.background.$zF[1].set_pixelSnapping(!1);
            var b = new h;
            g.createImageSprite(this.background, b, "game/bg_tunnel", !1, 0, 0);
            this.bgs.push(b);
            b = new h;
            g.createImageSprite(this.background, b, "game/bg_tunnel", !1, this.bgWidth, 0);
            this.bgs.push(b);
            b = new h;
            g.createImageSprite(this.background, b, "game/bg_tunnel", !1, 2 * this.bgWidth, 0);
            this.bgs.push(b);
            this.platformBackground = new h;
            g.createImageSprite(this.screen, this.platformBackground, "blank", !1, -((1336 - this.screenWidth) / 2), this.screenHeight - 520);
            this.platformBackground.$zF[1].set_pixelSnapping(!1);
            this.firstRedPlatform =
                new h;
            g.createImageSprite(this.platformBackground, this.firstRedPlatform, "game/red/bg_back_layer", !1, 0, 0);
            this.firstRedPlatform.$zF[1].set_visible(!1);
            this.platformBgs.push(this.firstRedPlatform);
            b = new h;
            g.createImageSprite(this.platformBackground, b, "game/red/bg_back_layer", !1, this.platformBGWidth, 0);
            b.$zF[1].set_visible(!1);
            this.platformBgs.push(b);
            b = new h;
            g.createImageSprite(this.platformBackground, b, "game/red/bg_back_layer", !1, 2 * this.platformBGWidth, 0);
            b.$zF[1].set_visible(!1);
            this.platformBgs.push(b);
            ...
            g.createImageSprite(this.screen, this.platformLight, "blank", !1, -((1336 - this.screenWidth) / 2), this.screenHeight - 600);
            ...
            b = new h;
            g.createImageSprite(this.platformLight, b, "game/red/light",
                !1, this.platformBGWidth, 0);
            b.$zF[1].set_visible(!1);
            this.platformLights.push(b);
            b = new h;
            g.createImageSprite(this.platformLight, b, "game/red/light", !1, 2 * this.platformBGWidth, 0);
            b.$zF[1].set_visible(!1);
            this.platformLights.push(b);
            this.game = new h;
            ...
            this.rearTrack.push(this.duplicateCar(b));
            this.fade2 = new h;
            g.createImageSprite(this.game, this.fade2, "game/fade", !0, this.screenWidth / 2, this.screenHeight - 768 + 650);
            this.fade2.$zF[1].scaleX.set__(3);
            b = (new h).add(new Pa(2, -300, this.screenHeight - 768 + 600));
            this.game.addChild(b);
            b.$zF[1].set_pixelSnapping(!1);
            this.midTrack.push(this.duplicateCar(b));
            b = (new h).add(new Pa(2, 2200, this.screenHeight - 768 +
                600));
            this.game.addChild(b);
            b.$zF[1].set_pixelSnapping(!1);
            this.midTrack.push(this.duplicateCar(b));
            this.fade1 = new h;
            g.createImageSprite(this.game, this.fade1, "game/fade", !0, this.screenWidth / 2, this.screenHeight - 768 + 750);
            ...
            this.group = 7;
            this.spidey = (new h).add(new rd(this.midTrack[0], 500, 20, D(this, this.leaveCar), D(this, this.landOnCar)));
            this.midTrack[0].addChild(this.spidey);
            b = new G;
            b.run(new H([new z(0.1), new x(function() {
                a.screenPushback = !0
            })]));
            this.spidey.add(b);
            this.darkFade = new h;
            g.createFillSprite(this.screen, this.darkFade, 0, !0, this.screenWidth / 2, this.screenHeight / 2, 3E3, 3E3, 0);
            this.column = new h;
            g.createImageSprite(this.game, this.column, "game/red/fg_column", !1, -500, this.screenHeight - 749);
            ...
            b = 0;
            for (c = this.midTrack; b < c.length;) f = c[b], ++b, this.cars.push(f);
            b = 0;
            for (c = this.rearTrack; b < c.length;) f = c[b], ++b, this.cars.push(f);
            this.hud = (new h).add(new od(0, 0, this.screenWidth,
                this.screenHeight));
            this.screen.addChild(this.hud);
            d.isMobile && (this.leftBtn = new h, g.createImageSprite(this.screen, this.leftBtn, "game/left", !0, 70, this.screenHeight - 100), this.rightBtn = new h, g.createImageSprite(this.screen, this.rightBtn, "game/right", !0, 210, this.screenHeight - 100), g.alignLeft(this.leftBtn), g.alignLeft(this.rightBtn), this.upBtn = new h, g.createImageSprite(this.screen, this.upBtn, "game/up", !0, this.screenWidth - 120, this.screenHeight - 170), this.downBtn = new h, g.createImageSprite(this.screen, this.downBtn,
                "game/down", !0, this.screenWidth - 120, this.screenHeight - 60), g.alignRight(this.upBtn), g.alignRight(this.downBtn));
            this.help = (new h).add(new Kb(this.screenWidth / 2, this.screenHeight / 2, D(this, this.helpCallback)));
        ...
        helpCallback: function() {
            ...
            this.inPlay = !0;
            var b = new G;
            b.run(new ua(new H([new z(2), new x(function() {
                    a.inColumn = !0;
                    r.instance(a.column.$zF[1], N).texture = d.pack.getTexture("game/light/fg_column");
                    a.column.$zF[1].x.set__(a.screenWidth + 200)
                }),
                new z(3), new x(function() {
                    a.startPlatform()
                }), new z(3), new x(function() {
                    a.endPlatform()
                }), new z(2)
        ...
        startPlatform: function() {
            ...
            r.instance(this.column.$zF[1], N).texture = d.pack.getTexture("game/red/fg_column")
        },
        ...
        duplicateCar: function(a) {
            var b =
                (new h).add(new jd(a, this.screenWidth / 2 - 650 - 800, this.screenHeight - 768 + 600));
            this.game.addChild(b);
            b.$zF[1].set_pixelSnapping(!1);
            var c = new h;
            g.createFillSprite(this.screen, c, 16777215, !1, this.screenWidth + d.offsetX / 2, 0, 3E3, this.screenHeight, 1);
            this.masks.push(c);
            b.$zF[1].set_mask(c.$zF[1]);
            a = (new h).add(new id(a, b, this.screenWidth / 2 - 650 - 800, this.screenHeight - 768 + 600));
        ...
        leaveCar: function(a, b) {
            ...
            if (b)
                if (a ? this.spidey.$zF[1].x.animateBy(-50, 1, C.sineOut) : this.spidey.$zF[1].x.animateBy(50, 1, C.sineOut), 2 > this.spidey.$zF[28].track) {
                    ...
                    c = 0;
                    for (d =
                        this.frontTrack; c < d.length;) e = d[c], ++c, this.game.addChild(e.$zF[29].linked), this.game.addChild(e.$zF[29].linked2), this.game.addChild(e)
                } else if (3 > this.spidey.$zF[28].track)
                for (c = 0, d = this.frontTrack; c < d.length;) e = d[c], ++c, this.game.addChild(e.$zF[29].linked), this.game.addChild(e.$zF[29].linked2), this.game.addChild(e);
        ...
        landOnCar: function(a) {
            ...
            if (99 == a) {
                var c = new G;
                c.run(new H([new z(0.5), new x(function() {
                    b.checkGameOver()
                }), new z(2), new x(function() {
                    0 < b.spidey.$zF[28].health &&
                        b.respawn()
                })]));
                this.spidey.add(c)
            } else {
                ...
                this.spidey.$zF[28].walkLeft ? d -= 40 : this.spidey.$zF[28].walkRight && (d += 40);
                for (var e = 0; e < c.length;) {
                    var g = c[e];
                    ++e;
                    if (d - g.$zF[1].x.$bG > this.spidey.$zF[28].carLeft - 50 && d - g.$zF[1].x.$bG < this.spidey.$zF[28].carRight + 50) {
                        a = !0;
                ...
                if (!a) {
                    ...
                    if (2 > this.spidey.$zF[28].track) {
                        c = 0;
                        for (a = this.midTrack; c < a.length;) d = a[c], ++c, this.game.addChild(d.$zF[29].linked), this.game.addChild(d.$zF[29].linked2), this.game.addChild(d);
                        this.game.addChild(this.fade1);
                        c = 0;
                        for (a = this.frontTrack; c < a.length;) d = a[c], ++c, this.game.addChild(d.$zF[29].linked), this.game.addChild(d.$zF[29].linked2), this.game.addChild(d)
                    } else if (3 > this.spidey.$zF[28].track)
                        for (c = 0, a = this.frontTrack; c < a.length;) d =
                            a[c], ++c, this.game.addChild(d.$zF[29].linked), this.game.addChild(d.$zF[29].linked2), this.game.addChild(d);
                    c = new G;
                    c.run(new H([new z(0.5), new x(function() {
                        b.checkGameOver()
                    }), new z(2), new x(function() {
        ...
        checkGameOver: function() {
            ...
            if (1 > this.spidey.$zF[28].health) {
                var b =
                    new G;
                b.run(new H([new z(3), new x(function() {
                    d.score = a.score;
                    d.targets = a.targets;
                    a.showGameOver()
                })]));
        ...
        spawnPickupGroup: function(a, b) {
            switch (b) {
                ...
                case 2:
                    ...
                    g.coinFlip() && this.spawnPickup("pickup",
                        a, 1600);
                    g.coinFlip() && this.spawnPickup("pickup", a, 1700);
                    break;
                case 3:
                    ...
                    g.coinFlip() && (this.spawnPickup("pickup", a, 600), this.spawnPickup("pickup", a, 1400));
                    break;
                case 4:
                    g.coinFlip() ? (this.spawnPickup("pickup", a, 400), this.spawnPickup("pickup", a, 500), this.spawnPickup("pickup", a, 600), this.spawnPickup("target", a, 1500)) : (this.spawnPickup("pickup", a, 1400), this.spawnPickup("pickup", a, 1500), this.spawnPickup("pickup",
                        a, 1600), this.spawnPickup("target", a, 500));
                    break;
                case 5:
                ...
                case 7:
                    ...
                    break;
                case 8:
                    g.coinFlip() ? (this.spawnPickup("bomb", a, 500), this.spawnPickup("target", a, 1500)) : (this.spawnPickup("bomb", a, 1500), this.spawnPickup("target", a, 500));
                    break;
                case 9:
                    g.coinFlip() ? (this.spawnPickup("bomb", a, 400), this.spawnPickup("time", a, 600), this.spawnPickup("bomb", a, 800), g.coinFlip() && this.spawnPickup("target", a, 1500)) : (this.spawnPickup("bomb", a, 1400), this.spawnPickup("time", a, 1600), this.spawnPickup("bomb", a, 1800), g.coinFlip() && this.spawnPickup("target", a, 500));
                    break;
                case 10:
                    g.coinFlip() ? (this.spawnPickup("bomb",
                        a, 100), this.spawnPickup("pickup", a, 250), g.coinFlip() && (this.spawnPickup("target", a, 1500), this.spawnPickup("bomb", a, 1300))) : (this.spawnPickup("pickup", a, 100), this.spawnMovingPickup("bomb", a, 250, 200, 1), g.coinFlip() && (this.spawnPickup("pickup", a, 1500), this.spawnPickup("pickup", a, 1300)));
                    break;
                case 11:
                    g.coinFlip() ? (this.spawnPickup("bomb", a, 400), this.spawnPickup("time", a, 600), this.spawnPickup("bomb", a, 800), this.spawnPickup("pickup", a, 1E3), this.spawnPickup("bomb", a, 1200), this.spawnPickup("target", a, 1400)) :
                        (this.spawnPickup("bomb", a, 400), this.spawnPickup("target", a, 600), this.spawnPickup("bomb", a, 800), this.spawnPickup("pickup", a, 1E3), this.spawnPickup("bomb", a, 1200), this.spawnPickup("time", a, 1400));
                ...
                case 12:
                    ...
                    this.spawnPickup("pickup", a, c + 100);
                    this.spawnPickup("pickup", a, c + 200);
                    this.healthPickups < this.maxHealthPickups ? (this.spawnPickup("health", a, c + 300), this.healthPickups++) : this.spawnPickup("pickup", a, c + 300);
                    this.spawnPickup("pickup", a, c + 400);
                ...
                case 15:
                    ...
                    break;
                case 16:
                    g.coinFlip() ? (this.spawnPickup("pickup", a, 400), this.spawnPickup("pickup", a, 500), this.spawnPickup("pickup", a, 600), this.spawnPickup("target", a, 1500)) : (this.spawnPickup("pickup", a, 1400), this.spawnPickup("pickup", a, 1500), this.spawnPickup("pickup", a, 1600), this.spawnPickup("target", a, 500));
                    break;
                case 17:
                ...
                case 19:
                    this.spawnPickup("pickup", a, 500);
                    this.spawnPickup("pickup", a, 600);
                    this.healthPickups < this.maxHealthPickups ? (this.spawnPickup("health", a, 800), this.healthPickups++) : this.spawnPickup("bomb", a, 800);
                    this.spawnPickup("pickup",
                        a, 1E3);
                    this.spawnPickup("pickup", a, 1100);
                    break;
                case 20:
                    g.coinFlip() ? (this.spawnMovingPickup("bomb", a, 500, 300, 1.5), this.spawnPickup("target", a, 1500)) : (this.spawnMovingPickup("bomb", a, 1300, 300, 1.5), this.spawnPickup("target", a, 500));
                    break;
                case 21:
                    g.coinFlip() ? (this.spawnPickup("bomb", a, 400), this.spawnPickup("pickup", a, 550), this.spawnPickup("pickup", a, 650), this.spawnPickup("bomb", a, 800), g.coinFlip() && this.spawnPickup("target", a, 1500)) : (this.spawnPickup("bomb", a, 1400), this.spawnPickup("target", a, 1600),
                        this.spawnPickup("bomb", a, 1800), g.coinFlip() && (this.spawnPickup("bomb", a, 300), this.spawnPickup("pickup", a, 500), this.spawnPickup("pickup", a, 600)));
                    break;
                case 22:
                    g.coinFlip() ? (this.spawnMovingPickup("bomb", a, 200, 300, 1.5), this.spawnPickup("pickup", a, 100), g.coinFlip() && (this.spawnPickup("target", a, 1500), this.spawnPickup("bomb", a, 1300))) : (this.spawnPickup("pickup", a, 100), this.spawnPickup("bomb", a, 250), g.coinFlip() && (this.spawnPickup("pickup", a, 1500), this.spawnPickup("pickup", a, 1300)));
                    break;
                case 23:
                    g.coinFlip() ?
                        (this.spawnPickup("bomb", a, 400), this.spawnPickup("pickup", a, 600), this.spawnPickup("bomb", a, 800), this.spawnPickup("pickup", a, 1E3), this.spawnPickup("bomb", a, 1200), this.spawnPickup("target", a, 1400)) : (this.spawnPickup("bomb", a, 400), this.spawnPickup("target", a, 600), this.spawnPickup("bomb", a, 800), this.spawnPickup("pickup", a, 1E3), this.spawnPickup("bomb", a, 1200), this.spawnPickup("pickup", a, 1400));
                    this.spawnPickup("bomb", a, 1600);
                    break;
                case 24:
                    c = g.randomNumber(200, 1E3), this.spawnPickup("pickup", a, c), this.spawnPickup("pickup",
                        a, c + 100), this.spawnPickup("pickup", a, c + 200), this.healthPickups < this.maxHealthPickups ? (this.spawnPickup("health", a, c + 300), this.healthPickups++) : this.spawnPickup("pickup", a, c + 300), this.spawnPickup("pickup", a, c + 400), this.spawnPickup("pickup", a, c + 500), this.spawnPickup("pickup", a, c + 600), this.group = 15
            }
            this.group++
        },
        ...
        onUpdate: function(a) {
            this.inPlay && (this.timer -= a, 0 >= this.timer && this.controlsActive && !this.gameEnded && (this.timer++, d.time++, 0 < this.seconds && (this.seconds--, this.hud.$zF[34].setTime(this.seconds), 0 == this.seconds && this.timeOut())), this.gameEnded || this.scroll(a), this.collidePickups(), this.screenPushback && 0 < this.spidey.$zF[28].health && (null != this.spidey.$zF[28].car ? this.spidey.$zF[1].x.$bG + this.spidey.$zF[28].car.$zF[1].x.$bG > this.rightLimit ?
                this.spidey.$zF[1].x.set__(this.rightLimit - this.spidey.$zF[28].car.$zF[1].x.$bG) : this.spidey.$zF[1].x.$bG + this.spidey.$zF[28].car.$zF[1].x.$bG < this.leftLimit && this.spidey.$zF[1].x.set__(this.leftLimit - this.spidey.$zF[28].car.$zF[1].x.$bG) : this.spidey.$zF[1].x.$bG > this.rightLimit ? this.spidey.$zF[1].x.set__(this.rightLimit) : this.spidey.$zF[1].x.$bG < this.leftLimit && this.spidey.$zF[1].x.set__(this.leftLimit)))
        },
        timeOut: function() {
            var a = this;
            ...
            var b = new h;
            d.vo ? g.createImageSprite(this.screen, b, "game/time_up", !0, this.screenWidth / 2, this.screenHeight / 2) : g.createXMLSprite(this.screen, b, d.titleFont, "Center", this.screenWidth / 2, this.screenHeight / 2, d.translations.node.resolve("timeUp"));
            P.spawn(b, 0, 0.5, 0.5);
            b = new G;
            b.run(new H([new z(1.5), new x(function() {
                d.score = a.score;
                d.targets = a.targets;
                a.showGameOver()
            })]));
        ...
        collidePickups: function() {
            if (null != this.spidey.$zF[28].car)
                for (var a = 0, b = this.pickups; a < b.length;) {
                    ...
                    ++a;
                    c.$zF[30].active &&
                        c.$zF[30].car == this.spidey.$zF[28].car && 80 > g.vectorDistance(this.spidey.$zF[1].x.$bG, c.$zF[1].x.$bG, 0, 0) && c.$zF[30].hit() && ("bomb" == c.$zF[30].type ? (this.spidey.$zF[28].hit(c), this.hud.$zF[34].setHealth(this.spidey.$zF[28].health), this.checkGameOver()) : "time" == c.$zF[30].type ? (this.seconds += 30, this.timer = 1, this.hud.$zF[34].setTime(this.seconds)) : "health" == c.$zF[30].type ? (this.spidey.$zF[28].healthPickup(), this.hud.$zF[34].setHealth(this.spidey.$zF[28].health)) : "target" == c.$zF[30].type ? (this.targets++,
                            this.hud.$zF[34].setTargets(this.targets)) : (this.score++, this.hud.$zF[34].setScore(this.score)))
                }
        },
        scroll: function(a) {
            ...
            b.set__(b.$bG - this.scrollSpeed * a);
            this.inColumn && (b = this.column.$zF[1].x, b.set__(b.$bG - this.scrollSpeed * a * 1.4));
            if (this.enterPlatform)
                for (var b = 0, c = this.masks; b < c.length;) {
                    var f = c[b];
                    ++b;
                    var e = f.$zF[1].x;
                    e.set__(e.$bG - this.scrollSpeed *
                        a);
                    f.$zF[1].x.$bG < -d.offsetX / 2 - 100 && f.$zF[1].x.set__(-d.offsetX / 2 - 100)
                }
            b = 0;
            for (c = this.bgs; b < c.length;) f = c[b], ++b, this.background.$zF[1].x.$bG + f.$zF[1].x.$bG < -(this.bgWidth + 100) && (f = f.$zF[1].x, f.set__(f.$bG + this.bgWidth * this.bgs.length));
            b = 0;
            for (c = this.platformBgs; b < c.length;)
                if (f = c[b], ++b, this.platformBackground.$zF[1].x.$bG + f.$zF[1].x.$bG < -(this.platformBGWidth + 100))
                    if (e = f.$zF[1].x, e.set__(e.$bG + this.platformBGWidth * this.platformBgs.length), this.inPlatform) {
                        if (f.$zF[1].set_visible(!0), !this.enterPlatform &&
                            this.masks[0].$zF[1].x.$bG > this.screenWidth / 2) {
                            for (var e = 0, g = this.masks; e < g.length;) {
                                var h = g[e];
                                ++e;
                                h.$zF[1].x.set__(this.platformBackground.$zF[1].x.$bG + f.$zF[1].x.$bG)
                            }
                        ...
                        if (this.platformLightsOn) {
                            e = 0;
                            for (g = this.masks; e < g.length;) h = g[e], ++e, h.$zF[1].x.set__(this.platformBackground.$zF[1].x.$bG + f.$zF[1].x.$bG - 3E3);
            ...
            for (c = this.platformLights; b < c.length;) f = c[b], ++b, this.platformLight.$zF[1].x.$bG + f.$zF[1].x.$bG < -(this.platformBGWidth + 100) && (e = f.$zF[1].x, e.set__(e.$bG + this.platformBGWidth * this.platformLights.length), this.inPlatform ? f.$zF[1].set_visible(!0) : f.$zF[1].set_visible(!1));
            if (this.exitPlatform) {
                b = 0;
                for (c = this.masks; b < c.length;) f = c[b], ++b, f = f.$zF[1].x, f.set__(f.$bG - this.scrollSpeed * a);
                this.platformLightsOn = !1;
                this.inColumn || this.column.$zF[1].x.set__(this.masks[0].$zF[1].x.$bG +
                    2950)
            } else this.inPlatform && !this.inColumn && this.column.$zF[1].x.set__(this.masks[0].$zF[1].x.$bG - 50);
            b = 0;
            for (c = this.rearTrack; b < c.length;)
                if (f = c[b], ++b, e = f.$zF[29].linked, g = e.$zF[1].x, g.set__(g.$bG + this.rearSpeed * a), -2500 > e.$zF[1].x.$bG) {
                    e = e.$zF[1].x;
                    e.set__(e.$bG + 5E3);
                    e = 0;
                    for (g = this.pickups; e < g.length;) h = g[e], ++e, h.$zF[30].car == f && (B.remove(this.pickups, h), h.dispose());
                    this.spawnPickupGroup(f, this.group)
                } b = 0;
            for (c = this.midTrack; b < c.length;)
                if (f = c[b], ++b, e = f.$zF[29].linked, g = e.$zF[1].x, g.set__(g.$bG +
                        this.midSpeed * a), e.$zF[1].x.$bG > this.screenWidth + 300) {
                    e = e.$zF[1].x;
                    e.set__(e.$bG - 5E3);
                    e = 0;
                    for (g = this.pickups; e < g.length;) h = g[e], ++e, h.$zF[30].car == f && (B.remove(this.pickups, h), h.dispose());
            ...
            for (c = this.frontTrack; b < c.length;)
                if (f = c[b], ++b, e = f.$zF[29].linked, g = e.$zF[1].x, g.set__(g.$bG + this.frontSpeed * a), -2500 > e.$zF[1].x.$bG) {
                    e = e.$zF[1].x;
                    e.set__(e.$bG + 5E3);
                    e = 0;
                    for (g = this.pickups; e < g.length;) h = g[e], ++e, h.$zF[30].car == f && (B.remove(this.pickups, h), h.dispose());
                    this.spawnPickupGroup(f,
                        this.group)
                }
        },
        handleTouchDown: function(a) {
            ...
            g.vectorDistance(b, this.leftBtn.$zF[1].x.$bG, a, this.leftBtn.$zF[1].y.$bG) < this.touchDist ? this.spidey.$zF[28].walk(M.LEFT, !0) : g.vectorDistance(b, this.rightBtn.$zF[1].x.$bG, a, this.rightBtn.$zF[1].y.$bG) < this.touchDist ? this.spidey.$zF[28].walk(M.RIGHT, !0) : g.vectorDistance(b, this.upBtn.$zF[1].x.$bG, a, this.upBtn.$zF[1].y.$bG) < this.touchDist ? this.spidey.$zF[28].jumpUp() : g.vectorDistance(b, this.downBtn.$zF[1].x.$bG,
                a, this.downBtn.$zF[1].y.$bG) < this.touchDist && this.spidey.$zF[28].jumpDown()
        },
        handleTouchMove: function(a) {
            var b = a.viewX / d.scale - d.offsetX / 2;
            a = a.viewY / d.scale - d.offsetY / 2;
            g.vectorDistance(b, this.leftBtn.$zF[1].x.$bG, a, this.leftBtn.$zF[1].y.$bG) < this.touchDist ? this.spidey.$zF[28].walk(M.LEFT, !0) : g.vectorDistance(b, this.rightBtn.$zF[1].x.$bG, a, this.rightBtn.$zF[1].y.$bG) < this.touchDist ? this.spidey.$zF[28].walk(M.RIGHT, !0) : (this.spidey.$zF[28].walk(M.LEFT, !1), this.spidey.$zF[28].walk(M.RIGHT, !1))
        },
        handleTouchUp: function(a) {
            a.viewX /
                d.scale - d.offsetX / 2 < this.screenWidth / 2 && (this.spidey.$zF[28].walk(M.LEFT, !1), this.spidey.$zF[28].walk(M.RIGHT, !1))
        },
        keyDownHandler: function(a) {
            this.inPlay && this.controlsActive && (a.key == e.A || a.key == e.Left ? this.spidey.$zF[28].walk(M.LEFT, !0) : a.key == e.D || a.key == e.Right ? this.spidey.$zF[28].walk(M.RIGHT, !0) : a.key == e.W || a.key == e.Up ? this.spidey.$zF[28].jumpUp() : a.key != e.S && a.key != e.Down || this.spidey.$zF[28].jumpDown());
            if (d.testMode)
                if (a.key == e.P) {
                    for (a = this.cars[g.randomNumber(0, this.cars.length - 1)]; a ==
                        this.spidey.$zF[28].car;) a = this.cars[g.randomNumber(0, this.cars.length - 1)];
                    this.spawnPickup("pickup", a)
                } else if (a.key == e.T) {
                for (a = this.cars[g.randomNumber(0, this.cars.length - 1)]; a == this.spidey.$zF[28].car;) a = this.cars[g.randomNumber(0, this.cars.length - 1)];
                this.spawnPickup("health", a)
            } else if (a.key == e.B) {
                for (a = this.cars[g.randomNumber(0, this.cars.length - 1)]; a == this.spidey.$zF[28].car;) a = this.cars[g.randomNumber(0, this.cars.length - 1)];
                this.spawnPickup("bomb", a)
            } else if (a.key == e.Y) {
                for (a = this.cars[g.randomNumber(0,
                        this.cars.length - 1)]; a == this.spidey.$zF[28].car;) a = this.cars[g.randomNumber(0, this.cars.length - 1)];
                this.spawnMovingPickup("bomb", a, 100, 200, 1)
            } else a.key == e.L && (this.screenPushback = !this.screenPushback)
        },
        keyUpHandler: function(a) {
            this.inPlay && this.controlsActive && (a.key == e.A || a.key == e.Left ? this.spidey.$zF[28].walk(M.LEFT, !1) : a.key != e.D && a.key != e.Right || this.spidey.$zF[28].walk(M.RIGHT, !1))
        },
        showGameOver: function() {
            if (!this.showingGo) {
                this.gameEnded = !0;
                var a = (new h).add(new Jb(this.screenWidth / 2, this.screenHeight /
                    2, D(this, this.closeGameOver)));
                this.screen.addChild(a);
                this.showingGo = !0
            }
        },
    ...
    md.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            this.connect1(m.$vG.getKeyboard().up, D(this, this.keyUpHandler));
            this.startGame();
            this.musicLoop = d.pack.getSound("audio/Spiderman_ITSV_JumpingGameplay_v1").loop();
            this.musicLoop.volume.set__(0);
            this.musicLoop.volume.animateTo(0.8,
                0.5);
        ...
        startGame: function() {
            ...
            this.owner.addChild(this.screen);
            var a = new h;
            g.createFillSprite(this.screen, a, 5003925, !0, this.screenWidth / 2,
                this.screenHeight / 2, 3E3, 3E3, 1);
            this.city = new h;
            g.createImageSprite(this.screen, this.city, "game2/background", !0, this.screenWidth / 2, 630);
            this.city.$zF[1].set_pixelSnapping(!1);
            this.game = new h;
            g.createImageSprite(this.screen, this.game, "blank", !1, 0, 0);
            a = new h;
            g.createImageSprite(this.game, a, "game2/side_wall", !1, this.screenWidth / 2 + 400, 0);
            var b = new h;
            g.createImageSprite(a, b, "game2/side_wall", !1, -800, 0);
            b.$zF[1].scaleX.set__(-1);
            this.walls.push(a);
            a = new h;
            g.createImageSprite(this.game, a, "game2/side_wall",
                !1, this.screenWidth / 2 + 400, this.wallHeight);
            b = new h;
            g.createImageSprite(a, b, "game2/side_wall", !1, -800, 0);
            b.$zF[1].scaleX.set__(-1);
            this.walls.push(a);
            a = new h;
            g.createImageSprite(this.game, a, "game2/side_wall", !1, this.screenWidth / 2 + 400, 2 * this.wallHeight);
            b = new h;
            g.createImageSprite(a, b, "game2/side_wall", !1, -800, 0);
            b.$zF[1].scaleX.set__(-1);
            this.walls.push(a);
            this.spidey = (new h).add(new sd(this.screenWidth / 2 - 410, 150, this.screenWidth / 2 - 410 | 0, this.screenWidth / 2 + 410 | 0, D(this, this.spideyCallback)));
        ...
        spideyCallback: function(a) {
            switch (a) {
                case "JUMP":
                    this.game.$zF[1].y.animateBy(-this.fallDist,
                        1.5 * this.jumpTime, C.sineInOut);
                    ...
                    for (var b = this.pickups; a < b.length;) {
                        var c = b[a];
                        ++a; - 200 > c.$zF[1].y.$bG + this.game.$zF[1].y.$bG && (B.remove(this.pickups, c), c.dispose())
                    }
                    break;
                case "LAND":
                    a = 0;
                    for (b = this.targets; a < b.length;) c = b[a], ++a, c.$zF[24].active && g.vectorDistance(this.spidey.$zF[1].x.$bG, c.$zF[1].x.$bG, this.spidey.$zF[1].y.$bG, c.$zF[1].y.$bG) <
                        c.$zF[24].size && c.$zF[24].hit() && ("target" == c.$zF[24].type ? (this.targetScore++, this.hud.$zF[26].setTargets(this.targetScore)) : "oil" == c.$zF[24].type && this.spidey.$zF[21].hitOil());
                    break;
                case "READY":
                    this.spidey.$zF[21].isLeft ? this.powerbar.$zF[22].spawn(!0, this.screenWidth / 2 - 380, 240) : this.powerbar.$zF[22].spawn(!1, this.screenWidth / 2 + 380, 240);
                    break;
                case "SCAFFOLD":
                    a = 0;
                    for (b = this.targets; a < b.length;) c = b[a], ++a, c.$zF[24].active && "scaffold" == c.$zF[24].type && 500 > g.vectorDistance(this.spidey.$zF[1].x.$bG,
                        c.$zF[1].x.$bG, 0, 0) && 110 > g.vectorDistance(0, 0, this.spidey.$zF[1].y.$bG, c.$zF[1].y.$bG - 35) && c.$zF[24].hit() && this.spidey.$zF[21].hitScaffold();
                    break;
                case "FALLEN":
                    d.score = this.score, d.targets = this.targetScore, this.showGameOver()
            }
        },
        onUpdate: function(a) {
            this.inPlay && (this.timer -= a, 0 >= this.timer && (this.timer++, d.time++, 0 < this.seconds && (this.seconds--, this.hud.$zF[26].setTime(this.seconds), 0 == this.seconds && this.timeOut())), this.scroll(a), this.spawnObjects(), this.collidePickups())
        },
        scroll: function(a) {
            a =
                0;
            for (var b = this.walls; a < b.length;) {
                var c = b[a];
                ++a;
                c.$zF[1].y.$bG + this.game.$zF[1].y.$bG < -(this.wallHeight + 100) && (c = c.$zF[1].y, c.set__(c.$bG + this.wallHeight * this.walls.length))
            }
        },
        spawnObjects: function() {
            if (this.game.$zF[1].y.$bG < this.lastSpawn - this.spawnGap) {
                ...
                3 > this.groups ? a = g.randomNumber(1, 3) : 3 == this.groups ? (a = 0, new h, g.coinFlip() ? this.spawnTarget("targetLeft", g.randomNumber(0, 50)) : this.spawnTarget("targetRight", g.randomNumber(0, 50))) :
                    6 > this.groups ? a = g.randomNumber(1, 3) : 6 == this.groups ? (a = 0, new h, g.coinFlip() ? this.spawnTarget("oilLeft", g.randomNumber(0, 50)) : this.spawnTarget("oilRight", g.randomNumber(0, 50))) : 8 == this.groups ? (a = 0, this.spawnPickup("pickup", 0, 0), this.spawnPickup("time", 0, 50), this.spawnPickup("pickup", 0, 105)) : 9 > this.groups ? a = g.randomNumber(1, 3) : 9 == this.groups ? (a = 0, g.coinFlip() ? this.spawnPickup("bombLeft", 0, 0) : this.spawnPickup("bombRight", 0, 0)) : 14 == this.groups ? a = g.randomNumber(1, 3) : 15 == this.groups ? (a = 0, this.spawnPickup("bombLeft",
                        0, 0), this.spawnPickup("bombRight", 0, 100)) : 16 == this.groups ? a = g.randomNumber(1, 3) : 20 == this.groups ? (a = 0, this.spawnPickup("pickup", 0, 0), this.spawnPickup("time", 0, 50), this.spawnPickup("pickup", 0, 105)) : 30 == this.groups ? (a = 0, this.spawnPickup("pickup", 0, 0), this.spawnPickup("time", 0, 50), this.spawnPickup("pickup", 0, 105)) : 40 == this.groups ? (a = 0, this.spawnPickup("pickup", 0, 0), this.spawnPickup("time", 0, 50), this.spawnPickup("pickup", 0, 105)) : a = 20 > this.groups ? g.randomNumber(1, 5) : 30 > this.groups ? g.randomNumber(1, 7) : g.randomNumber(1,
                        8);
                this.groups++;
                switch (a) {
                    case 1:
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        g.coinFlip() ? this.spawnPickup("bombLeft", 0, 0) : this.spawnPickup("bombRight", 0, 0);
                        break;
                    case 5:
                        g.coinFlip() ?
                            this.spawnTarget("targetLeft", g.randomNumber(0, 50)) : this.spawnTarget("targetRight", g.randomNumber(0, 50));
                        break;
                    case 6:
                        g.coinFlip() ? this.spawnTarget("oilLeft", g.randomNumber(0, 50)) : this.spawnTarget("oilRight", g.randomNumber(0, 50));
                        break;
                    case 7:
                        g.coinFlip() ? this.spawnTarget("scaffoldLeft", g.randomNumber(0, 50)) : this.spawnTarget("scaffoldRight", g.randomNumber(0, 50));
                        break;
                    case 8:
                        this.spawnPickup("bombLeft", 0, 0), this.spawnPickup("bombRight", 0, 100)
                }
            }
        },
        collidePickups: function() {
            for (var a = 0, b = this.pickups; a <
                b.length;) {
                var c = b[a];
                ++a;
                c.$zF[25].active && (this.spidey.$zF[21].isLeft ? (40 > g.vectorDistance(this.spidey.$zF[1].x.$bG - 135, c.$zF[1].x.$bG, this.spidey.$zF[1].y.$bG - 65, c.$zF[1].y.$bG) || 65 > g.vectorDistance(this.spidey.$zF[1].x.$bG - 135, c.$zF[1].x.$bG, this.spidey.$zF[1].y.$bG - 30, c.$zF[1].y.$bG) || 65 > g.vectorDistance(this.spidey.$zF[1].x.$bG - 135, c.$zF[1].x.$bG, this.spidey.$zF[1].y.$bG + 10, c.$zF[1].y.$bG)) && c.$zF[25].hit() && ("bomb" == c.$zF[25].type ? (this.health--, 0 > this.health && (this.health = 0), this.hud.$zF[26].setHealth(this.health),
                        0 == this.health && this.endGame()) : "time" == c.$zF[25].type ? (this.seconds += 30, this.timer = 1, this.hud.$zF[26].setTime(this.seconds)) : (this.score++, this.hud.$zF[26].setScore(this.score))) : (40 > g.vectorDistance(this.spidey.$zF[1].x.$bG + 135, c.$zF[1].x.$bG, this.spidey.$zF[1].y.$bG - 65, c.$zF[1].y.$bG) || 65 > g.vectorDistance(this.spidey.$zF[1].x.$bG + 135, c.$zF[1].x.$bG, this.spidey.$zF[1].y.$bG - 30, c.$zF[1].y.$bG) || 65 > g.vectorDistance(this.spidey.$zF[1].x.$bG + 135, c.$zF[1].x.$bG, this.spidey.$zF[1].y.$bG + 10, c.$zF[1].y.$bG)) &&
                    c.$zF[25].hit() && ("bomb" == c.$zF[25].type ? (this.health--, 0 > this.health && (this.health = 0), this.hud.$zF[26].setHealth(this.health), 0 == this.health && this.endGame()) : "time" == c.$zF[25].type ? (this.seconds += 10, this.timer = 1, this.hud.$zF[26].setTime(this.seconds)) : (this.score++, this.hud.$zF[26].setScore(this.score))))
            }
        },
        timeOut: function() {
            var a = this;
            this.inPlay = !1;
            var b = new G;
            b.run(new H([new z(1), new x(function() {
                d.score = a.score;
        ...
        endGame: function() {
            ...
            var b = new G;
            b.run(new H([new z(2), new x(function() {
                d.score = a.score;
                d.targets = a.targetScore;
                a.showGameOver()
            })]));
        ...
        spawnPickup: function(a, b, c) {
            null == c && (c = 0);
            null == b && (b = 0);
            a = (new h).add(new ud(a, this.screenWidth / 2 + b, -this.game.$zF[1].y.$bG + this.screenHeight + 250 + c));
            this.game.addChild(a);
            this.pickups.push(a);
            this.game.addChild(this.spidey, !0)
        },
        spawnTarget: function(a, b) {
            null == b && (b = 0);
            var c = new h; - 1 != a.indexOf("Left") ? c.add(new Mb(a, this.screenWidth /
                2 - 430, -this.game.$zF[1].y.$bG + this.screenHeight + 250 + b)) : c.add(new Mb(a, this.screenWidth / 2 + 430, -this.game.$zF[1].y.$bG + this.screenHeight + 250 + b));
        ...
        keyDownHandler: function(a) {
            var b = this;
            this.inPlay && (a.key == e.Number1 ? this.spidey.$zF[21].isIdle && (this.fallDist = 10, this.spidey.$zF[21].jump(this.fallDist)) : a.key == e.Number2 ? this.spidey.$zF[21].isIdle && (this.fallDist = 0.1 * (this.screenHeight - 150) | 0, this.spidey.$zF[21].jump(this.fallDist)) :
                a.key == e.Number3 ? this.spidey.$zF[21].isIdle && (this.fallDist = 0.4 * (this.screenHeight - 150) | 0, this.spidey.$zF[21].jump(this.fallDist)) : a.key == e.Number4 ? this.spidey.$zF[21].isIdle && (this.fallDist = 0.7 * (this.screenHeight - 150) | 0, this.spidey.$zF[21].jump(this.fallDist)) : a.key == e.Number5 ? this.spidey.$zF[21].isIdle && (this.fallDist = this.screenHeight - 150 | 0, this.spidey.$zF[21].jump(this.fallDist)) : a.key == e.Number6 ? this.spidey.$zF[21].isIdle && (this.fallDist = 1.2 * (this.screenHeight - 150) | 0, this.spidey.$zF[21].jump(this.fallDist)) :
                a.key == e.Number7 ? this.spidey.$zF[21].isIdle && (this.fallDist = 1.5 * (this.screenHeight - 150) | 0, this.spidey.$zF[21].jump(this.fallDist)) : a.key == e.Number0 ? (this.spidey.$zF[21].isIdle && (this.fallDist = 1.5 * (this.screenHeight - 150) | 0, this.spidey.$zF[21].failJump(this.fallDist)), a = new G, a.run(new H([new z(3), new x(function() {
                    d.score = b.score;
                    d.targets = b.targetScore;
                    b.gameOverCallback()
                })])), this.owner.add(a)) : a.key == e.T ? g.coinFlip() ? this.spawnTarget("targetLeft") : this.spawnTarget("targetRight") : a.key == e.B ? g.coinFlip() ?
                this.spawnPickup("bombLeft", 0, 0) : this.spawnPickup("bombRight", 0, 0) : a.key == e.O ? g.coinFlip() ? this.spawnTarget("oilLeft") : this.spawnTarget("oilRight") : a.key == e.S ? g.coinFlip() ? this.spawnTarget("scaffoldLeft") : this.spawnTarget("scaffoldRight") : a.key == e.L ? this.spawnPickup("time", 0, 0) : a.key == e.Space && this.startPower())
        },
        keyUpHandler: function(a) {
        ...
        endPower: function() {
            ...
            0 <= b && (b /= this.powerbar.$zF[22].length, 1 < b && (b = 1), this.spidey.$zF[21].isIdle && (0.9 < b ? (this.fallDist = 1.5 * (this.screenHeight - 150) * b | 0, this.spidey.$zF[21].failJump(this.fallDist), b = new G, b.run(new H([new z(3), new x(function() {
                a.showGameOver()
            })])), this.owner.add(b)) : (this.fallDist = 1.5 * (this.screenHeight - 150) * b | 0, this.spidey.$zF[21].jump(this.fallDist))));
            null
        },
        showGameOver: function() {
            this.inPlay = !1;
            ...
            var a = (new h).add(new Jb(this.screenWidth / 2, this.screenHeight / 2, D(this, this.closeGameOver)));
            this.screen.addChild(a)
        },
        closeGameOver: function() {
            this.gameOverCallback()
    ...
    ye.main = function() {
        var a, b = (new h).add(new Y(16777215, 960, 560)),
        ...
        c = window.navigator.userAgent; - 1 != c.indexOf("Win") && (d.isMobile = !1); - 1 != c.indexOf("Mac") && (d.isMobile = !1); - 1 != c.indexOf("Mobile") && (d.isMobile = !0);
    ...
    S.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            d.lite && (80 == this.liteScale ? this.thisSprite.setScale(1.25) : 50 == this.liteScale && this.thisSprite.setScale(2), this.thisSprite.set_pixelSnapping(!1))
        },
    ...
    nd.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            a = new h;
            g.createImageSprite(this.owner, a, "help/subscreen",
                !0, 0, 0);
            this.connect1(m.$vG.$GG.down, D(this, this.onPointerDown));
            this.connect1(m.$vG.$GG.move, D(this, this.onPointerMove));
            this.screen = new h;
        ...
        showMenu: function() {
            ...
            g.createImageSprite(this.owner, this.screen, "blank", !0, 0, 0);
            this.btnPlay = new h;
            g.createImageSprite(this.screen, this.btnPlay, "buttons/BTN_play", !0, -180, 10);
            this.btnHelp = new h;
            g.createImageSprite(this.screen, this.btnHelp, "buttons/BTN_help",
                !0, -60, 10);
            this.btnMute = new h;
            d.muted ? g.createImageSprite(this.screen, this.btnMute, "buttons/BTN_audio_OFF", !0, 60, 10) : g.createImageSprite(this.screen, this.btnMute, "buttons/BTN_audio_ON", !0, 60, 10);
            this.btnExit = new h;
            g.createImageSprite(this.screen, this.btnExit, "buttons/BTN_close", !0, 180, 10);
            this.tab = "MENU"
        },
        showHelp: function() {
            this.stage = 1;
            ...
            g.createImageSprite(this.owner, this.screen, "blank", !0, 0, 0);
            var a = new h;
            g.createImageSprite(this.screen, a, "help/header", !0,
                0, -200);
            this.help = new h;
            1 == d.mission ? d.isMobile ? (g.createImageSprite(this.owner, this.help, "help/m1_mobile1", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 30, 30, d.translations.node.resolve("run")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 265, 30, d.translations.node.resolve("jumpCars"))) : (g.createImageSprite(this.owner, this.help, "help/m1_desktop1", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 20, 20, d.translations.node.resolve("run")), a = new h,
                g.createXMLSprite(this.help, a, d.helpFont, "Center", 250, 20, d.translations.node.resolve("jumpCars"))) : d.isMobile ? d.vo ? g.createImageSprite(this.owner, this.help, "help/m2_mobile1", !0, 15, 20) : (g.createImageSprite(this.owner, this.help, "help/m2_mobile1_int", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 210, 20, d.translations.node.resolve("jumpWall")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 35, 210, d.translations.node.resolve("jump")), a = new h, g.createXMLSprite(this.help,
                a, d.helpFont, "Center", 150, 255, d.translations.node.resolve("hold")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 330, 220, d.translations.node.resolve("power"))) : d.vo ? g.createImageSprite(this.owner, this.help, "help/m2_desktop1", !0, 15, 20) : (g.createImageSprite(this.owner, this.help, "help/m2_desktop1_int", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 210, 20, d.translations.node.resolve("jumpWall")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 35, 210, d.translations.node.resolve("jump")),
                a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 150, 255, d.translations.node.resolve("hold")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 330, 220, d.translations.node.resolve("power")));
            this.backBtn = new h;
            g.createImageSprite(this.screen, this.backBtn, "buttons/BTN_back", !0, -275, 20);
            this.nextBtn = new h;
            g.createImageSprite(this.screen, this.nextBtn, "buttons/BTN_next", !0, 300, 20);
            this.btnExit = new h;
            this.showExit && g.createImageSprite(this.screen, this.btnExit, "buttons/BTN_close", !0, 300,
                -100);
            this.showExit = !0;
            this.tab = "HELP"
        },
        showQuit: function() {
            ...
            g.createImageSprite(this.owner, this.screen, "blank", !0, 0, 0);
            this.btnExit = new h;
            g.createImageSprite(this.screen, this.btnExit, "buttons/BTN_tick", !0, -100, 30);
            this.btnPlay = new h;
            g.createImageSprite(this.screen, this.btnPlay, "buttons/BTN_close", !0, 100, 30);
            var a = new h;
            g.createXMLSprite(this.screen, a, d.italicFont, "Center", 0, -100, d.translations.node.resolve("sure"));
            this.tab = "QUIT"
        },
        onPointerDown: function(a) {
            switch (this.tab) {
                case "MENU":
                    a.hit ==
                        this.btnPlay.$zF[1] ? (this.callback(!1), this.playSound("click")) : a.hit == this.btnHelp.$zF[1] ? (this.showHelp(), this.playSound("click")) : a.hit == this.btnExit.$zF[1] ? (this.showQuit(), this.playSound("click")) : a.hit == this.btnMute.$zF[1] && (d.muted ? (this.btnMute.dispose(), this.btnMute = new h, g.createImageSprite(this.screen, this.btnMute, "buttons/BTN_audio_ON", !0, 60, 10), g.mute(!1)) : (this.btnMute.dispose(), this.btnMute = new h, g.createImageSprite(this.screen, this.btnMute, "buttons/BTN_audio_OFF", !0, 60, 10), g.mute(!0)),
                            this.playSound("click"));
                    break;
                case "HELP":
                    if (a.hit == this.btnExit.$zF[1]) this.help.dispose(), this.showMenu(), this.playSound("click");
                    else if (a.hit == this.backBtn.$zF[1] || a.hit == this.nextBtn.$zF[1]) this.help.dispose(), this.help = new h, 1 == this.stage ? (this.stage = 2, 1 == d.mission ? (g.createImageSprite(this.screen, this.help, "help/m1_2", !0, 0, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Left", 270, 55, d.translations.node.resolve("collect")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Left", 270, 200,
                        d.translations.node.resolve("avoid"))) : (g.createImageSprite(this.owner, this.help, "help/m2_2", !0, 0, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 95, 35, d.translations.node.resolve("collect2")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Left", 335, 40, d.translations.node.resolve("land")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 260, 170, d.translations.node.resolve("avoid")))) : (this.stage = 1, 1 == d.mission ? d.isMobile ? (g.createImageSprite(this.screen, this.help, "help/m1_mobile1",
                            !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 30, 30, d.translations.node.resolve("run")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 265, 30, d.translations.node.resolve("jumpCars"))) : (g.createImageSprite(this.owner, this.help, "help/m1_desktop1", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 20, 20, d.translations.node.resolve("run")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 250, 20, d.translations.node.resolve("jumpCars"))) : d.isMobile ?
                        d.vo ? g.createImageSprite(this.screen, this.help, "help/m2_mobile1", !0, 15, 20) : (g.createImageSprite(this.screen, this.help, "help/m2_mobile1_int", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 215, 25, d.translations.node.resolve("jumpWall")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 55, 225, d.translations.node.resolve("jump")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 155, 270, d.translations.node.resolve("hold")), a = new h, g.createXMLSprite(this.help, a, d.helpFont,
                            "Center", 330, 220, d.translations.node.resolve("power"))) : d.vo ? g.createImageSprite(this.screen, this.help, "help/m2_desktop1", !0, 15, 20) : (g.createImageSprite(this.screen, this.help, "help/m2_desktop1_int", !0, 15, 20), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 215, 25, d.translations.node.resolve("jumpWall")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 55, 225, d.translations.node.resolve("jump")), a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 155, 270, d.translations.node.resolve("hold")),
                            a = new h, g.createXMLSprite(this.help, a, d.helpFont, "Center", 330, 220, d.translations.node.resolve("power")))), P.fadeIn(this.help, 0, 0.3);
                    break;
                case "HELPINTRO":
                    a.hit == this.btnExit.$zF[1] && (this.callback(!1), this.playSound("click"));
                    break;
                case "QUIT":
                    a.hit == this.btnExit.$zF[1] ? (this.callback(!0), this.playSound("click")) : a.hit == this.btnPlay.$zF[1] && (this.showMenu(), this.playSound("click"))
            }
        },
        onPointerMove: function(a) {
            switch (this.tab) {
                case "MENU":
                    g.rolloverImage(this.btnPlay, "buttons/BTN_play", "buttons/BTN_play_rollover",
                        a);
                    g.rolloverImage(this.btnHelp, "buttons/BTN_help", "buttons/BTN_help_rollover", a);
                    g.rolloverImage(this.btnExit, "buttons/BTN_close", "buttons/BTN_close_rollover", a);
                    d.muted ? g.rolloverImage(this.btnMute, "buttons/BTN_audio_OFF", "buttons/BTN_audio_OFF_rollover", a) : g.rolloverImage(this.btnMute, "buttons/BTN_audio_ON", "buttons/BTN_audio_ON_rollover", a);
                    break;
                case "HELP":
                    g.rolloverImage(this.btnExit, "buttons/BTN_close", "buttons/BTN_close_rollover", a);
                    break;
                case "QUIT":
                    g.rolloverImage(this.btnExit, "buttons/BTN_tick",
                        "buttons/BTN_tick_rollover", a), g.rolloverImage(this.btnPlay, "buttons/BTN_close", "buttons/BTN_close_rollover", a)
            }
        },
        playSound: function(a) {
            this.sfx = d.pack.getSound("audio/" + a).play()
    ...
    Lb.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            if ("bomb" == this.type) this.bomb = (new h).add(new S("game/bomb", "idle", 0, 0)), this.owner.addChild(this.bomb);
                ...
                this.burst = (new h).add(new S("game/pickups2",
                    "blank", 3, -20));
                a.addChild(this.burst)
            } else "time" == this.type ? (this.shadow = (new h).add(new S("game/pickups", "shadow", 0, 62)), this.owner.addChild(this.shadow), a = new h, g.createImageSprite(this.owner, a, "blank", !0, 0, 0), g.pulseUpDown(a, 25, 1.2), this.pickup = new h, g.createImageSprite(a, this.pickup, "game/pickup_time", !0, 0, -15), this.burst = (new h).add(new S("game/pickups2", "blank", 3, -20)), a.addChild(this.burst)) : "target" == this.type ? (this.pickup = new h, g.createImageSprite(this.owner, this.pickup, "game/spider_pickup",
                !0, 0, 64), this.burst = (new h).add(new S("game/targetBurst", "blank", 0, 50)), this.owner.addChild(this.burst)) : (this.shadow = (new h).add(new S("game/pickups", "shadow", 0, 62)), this.owner.addChild(this.shadow), a = new h, g.createImageSprite(this.owner, a, "blank", !0, 0, 0), g.pulseUpDown(a, 25, 1.2), this.pickup = new h, g.createImageSprite(a, this.pickup, "game/pickup", !0, 0, 0), this.burst = (new h).add(new S("game/pickups", "blank", 3, -20)), a.addChild(this.burst))
        },
        move: function(a, b) {
            var c = new G;
            c.run(new ua(new H([new ca(this.owner.$zF[1].x,
                this.x + a, b, C.sineInOut), new ca(this.owner.$zF[1].x, this.x, b, C.sineInOut)])));
            this.bomb.add(c)
        },
        hit: function() {
            if (this.active) {
                this.active = !1;
                if ("bomb" == this.type) this.bomb.$zF[17].play("explode", "blank"), null != this.bomb.$zF[11] && (this.bomb.$zF[11].stopAll(), this.owner.$zF[1].x.set__(this.owner.$zF[1].x.$bG)), this.playSound("explode");
                else {
                    if ("target" == this.type) {
                        this.pickup.$zF[1].alpha.animateTo(0, 0.5);
                        this.burst.$zF[17].play("burst", "blank");
                        var a = new h;
                        g.createImageSprite(this.owner, a, "game2/target",
                            !0, 0, 0);
                        a.$zF[1].set_pixelSnapping(!1);
                        a.$zF[1].y.animateBy(-100, 1, C.sineIn);
                        a.$zF[1].alpha.animateTo(0, 1)
                    } else this.shadow.$zF[1].alpha.animateTo(0, 0.1), this.pickup.$zF[1].y.animateBy(-30, 0.5), this.pickup.$zF[1].alpha.animateTo(0, 0.5), this.burst.$zF[17].play("burst", "blank");
    ...
    ud.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            if ("bombLeft" == this.type) {
                ...
                var a = new G;
                a.run(new ua(new H([new ca(this.owner.$zF[1].x, this.x + this.bombMoveDist, this.bombMoveTime, C.sineInOut), new ca(this.owner.$zF[1].x, this.x - this.bombMoveDist, this.bombMoveTime, C.sineInOut)])));
                this.bomb.add(a);
                this.type = "bomb"
            } else "bombRight" == this.type ? (this.owner.$zF[1].setXY(this.x + this.bombMoveDist, this.y), this.bomb = (new h).add(new S("game/bomb", "idle", 0, 0)), this.owner.addChild(this.bomb), a = new G, a.run(new ua(new H([new ca(this.owner.$zF[1].x, this.x - this.bombMoveDist, this.bombMoveTime,
                C.sineInOut), new ca(this.owner.$zF[1].x, this.x + this.bombMoveDist, this.bombMoveTime, C.sineInOut)]))), this.bomb.add(a), this.type = "bomb") : ("time" == this.type ? (a = new h, g.createImageSprite(this.owner, a, "blank", !0, 0, 0), g.pulseUpDown(a, 25, 1.2), this.pickup = new h, g.createImageSprite(a, this.pickup, "game/pickup_time", !0, 0, 0), this.burst = (new h).add(new S("game/pickups2", "blank", 3, -20))) : (a = new h, g.createImageSprite(this.owner, a, "blank", !0, 0, 0), g.pulseUpDown(a, 25, 1.2), this.pickup = new h, g.createImageSprite(a, this.pickup,
                "game/pickup", !0, 0, 0), this.burst = (new h).add(new S("game/pickups", "blank", 3, -20))), a.addChild(this.burst))
        },
        hit: function() {
            return this.active ? (this.active = !1, "bomb" == this.type ? (this.bomb.$zF[17].play("explode", "blank"), this.playSound("explode")) : (this.pickup.$zF[1].y.animateBy(-30, 0.5), this.pickup.$zF[1].alpha.animateTo(0, 0.5), this.burst.$zF[17].play("burst", "blank"), this.playSound("pickup")), !0) : !1
        },
        onUpdate: function(a) {},
        playSound: function(a) {
            this.sfx = d.pack.getSound("audio/" + a).play()
    ...
    qd.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            this.bgs = [];
            var a = new h;
            g.createImageSprite(this.owner, a, "blank", !1, 0,
                0);
            this.background = new h;
            g.createImageSprite(a, this.background, "blank", !1, -200, 0);
            var b = new h;
            g.createImageSprite(this.background, b, "game/red/bg_front_layer", !1, 0, 0);
            this.bgs.push(b);
            b = new h;
            g.createImageSprite(this.background, b, "game/red/bg_front_layer", !1, this.bgWidth, 0);
            this.bgs.push(b);
            b = new h;
            g.createImageSprite(this.background, b, "game/red/bg_front_layer", !1, 2 * this.bgWidth, 0);
            this.bgs.push(b);
            b = new h;
            g.createImageSprite(this.background, b, "game/red/bg_front_layer", !1, 3 * this.bgWidth, 0);
            this.bgs.push(b);
            b = new h;
            g.createImageSprite(this.background, b, "game/red/bg_front_layer", !1, 4 * this.bgWidth, 0);
            this.bgs.push(b);
            b = new h;
            g.createImageSprite(this.background, b, "game/red/bg_front_layer", !1, 5 * this.bgWidth, 0);
            this.bgs.push(b);
            b = new h;
            g.createImageSprite(this.background, b, "game/red/bg_front_layer", !1, 6 * this.bgWidth, 0);
            this.bgs.push(b);
            this.mask = new h;
            g.createFillSprite(this.background, this.mask, 16776960, !1, 0, 0, 4935, 1E3, 1);
        ...
        onUpdate: function(a) {
            ...
            for (b = this.bgs; a < b.length;) {
                var c = b[a];
                ++a;
                this.background.$zF[1].x.$bG + c.$zF[1].x.$bG < -(this.bgWidth + 100) && (c = c.$zF[1].x, c.set__(c.$bG + this.bgWidth * this.bgs.length))
            }
        },
        __class__: qd
    });
    ...
    td.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            this.bar = new h;
            g.createImageSprite(this.owner, this.bar, "game2/powerbarArrow", !0, 0, 0);
            a = new h;
        ...
        spawn: function(a, b, c) {
            ...
            a ? this.owner.$zF[1].scaleX.set__(-1) : this.owner.$zF[1].scaleX.set__(1);
        ...
        startBar: function() {
            ...
            if (this.ready) {
                var b = new G;
                b.run(new ua(new H([new ca(this.bar.$zF[1].x, 0, this.speed, C.sineIn), new ca(this.bar.$zF[1].x, this.length, this.speed, C.sineOut), new x(function() {
        ...
        getPower: function() {
            ...
            if (this.moving) {
                ...
                var b = new G;
                b.run(new H([new z(0.2), new x(function() {
    ...
    vd.prototype = v(s.prototype, {
        ...
        onAdded: function() {
            ...
            m.root.addChild(a);
            a.$zF[1].x.set__(-300);
            this.screen = (new h).add(new Y(this.backgroundColour, this.staticWidth, this.staticHeight));
            m.root.addChild(this.screen);
            this.onResize();
            this.screen.dispose();
            this.loadGame()
        ...
        loadGame: function() {
            var a = this;
            this.screen =
                (new h).add(new Y(this.backgroundColour, 960, 560));
            m.root.addChild(this.screen);
            this.getScreenSize();
            this.getScreenSize();
            var b = new h;
            g.createImageSprite(this.screen, b, "background", !1, -((1336 - this.screenWidth) / 2), this.screenHeight - 768, "LOADER");
            b = new h;
            g.createImageSprite(this.screen, b, "header", !0, this.screenWidth / 2, 60, "LOADER");
            b = new h;
            g.createImageSprite(this.screen, b, "smlogo", !0, this.screenWidth / 2, 60, "LOADER");
            d.translations = new Wa(t.parse(d.configPack.getFile("translation.xml").toString()).firstElement());
            new h;
            ...
            var k = new h,
                b = new ba(d.loaderPack,
                    "italicFont");
            k.add(new I(b));
            this.screen.addChild(k);
            r.instance(k.$zF[1], I).set_align(da.Center);
            r.instance(k.$zF[1], I).setXY(this.screenWidth / 2, this.screenHeight / 2 + 180);
            r.instance(k.$zF[1], I).set_text("0%");
            var b = new Wa(t.parse(d.configPack.getFile("config.xml").toString()).firstElement()),
                l = new h;
            "YES" == b.node.resolve("showVersionNumber").get_innerData() && (c = new ba(d.loaderPack, "tinyfont"), l.add(new I(c)), this.screen.addChild(l), r.instance(l.$zF[1], I).set_align(da.Center), r.instance(l.$zF[1], I).setXY(this.screenWidth -
                20, this.screenHeight - 20), l.$zF[1].alpha.set__(0.5), g.alignRight(l), b.node.resolve("versionNumber").get_innerData() == this.version ? r.instance(l.$zF[1], I).set_text("v" + b.node.resolve("versionNumber").get_innerData()) : r.instance(l.$zF[1], I).set_text("version error"));
            this.onResize();
            "YES" == b.node.resolve("testLite").get_innerData() && (d.lite = !0);
            "YES" == b.node.resolve("testMobile").get_innerData() && (d.isMobile = !0);
            b = "mainassets";
            d.lite && (b += "-lite");
            d.v2 ? (b = pa.fromAssets(b), b.set_remoteBase(r.string(m.$vG.getExternal().call("jsembed.baseUrl")) +
                "assets/"), this.loader2 = m.$vG.loadAssetPack(b)) : this.loader2 = m.loadAssetPack(pa.fromAssets(b));
            this.loader2.success.connect(function(b) {
                ...
                if (d.preloaderClick) {
                    ...
                    l.dispose();
                    b = new h;
                    g.createImageSprite(a.screen, b, "blank", !0, a.screenWidth / 2, a.screenHeight / 2);
                    b.$zF[1].set_pixelSnapping(!1);
                    var c = new h;
                    d.isMobile ? g.createXMLSprite(b, c, d.titleFont, "Center", 0, 0, d.translations.node.resolve("tapStart")) : g.createXMLSprite(b, c, d.titleFont, "Center", 0, 0, d.translations.node.resolve("clickStart"));
        ...
        startGame: function() {
            ...
            if (!this.fading) {
                ...
                b = new G;
                b.run(new H([new z(0.3), new x(function() {
                    a.screen.dispose();
        ...
        onResize: function() {
            if (null != this.screen) {
                ...
                939 < m.$vG.$IG.get_height() &&
                    1140 > m.$vG.$IG.get_height() && (d.resizeScreen = !1);
                if (1336 < m.$vG.$IG.get_width() || 960 > m.$vG.$IG.get_width()) d.resizeScreen = !0;
                2 < m.$vG.$IG.get_width() / m.$vG.$IG.get_height() && (d.resizeScreen = !1);
                if (d.alwaysResize || 2048 < m.$vG.$IG.get_width() || 768 < m.$vG.$IG.get_height()) d.resizeScreen = !0;
                2048 == m.$vG.$IG.get_width() && 1536 >= m.$vG.$IG.get_height() && (d.staticWidth = r["int"](m.$vG.$IG.get_width() / 2), d.staticHeight = r["int"](m.$vG.$IG.get_height() / 2));
                if (d.resizeScreen) {
                    1920 == r["int"](m.$vG.$IG.get_width()) &&
                        1120 == r["int"](m.$vG.$IG.get_height()) && (d.staticHeight = 560);
                    var a = d.staticWidth,
                        b = d.staticHeight;
                    d.scale = ha.min(m.$vG.$IG.get_width() / a, m.$vG.$IG.get_height() / b);
                    this.screen.$zF[1].setScale(d.scale).setXY((m.$vG.$IG.get_width() - a * d.scale) / 2, (m.$vG.$IG.get_height() - b * d.scale) / 2);
                    m.$vG.$IG.get_width() > m.$vG.$IG.get_height() ? (d.offsetX = r["int"](m.$vG.$IG.get_width() / d.scale - a), d.offsetY = r["int"](m.$vG.$IG.get_height() / d.scale - b)) : (d.offsetX = r["int"](m.$vG.$IG.get_height() / d.scale - b), d.offsetY = r["int"](m.$vG.$IG.get_width() /
                        d.scale - a))
                } else d.scale = 1, d.offsetX = 0, d.offsetY = 0
            }
        },
        getScreenSize: function() {
            if (d.resizeScreen) this.screenWidth = d.staticWidth, this.screenHeight = d.staticHeight;
            else if (this.screenWidth = m.$vG.$IG.get_width(), this.screenHeight = m.$vG.$IG.get_height(), this.screenHeight > this.screenWidth) {
                var a = this.screenWidth;
                this.screenWidth = this.screenHeight;
                this.screenHeight = a
    ...
    rd.prototype = v(s.prototype, {
        ...
        init: function() {
            this.active = !0;
            this.attacking = this.hurting = this.jumping = this.walkRight = this.walkLeft = !1;
            this.facingRight = !0;
            this.fallen = !1
        },
        onUpdate: function(a) {
            if (!this.walkRight || this.attacking ||
                this.hurting) !this.walkLeft || this.attacking || this.hurting || (this.owner.$zF[1].x.$bG < this.carLeft ? this.walk(M.LEFT, !1) : (b = this.owner.$zF[1].x, b.set__(b.$bG - this.walkSpeed * a)));
            else if (this.owner.$zF[1].x.$bG > this.carRight) this.walk(M.RIGHT, !1);
            else {
                var b = this.owner.$zF[1].x;
                b.set__(b.$bG + this.walkSpeed * a)
            }!this.jumping && 0 < this.shadow.$zF[1].alpha.$bG && (this.owner.$zF[1].x.$bG > this.carRight + 50 ? this.fall(M.RIGHT) && (this.leaveCar(!0, !0), this.shadow.$zF[1].alpha.set__(0)) : this.owner.$zF[1].x.$bG < this.carLeft -
                50 && this.fall(M.LEFT) && (this.leaveCar(!0, !0), this.shadow.$zF[1].alpha.set__(0)))
        },
        endGame: function() {
        ...
        jumpUp: function() {
            var a = this;
            if (this.active && !this.attacking && !this.hurting && !this.jumping && 1 < this.car.$zF[29].track) {
                this.jumping = !0;
                this.attacking = !1;
                ...
                this.shadow.$zF[1].alpha.animateTo(0,
                    0.2);
                var b = 0.16;
                if (this.walkLeft || this.walkRight) this.spidey.$zF[17].gotoAndPlay(3), b = 0;
                var c = new G;
                c.run(new H([new z(b), new x(function() {
                        a.leaveCar(!0, !1);
                        a.spidey.$zF[1].y.animateBy(-a.jumpHeight, a.jumpTime / 2, C.sineOut);
                        a.owner.$zF[1].y.animateBy(-70, a.jumpTime / 2, C.sineInOut)
                    }), new z(0.16), new x(function() {
                        a.spidey.$zF[1].y.animateTo(0, a.jumpTime / 2, C.sineIn)
                    }), new z(0.38), new x(function() {
                        a.shadow.$zF[17].loop("shadow");
                        a.shadow.$zF[1].alpha.animateTo(1, 0.3);
                        a.landOnCar(a.track)
                    }), new z(0.25),
                    new x(function() {
                        a.walkLeft || a.walkRight ? (a.spidey.$zF[17].loop("run"), a.shadow.$zF[17].loop("shadow_run"), a.jumping = !1) : a.spidey.$zF[17].loop("idle")
                    }), new z(0.16), new x(function() {
                        a.jumping && (a.jumping = !1, a.walkLeft || a.walkRight) && (a.spidey.$zF[17].loop("run"), a.shadow.$zF[17].loop("shadow_run"))
                    })
                ]));
                this.jumpEnt.add(c);
                return !0
        ...
        jumpDown: function() {
            var a = this;
            if (this.active && !this.attacking && !this.hurting && !this.jumping && 3 > this.car.$zF[29].track) {
                this.jumping = !0;
                this.attacking = !1;
                this.track =
                    this.car.$zF[29].track + 1;
                this.spidey.$zF[17].play("jump", "idle");
                this.playSound("jump" + g.randomNumber(1, 2));
                this.playVo("VO_" + d["char"] + "_jump1_long");
                ...
                c.run(new H([new z(b), new x(function() {
                    ...
                    a.spidey.$zF[1].y.animateTo(0,
                        a.jumpTime / 2, C.sineIn)
                }), new z(0.38), new x(function() {
                    a.shadow.$zF[17].loop("shadow");
                    a.shadow.$zF[1].alpha.animateTo(1, 0.3);
                    a.landOnCar(a.track)
                }), new z(0.25), new x(function() {
                    a.walkLeft || a.walkRight ? (a.spidey.$zF[17].loop("run"), a.shadow.$zF[17].loop("shadow_run"), a.jumping = !1) : a.spidey.$zF[17].loop("idle")
                }), new z(0.16), new x(function() {
                    a.jumping && (a.jumping = !1, a.walkLeft || a.walkRight) && (a.spidey.$zF[17].loop("run"), a.shadow.$zF[17].loop("shadow_run"))
                })]));
        ...
        hit: function(a) {
            var b = this;
            return !this.active || this.hurting || this.invincible ? !1 : (this.health--, this.hurting = !0, this.walkRight = this.walkLeft = !1, this.shadow.$zF[17].loop("shadow"), this.playVo("VO_" + d["char"] + "_hit"), 0 == this.health ? (this.spidey.$zF[17].play("hit", "idle"), a = new G, a.run(new H([new z(0.4), new x(function() {
                    b.spidey.$zF[17].play("die", "dead");
                    b.shadow.$zF[17].loop("shadow_dead")
                })]))) : (this.spidey.$zF[17].play("hit", "idle"), this.shadow.$zF[17].loop("shadow"), a = new G, a.run(new H([new z(0.5),
                    new x(function() {
                        b.hurting = !1;
                        b.invincible = !0;
        ...
        fall: function(a) {
            this.health--;
            this.landOnCar(99);
            return this.active ? (this.active = !1, a == M.LEFT ? (this.spidey.$zF[1].rotation.animateBy(-60, 1, C.sineIn), this.spidey.$zF[1].y.animateBy(600, 1, C.sineIn)) : a == M.RIGHT && (this.spidey.$zF[1].rotation.animateBy(60, 1, C.sineIn), this.spidey.$zF[1].y.animateBy(600,
                1, C.sineIn)), !0) : !1
        },
        walk: function(a, b) {
            a == M.RIGHT ? (this.walkRight = b) ? (this.hurting || this.spidey.$zF[1].scaleX.set__(1), this.facingRight = !0, this.walkLeft = !1) : this.walkLeft && (this.spidey.$zF[1].scaleX.set__(-1), this.facingRight = !1) : a == M.LEFT && ((this.walkLeft = b) ? (this.hurting || this.spidey.$zF[1].scaleX.set__(-1), this.walkRight = this.facingRight = !1) : this.walkLeft && (this.spidey.$zF[1].scaleX.set__(1), this.facingRight = !0));
            this.jumping || this.attacking || this.hurting || (b ? (this.spidey.$zF[17].loop("run"),
                this.shadow.$zF[17].loop("shadow_run")) : this.walkLeft || this.walkRight || (this.spidey.$zF[17].loop("idle"), this.shadow.$zF[17].loop("shadow")))
        },
    ...
    sd.prototype = v(s.prototype, {
        ...
        hitOil: function() {
            ...
            var b = new G;
            b.run(new H([new z(0.5), new x(function() {
                a.spidey.$zF[17].loop("sliding");
                a.playVo("VO_" + d["char"] + "_hit");
                a.owner.$zF[1].y.animateBy(1E3, 2, C.sineIn);
                a.isLeft ? (a.owner.$zF[1].x.animateBy(60, 2, C.sineIn), a.owner.$zF[1].rotation.animateBy(30, 2, C.sineIn)) : (a.owner.$zF[1].x.animateBy(-60, 2, C.sineIn), a.owner.$zF[1].rotation.animateBy(-30, 2, C.sineIn))
            }), new z(2), new x(function() {
                a.callback("FALLEN")
            })]));
            this.spidey.add(b)
        ...
        hitScaffold: function() {
            ...
            b.run(new H([new z(0.1), new x(function() {
                ...
                a.isLeft ? a.owner.$zF[1].x.animateBy(60, 2, C.sineIn) : a.owner.$zF[1].x.animateBy(-60, 2, C.sineIn)
            }), new z(2), new x(function() {
                a.callback("FALLEN")
            })]));
            this.spidey.add(b)
        ...
        fall: function(a) {
            null == a && (a = !1);
            null != this.spidey.$zF[11] && this.spidey.$zF[11].stopAll();
            a ? this.spidey.$zF[17].loop("jumping") : (this.spidey.$zF[17].play("fall", "falling"), this.owner.$zF[1].x.set__(this.owner.$zF[1].x.$bG));
            a ? this.owner.$zF[1].y.animateBy(1300, 1, C.sineIn) : this.owner.$zF[1].y.animateBy(1E3, 1.5, C.sineIn);
            this.playVo("VO_" + d["char"] + "_hit")
        },
        failJump: function(a) {
            var b = this;
            if (this.isIdle) {
                ...
                this.playVo("VO_" + d["char"] + "_jump1_long");
                var c = new G;
                c.run(new H([new z(0.1), new x(function() {
                    b.isLeft ?
                        (b.owner.$zF[1].x.animateBy(b.jumpDist - 30, b.jumpTime + 0.6, C.sineOut), b.isLeft = !1) : (b.owner.$zF[1].x.animateBy(-b.jumpDist + 30, b.jumpTime + 0.6, C.sineOut), b.isLeft = !0);
                    b.owner.$zF[1].y.animateBy(a, b.jumpTime, C.sineIn)
                }), new z(this.jumpTime / 2), new x(function() {
                    b.callback("JUMP")
                }), new z(this.jumpTime / 2 - 0.05), new x(function() {
                    b.fall(!0)
                })]));
                this.spidey.add(c)
            }
        ...
        jump: function(a) {
            ...
            if (this.isIdle) {
                ...
                var c = new G;
                c.run(new H([new z(0.1), new x(function() {
                        b.isLeft ? (b.owner.$zF[1].x.animateBy(b.jumpDist, b.jumpTime), b.isLeft = !1) : (b.owner.$zF[1].x.animateBy(-b.jumpDist, b.jumpTime), b.isLeft = !0);
                        100 > b.jumpDist ? b.owner.$zF[1].y.animateBy(-50, 0.5 * b.jumpTime, C.sineOut) : b.owner.$zF[1].y.animateBy(a, b.jumpTime, C.sineIn)
                    }), new z(this.jumpTime / 2), new x(function() {
                        b.callback("JUMP");
                        100 > b.jumpDist && b.owner.$zF[1].y.animateBy(a + 50, 0.5 * b.jumpTime, C.sineIn)
                    }), new z(this.jumpTime / 2 - 0.05),
                    new x(function() {
                        b.callback("SCAFFOLD")
                    }), new z(0.05), new x(function() {
                        b.isLeft ? (b.spidey.$zF[1].scaleX.set__(1), b.owner.$zF[1].x.set__(b.left)) : (b.spidey.$zF[1].scaleX.set__(-1), b.owner.$zF[1].x.set__(b.right));
                        b.callback("LAND");
                        b.callback("SCAFFOLD")
                    }), new z(this.jumpTime), new x(function() {
                        b.isIdle = !0;
                        b.callback("READY")
                    })
                ]));
    ...
    Mb.prototype =
        v(s.prototype, {
            ...
            onAdded: function() {
                ...
                this.owner.$zF[1].setXY(this.x, this.y);
                this.owner.$zF[1].set_pixelSnapping(!1);
                "target" == this.type ? (this.target = new h, g.createImageSprite(this.owner, this.target, "game2/" + this.type, !0, 0, 0), this.showArrow(!1)) : "oil" == this.type ? (this.size = 80, this.left ? (this.target = (new h).add(new S("game2/drain", "water", 15, 0)), this.owner.addChild(this.target)) : (this.target =
                    (new h).add(new S("game2/drain", "water", -15, 0)), this.owner.addChild(this.target), this.target.$zF[1].scaleX.set__(-1))) : "scaffold" == this.type && (this.target = new h, g.createImageSprite(this.owner, this.target, "game2/scaffold", !0, 0, 0), this.left ? g.createImageSprite(this.owner, this.target, "game2/scaffold", !0, -110, 0) : (g.createImageSprite(this.owner, this.target, "game2/scaffold", !0, 110, 0), this.target.$zF[1].scaleX.set__(-1)))
            },
            ...
            hit: function() {
                ...
                if (this.active) {
                    ...
                    if ("target" == this.type) {
                        ...
                        c = new G;
                        c.run(new H([new z(0.3), new x(function() {
    ...
    g.addDebugSpeedAdjuster = function(a) {
        ...
        return m.$vG.getKeyboard().down.connect(function(b) {
            var c = a.$zF[9];
            b.key == e.LeftBracket ? (b = c.scale, b.set__(b.$bG / 1.61803398875), null) : b.key == e.RightBracket && (b = c.scale, b.set__(1.61803398875 * b.$bG), null)
        })
    };
    g.createImageSprite = function(a, b, c, e, g, h, l, m) {
        ...
        b.$zF[1].x.set__(g);
        b.$zF[1].y.set__(h);
        d.lite && (80 == m ? b.$zF[1].setScale(1.25) : 50 == m && b.$zF[1].setScale(2))
    };
    ...
    g.createTextSprite = function(a, b, c, d, e, g, h, l) {
        b.add(new I(c));
        a.addChild(b);
        "Left" == d ? r.instance(b.$zF[1], I).set_align(da.Left) : "Right" == d ? r.instance(b.$zF[1], I).set_align(da.Right) : r.instance(b.$zF[1], I).set_align(da.Center);
        r.instance(b.$zF[1],
            I).x.set__(e);
        r.instance(b.$zF[1], I).y.set__(g);
        r.instance(b.$zF[1], I).set_text(h);
        null != l && (a = r.instance(b.$zF[1], I).x, a.set__(a.$bG + r.parseInt(l.att.resolve("offsetX"))), a = r.instance(b.$zF[1], I).y, a.set__(a.$bG + r.parseInt(l.att.resolve("offsetY"))), r.instance(b.$zF[1], I).setScale(r.parseFloat(l.att.resolve("fontScale"))))
    };
    g.createXMLSprite = function(a, b, c, d, e, g, h) {
        b.add(new I(c));
        a.addChild(b);
        "Left" == d ? r.instance(b.$zF[1], I).set_align(da.Left) : "Right" == d ? r.instance(b.$zF[1], I).set_align(da.Right) :
    ...
    g.rolloverImage = function(a, b, c, e) {
        d.isMobile || (e.hit == a.$zF[1] ? (r.instance(a.$zF[1], N).texture = d.pack.getTexture(c),
            m.$vG.$FG.set_cursor(ea.Button)) : (r.instance(a.$zF[1], N).texture = d.pack.getTexture(b), m.$vG.$FG.set_cursor(ea.Default)))
    };
    ...
    g.pulseUpDown = function(a, b, c) {
        ...
        var d = a.$zF[1].y.$bG,
            e = new G;
        e.run(new ua(new H([new ca(a.$zF[1].y,
            d + b, c, C.sineInOut), new ca(a.$zF[1].y, d, c, C.sineInOut)])));
        a.add(e)
    };
    g.mute = function(a) {
        a ? (d.muted = !0, m.volume.set__(0)) : (d.muted = !1, m.volume.set__(1))
    };
    ...
    g.detectLowEndDevice = function() {
        ...
        if (-1 != a.indexOf("ipod") || -1 != a.indexOf("iphone") || -1 != a.indexOf("ipad")) {
        ...
        navigator.isCocoonJS ? (d.nickApp = !0, d.liteAssetsInApp && (d.lite = !0)) : null;
        d.lite || null
    };
    g.__super__ = s;
    g.prototype = v(s.prototype, {
    ...
    var Nb = function() {};
    l["spine.attachments.VertexAttachment"] =
        Nb;
    ...
    La.USE_CACHE = !1;
    La.USE_ENUM_INDEX = !1;
    La.BASE64 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%:";
